...
Můžete také použít [automatizované zálohování databáze](sql-database-automated-backups.md) k vytvoření [kopírování databáze](sql-database-copy.md) na libovolném logického serveru v libovolné oblasti. 
