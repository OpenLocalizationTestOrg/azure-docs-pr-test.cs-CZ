...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>Pomocí prostředí PowerShell tooconfigure active geografická replikace pro jednu databázi Azure SQL

Tento ukázkový skript prostředí PowerShell nakonfiguruje aktivní geografickou replikací pro jednu databázi Azure SQL a převezme tooa sekundární replika databáze Azure SQL hello.
