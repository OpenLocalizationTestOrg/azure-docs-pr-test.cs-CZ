...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Použití prostředí PowerShell toosync mezi databáze SQL Azure a místní databáze SQL serveru

Tento příklad PowerShell konfiguruje toosync synchronizaci dat mezi databáze SQL Azure a místní databázi systému SQL Server. 

Tato ukázka vyžaduje hello prostředí Azure PowerShell verze modulu 4.2 nebo novější. Spustit `Get-Module -ListAvailable AzureRM` toofind hello nainstalované verze. Pokud potřebujete tooinstall nebo aktualizace, přečtěte si [modul nainstalovat Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/install-azurerm-ps).
...
Po spuštění hello ukázkový skript můžete spustit následující příkaz tooremove hello prostředků skupiny hello a všechny prostředky s ním spojená.
...
| [Nové AzureRmSqlSyncAgentKey](/powershell/module/azurerm.sql/New-AzureRmSqlSyncAgentKey) |  Vygeneruje klíč agenta hello přidruženého k agentovi synchronizace hello |
| [Get-AzureRmSqlSyncAgentLinkedDatabase](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncAgentLinkedDatabase) |  Získání všech informací hello pro hello agenta synchronizace |
| [Nové AzureRmSqlSyncMember](/powershell/module/azurerm.sql/New-AzureRmSqlSyncMember) |  Přidat nové toohello člen skupiny synchronizace |
| [Aktualizace AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncSchema) |  Aktualizuje informace o schématu databáze hello |
| [Get-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncSchem) |  Získání informací o schématu databáze hello |
| [Aktualizace AzureRmSqlSyncGroup](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncGroup) |  Aktualizace hello skupiny synchronizace |
| [Počáteční AzureRmSqlSyncGroupSync](/powershell/module/azurerm.sql/Start-AzureRmSqlSyncGroupSync) | Aktivace synchronizace |
| [Get-AzureRmSqlSyncGroupLog](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncGroupLog) |  Hello kontroly protokolů synchronizace |
|||
