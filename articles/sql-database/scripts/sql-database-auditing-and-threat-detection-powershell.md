...
---
# <a name="use-powershell-to-configure-sql-database-auditing-and-threat-detection"></a>Konfigurace SQL Database auditování a zjišťování hrozeb pomocí prostředí PowerShell

Tento příklad skriptu prostředí PowerShell konfiguruje SQL Database auditování a zjišťování hrozeb. 

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

## <a name="sample-script"></a>Ukázkový skript

[!code-powershell[hlavní](../../../powershell_scripts/sql-database/database-auditing-and-threat-detection/database-auditing-and-threat-detection.ps1?highlight=13-14 "konfigurace auditování a zjišťování hrozeb")]
...
| [Set-AzureRmSqlDatabaseAuditingPolicy](/powershell/module/azurerm.sql/set-azurermsqldatabaseauditingpolicy) | Nastavení zásad auditování pro databázi. |
| [Set-AzureRmSqlDatabaseThreatDetectionPolicy](/powershell/module/azurerm.sql/set-azurermsqldatabasethreatdetectionpolicy) | Nastaví zásadu detekce hrozeb v databázi. |
