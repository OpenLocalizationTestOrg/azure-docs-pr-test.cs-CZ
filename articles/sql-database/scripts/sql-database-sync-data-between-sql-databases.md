...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Použití prostředí PowerShell toosync mezi více databází Azure SQL
 
Tento příklad PowerShell konfiguruje toosync synchronizaci dat mezi několika databází Azure SQL.
