...
---
# <a name="use-powershell-toocreate-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>Použijte toocreate prostředí PowerShell jednu databázi Azure SQL a nakonfigurujte pravidlo brány firewall

Tento příklad skriptu prostředí PowerShell vytvoří Azure SQL database a nakonfiguruje pravidla brány firewall na úrovni serveru. Po úspěšně spustit skript hello hello databáze SQL je přístupná ze všech služeb Azure a hello nakonfigurovat IP adresu. 
