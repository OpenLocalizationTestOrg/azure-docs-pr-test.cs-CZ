...
---
# <a name="use-powershell-tooconfigure-an-active-geo-replication-failover-group-for-a-single-azure-sql-database"></a>Pomocí prostředí PowerShell tooconfigure skupinu aktivní geografickou replikaci převzetí služeb při selhání pro jednu databázi Azure SQL

Tento ukázkový skript prostředí PowerShell nakonfiguruje skupinu aktivní geografickou replikaci převzetí služeb při selhání pro jednu databázi Azure SQL a převezme tooa sekundární replika databáze Azure SQL hello.
