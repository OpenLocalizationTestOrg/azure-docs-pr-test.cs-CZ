...
V řešení Data Factory vytváříte jeden nebo více datových [kanálů](data-factory-create-pipelines.md). Kanál je logické seskupení aktivit, které společně provádějí úlohy. Tyto kanály nacházet v oblasti, kde byl vytvořen služby data factory. 
...
- [Databáze Azure Cosmos](../documentdb/documentdb-firewall-support.md)
