...
-------- | ----------- | --------
| jméno | Název kanálu. Zadejte název, který představuje akci, aktivity nebo kanálu je nakonfigurovaný<br/><ul><li>Maximální počet znaků: 260</li><li>Musí začínat číslem písmenem nebo podtržítkem (_)</li><li>Nejsou povolené tyto znaky: ".", "+","?", "/", "<",">", "*", "%", "&", ":","\\"</li></ul> |Ano |
| Popis |Text popisující, co aktivity nebo kanálu se používá pro | Ne |
| aktivity | Obsahuje seznam aktivit. | Ano |
...
| --- | --- | --- |
| jméno |Název aktivity. Zadejte název, který představuje akci nakonfigurovaný tak, aby se aktivity<br/><ul><li>Maximální počet znaků: 260</li><li>Musí začínat číslem písmenem nebo podtržítkem (_)</li><li>Nejsou povolené tyto znaky: ".", "+","?", "/", "<",">", "*", "%", "&", ":","\\"</li></ul> |Ano |
| Popis |Text popisující, co se používá aktivitu pro. |Ano |
...
| linkedServiceName |Název propojené služby použité aktivitou. <br/><br/>Aktivita může vyžadovat, že zadáváte propojené služby, která odkazuje na požadované výpočetním prostředí. |Ano pro aktivity HDInsight, Azure Machine Learning aktivity a aktivity uložené procedury. <br/><br/>Ne všechny ostatní uživatelé |
| rámci typeProperties |Vlastnosti v rámci typeProperties části závisí na typu aktivity. |Ne |
...
| rámci typeProperties | V rámci typeProperties části obsahuje prvky, které se liší u každé úložiště dat nebo výpočetní prostředí. V tématu [úložišť dat](#datastores) části pro všechna data ukládat propojené služby a [výpočetní prostředí](#compute-environments) pro všechny výpočetní propojené služby |   
...
| rámci typeProperties | Vlastnosti odpovídající vybranému typu. V tématu [ÚLOŽIŠŤ dat](#data-stores) části Podporované typy a jejich vlastnosti. |Ano |Není k dispozici |
...
| &nbsp; |[Databáze Azure Cosmos](#azure-cosmos-db) |
