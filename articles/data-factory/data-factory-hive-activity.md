...
4. Kopírovat dotaz Hive jako soubor do úložiště objektů Blob Azure nakonfigurovali v kroku #2. Pokud je úložiště pro hostování dat jiný než hostování tento soubor dotazu, vytvořte samostatné propojenou službu úložiště Azure a na ni odkazuje v rámci aktivity. Použijte ** scriptPath ** zadat cestu k souboru dotazu hive a **scriptLinkedService** k určení úložiště Azure, která obsahuje soubor skriptu. 
