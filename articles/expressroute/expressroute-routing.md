...
* Pokud se používá podsíť /29, rozdělí se na dvě podsítě /30. 
  * nejprve Hello/30 podsítě se používá pro primární propojení hello a hello druhý /30 podsítě se používá pro sekundární propojení hello.
  * Pro každé podsítě hello /30 musíte použít hello první IP adresu podsítě hello /30 na směrovači. Společnost Microsoft používá hello druhou IP adresu podsítě tooset hello /30 se relace protokolu BGP.
...
Pokud si zvolíte a.b.c.d/29 tooset toouse až hello partnerský vztah, rozdělí se na dvě podsítě/30. V příkladu hello níže podíváme na tom, jak hello se podsíť a.b.c.d/29 použije. 
...
* Pokud se používá podsíť /29, rozdělí se na dvě podsítě /30. 
  * nejprve Hello/30 podsítě se použije pro primární propojení hello a hello druhý /30 podsítě se používá pro sekundární propojení hello.
  * Pro každé podsítě hello /30 musíte použít hello první IP adresu podsítě hello /30 na směrovači. Společnost Microsoft používá hello druhou IP adresu podsítě tooset hello /30 se relace protokolu BGP.
  * Musíte nastavit obě relace protokolu BGP pro naše [smlouva SLA o dostupnosti](https://azure.microsoft.com/support/legal/sla/) toobe platný.
...
Můžete toouse veřejných nebo privátních IPv4 adresy pro soukromý partnerský vztah. Poskytujeme kompletní izolaci provozu, takže v případě soukromého partnerského vztahu není možné překrývání adres s jinými zákazníky. Tyto adresy nejsou inzerovaný tooInternet. 
...
Ujistěte se, že vaše IP adresa a číslo AS jsou registrované tooyou v jednom z hello registrech následující:
...
Můžete zakoupit víc než jeden okruh ExpressRoute na geopolitickou oblast. Použití víc připojení nabízí významné výhody vysoké dostupnosti kvůli toogeo redundance. V případech, kdy máte víc okruhů ExpressRoute obdržíte stejnou sadu předpon inzerovaných hello od společnosti Microsoft na hello veřejného partnerského vztahu a partnerského vztahu Microsoftu. To znamená, že bude mít z vaší sítě do Microsoftu víc cest. To může potenciálně způsobit optimální směrování rozhodnutí toobe provedené v rámci vaší sítě. V důsledku toho můžete setkat s neoptimálním průběhem připojení prostředí toodifferent služby. Můžete spoléhat na hello komunity hodnoty toomake odpovídající směrování rozhodnutí toooffer [optimální směrování toousers](expressroute-optimize-routing.md).
