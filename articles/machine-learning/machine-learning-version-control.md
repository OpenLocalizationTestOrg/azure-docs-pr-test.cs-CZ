...
Můžete také vytvořit mnoho koncových bodů identické webové služby a potom oprava různé verze souboru .iLearner ke koncovému bodu k dosažení podobný vliv. [Tento článek](machine-learning-create-models-and-endpoints-with-powershell.md) podrobněji vysvětluje, jak provést tuto akci.
...
* Zjistěte, jak [vytvořit a spravovat velký počet ML modelů pomocí právě jeden experimentu](machine-learning-create-models-and-endpoints-with-powershell.md) pomocí prostředí PowerShell a retraining API.
