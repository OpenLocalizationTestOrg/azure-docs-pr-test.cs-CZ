...
Nasazení webové služby nebo použijte existující webovou službu. Další informace o nasazení webové služby najdete v tématu [návod krok 5: nasazení služby Azure Machine Learning webové](machine-learning-walkthrough-5-publish-web-service.md).
...
1. Nasazení webové služby nebo použijte existující webovou službu. Další informace o nasazení webové služby najdete v tématu [návod krok 5: nasazení služby Azure Machine Learning webové](machine-learning-walkthrough-5-publish-web-service.md).
2. Klikněte na tlačítko **využívat**.
3. Vyhledejte **informace o základní spotřeby** části. Zkopírujte a uložte **primární klíč** a **požadavků a odpovědí** adresy URL.
