...
Tato služba přijímá argumenty 4 a vypočítá hello ETS prognózy.
...
Existuje více způsobů využívání služby hello automatizovaně (je třeba aplikace [sem](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx)).
