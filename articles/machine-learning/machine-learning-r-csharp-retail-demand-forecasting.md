...
Tato služba přijímá argumenty 4 a vypočítá prognózy.
...
Existuje více způsobů využívání služby automatizovaně (je třeba aplikace [sem](http://microsoftazuremachinelearning.azurewebsites.net/StlEtsForecasting.aspx)).
...
To je velmi jednoduchý příklad pro ETS + STL prognózy. Jak je vidět z výše uvedený ukázkový kód, žádné chyby zachytávání je implementována a službu předpokládá, že jsou všechny proměnné průběžné nebo kladnou hodnoty a frekvenci musí být celé číslo větší než 1. Délka hodnotu data a vektory musí být stejná, a délka časové řady musí být větší než 2 * frekvence. Proměnnou datum by měl splňovat ve formátu ' mm/dd/rrrr'.
