...
> [!NOTE]
> Ke stažení tahák a postupovat, přejděte na [strojového učení rychlý přehled algoritmů pro Microsoft Azure Machine Learning Studio](machine-learning-algorithm-cheat-sheet.md).
> 
> 
...
* Stáhnout a vytisknout diagram, který poskytne přehled funkcí Azure Machine Learning Studio najdete v tématu [diagram s přehledem funkcí Azure Machine Learning Studio](machine-learning-studio-overview-diagram.md).
