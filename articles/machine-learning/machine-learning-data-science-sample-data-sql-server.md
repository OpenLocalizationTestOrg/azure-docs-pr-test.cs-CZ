...
> [!NOTE]
> Ukázkový kód SQL v tomto dokumentu se předpokládá, že data jsou v systému SQL Server na platformě Azure. Pokud není, získáte informace [přesun dat do systému SQL Server na platformě Azure](machine-learning-data-science-move-sql-server-virtual-machine.md) tématu pokyny o tom, jak přesunout data do systému SQL Server v Azure.
> 
> 
...
Příklad začátku do konce návod procesu vědecké účely Team dat pomocí veřejné datové sady, najdete v tématu [proces vědecké účely Team dat v akci: pomocí SQL serveru](machine-learning-data-science-process-sql-walkthrough.md).
