...
Technici a výběr funkcí je jednou ze součástí z Team Data vědecké účely procesu (TDSP) uvedené v [co je proces Team dat. vědecké účely?](data-science-process-overview.md). Funkce inženýrství a výběr jsou součástí **vyvíjet funkce** krok TDSP.
