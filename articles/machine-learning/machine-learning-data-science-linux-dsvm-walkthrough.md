...
* A [ **Linux vědecké zpracování dat virtuálních počítačů**](https://azure.microsoft.com/marketplace/partners/microsoft-ads/linux-data-science-vm). Informace o zřizování tohoto virtuálního počítače najdete v tématu [zřízení virtuálního počítače Linux datové vědy](machine-learning-data-science-linux-dsvm-intro.md).
...
Vyberte **nastavení** v levé nabídce. Poznámka: vaše **ID pracovního prostoru**. ![2](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-id.png)

Vyberte **autorizace tokeny** z nabídky režijních nákladů a Poznámka vaše **primární autorizační Token**.![ 3](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-token.png)
...
Popis dalších návody začátku do konce, které ukazují kroků v procesu vědecké účely Team dat u konkrétních scénářů najdete v tématu [proces vědecké účely dat Team návody](data-science-process-walkthroughs.md). Názorné postupy také ukazují, jak kombinovat cloudové a místní nástroje a služby do pracovního postupu nebo kanálu vytvoření inteligentního aplikace.
