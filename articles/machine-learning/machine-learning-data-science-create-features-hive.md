...
* Data byla uložena do tabulek Hive v Azure HDInsight Hadoop clusterů. Pokud ne, postupujte podle [vytvoření a načtení dat do tabulek Hive](machine-learning-data-science-move-hive-tables.md) nejprve nahrát data do tabulek Hive.
