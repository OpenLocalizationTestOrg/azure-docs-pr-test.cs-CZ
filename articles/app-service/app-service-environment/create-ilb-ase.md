...
Všechny články a postupy pro ASEs jsou k dispozici v [soubor README pro služby App Service Environment][ASEReadme].

* Chcete-li začít pracovat s ASEs, přečtěte si téma [Úvod do služby App Service Environment][Intro].
* Další informace o platformě Azure App Service najdete v článku [Azure App Service](http://azure.microsoft.com/documentation/articles/app-service-value-prop-what-is/).
