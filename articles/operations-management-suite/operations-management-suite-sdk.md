...
* [Rutiny prostředí PowerShell automatizace](http://msdn.microsoft.com/library/dn690262.aspx)
* [Rozhraní API REST automatizace](http://msdn.microsoft.com/library/mt662285.aspx)
* [Sady runbook komunity](https://gallery.technet.microsoft.com/scriptcenter/site/search?f%5B0%5D.Type=RootCategory&f%5B0%5D.Value=WindowsAzure&f%5B0%5D.Text=Windows%20Azure)
...
* [Hledání protokolů REST API](../log-analytics/log-analytics-log-search-api.md)
* [Výstrahy REST API](../log-analytics/log-analytics-api-alerts.md)
* [Rutiny prostředí PowerShell analýzy protokolů](https://msdn.microsoft.com/library/mt188224.aspx)
* [Knihovna .NET analýzy protokolů](https://www.nuget.org/packages/Microsoft.Azure.Management.OperationalInsights/0.16.0-preview)

## <a name="service-map"></a>Mapa služeb
* [Dokumentace mapy služeb](operations-management-suite-service-map.md)
* [Mapa služeb rozhraní REST API](https://docs.microsoft.com/rest/api/servicemap/)
