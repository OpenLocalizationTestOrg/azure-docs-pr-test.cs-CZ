...
Chcete-li vytvořit tuto analýzou hrozeb, OMS zabezpečení a Audit pomocí dat pocházejících z více zdrojů v rámci Microsoftu. OMS zabezpečení a Audit bude tyto údaje využijte k identifikaci potenciálních hrozeb pro vaše prostředí.
...
Můžete využít **analýzou hrozeb** informace v OMS zabezpečení a Audit řešení umožňující těchto úloh. Použijte následující postup pro přístup k: **analýzou hrozeb** možnosti:
