---
title: "Azure Resource Health – kurzy | Dokumentace Microsoftu"
description: 
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Další informace o službě Azure Service Health</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Další informace o typech prostředků a kontrolách stavu ve službě Resource Health</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Zaslání upozornění, když vás příště ovlivní problém se službou Azure</h3>
                    </div>
                </div>
            </div>
        </div>
