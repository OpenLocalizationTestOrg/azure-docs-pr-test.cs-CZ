...
Brána používá jako služby systému Windows. Stejně jako ostatní služby systému Windows můžete spustit a zastavit službu několika způsoby. Můžete například otevřete příkazový řádek se zvýšenými oprávněními v počítači se spuštěným systémem brány a spusťte buď tyto příkazy:
...
Místní brána dat je nastavit tak, aby použít `NT SERVICE\PBIEgwService` Windows služby přihlašovací údaje. Ve výchozím nastavení brány má právo "Přihlásit jako službu" pro počítač, kde instalujete bránu.
