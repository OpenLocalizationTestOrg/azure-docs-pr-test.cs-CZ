...
4. Přidáte akci, která se pošle e-mailu, když se aktivuje batch aktivační událost. Pokaždé, když dávky má pět položek, aplikace logiky odešle e-mail.
...
6. Nastavte vlastnosti pro akci, kterou jste právě přidali.
   ...
   * V **k** zadejte příjemce e-mailovou adresu. 
