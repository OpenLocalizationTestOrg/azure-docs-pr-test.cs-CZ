...
## B2B se sadou Enterprise Integration Pack
...
### [Monitorování stavu aplikace logiky v OMS s využitím Log Analytics](logic-apps-monitor-your-logic-apps-oms.md)
...
### [Vlastní rozhraní / webové aplikace](logic-apps-create-api-app.md)
...
### [Systém souborů](logic-apps-using-file-connector.md)
### [Plochý soubor](logic-apps-enterprise-integration-flatfile.md)
...
### [Plán](../connectors/connectors-native-recurrence.md)
