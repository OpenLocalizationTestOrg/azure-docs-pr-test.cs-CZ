...
## <a name="supported-platforms-for-windows-vms"></a>Podporované platformy pro virtuální počítače Windows
...
> [!NOTE]
>
* Vyhodnocování ohrožení zabezpečení operačního systému ještě nejsou k dispozici pro systém Windows Server 2016.
* Crash analysis, že detekce jsou podporovány pouze pro Windows Server 2012 a Windows Server 2012 R2.
>
>

## <a name="supported-platforms-for-linux-vms"></a>Podporované platformy pro virtuální počítače s Linuxem
Podporované operační systémy Linux:

* Verze Ubuntu 12.04, 14.04, 16.04, 16.10
* Debian verze 7, 8
* CentOS verze 6. \*, 7.*
* Red Hat Enterprise Linux (RHEL) verze 6. \*, 7.*
* SUSE Linux Enterprise Server (SLES) verze 11 SP4 +, 12.*
