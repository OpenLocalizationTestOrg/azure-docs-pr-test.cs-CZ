...
Vytvoření clusteru v Azure se provádí prostřednictvím šablonu Model prostředků nebo portálu Azure. Čtení [vytvořit cluster Service Fabric pomocí šablony Resource Manageru](service-fabric-cluster-creation-via-arm.md) nebo [z portálu Azure vytvořit cluster Service Fabric](service-fabric-cluster-creation-via-portal.md) Další informace.

## <a name="supported-operating-systems-for-clusters-on-azure"></a>Podporované operační systémy pro clustery v Azure
Budete moci vytvořit clustery se na virtuálních počítačích s těmito operačními systémy:
...
Budete moci vytvořit clustery se na virtuální počítače nebo počítačů s těmito operačními systémy:
