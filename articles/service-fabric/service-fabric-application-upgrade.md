...
> [!TIP]
> [EnableDefaultServicesUpgrade](service-fabric-cluster-fabric-settings.md#fabric-settings-that-you-can-customize) musí být nastavena na hodnotu true, chcete-li povolit následující pravidla. Tato funkce je podporovaná ze v5.5.
