...
|Popis|Řetězec|Popis rozhraní API. Nesmí být prázdný. Může zahrnovat formátování značky HTML. Maximální délka je 1 000 znaků.|  
...
|Parametry|Kolekce [parametr](#Parameter) entity.|Parametry, které jsou definované pro tuto operaci.|  
...
|Vlastnost|Typ|Popis|  
|--------------|----------|-----------------|  
|Popis|Řetězec|Popis žádost o operaci.|  
|Záhlaví|pole [záhlaví](#Header) entity.|Hlavičky požadavku.|  
|Parametry|pole [parametr](#Parameter)|Kolekce parametrů žádost o operaci.|  
...
|Popis|Řetězec|Operace popis odpovědi.|  
...
|Popis|Řetězec|Popis operace. Nesmí být prázdný. Může zahrnovat formátování značky HTML. Maximální délka je 1 000 znaků.|  
