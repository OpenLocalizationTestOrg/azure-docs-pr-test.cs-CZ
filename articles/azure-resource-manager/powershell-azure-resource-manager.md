...
V tomto článku zjistěte, jak spravovat vaše řešení pomocí Azure PowerShell a Azure Resource Manager. Pokud nejste obeznámeni s Resource Managerem, přečtěte si téma [Přehled služby Správce prostředků](resource-group-overview.md). Toto téma se zaměřuje na úlohy správy. Vaším úkolem je:
...
Toto téma bylo aktualizováno pro verzi 3.3.0. Pokud máte starší verzi, nemusí odpovídat prostředí postupy v tomto tématu. Dokumentaci o rutinách v této verzi najdete v tématu [AzureRM.Resources modulu](/powershell/module/azurerm.resources).
...
Toto téma ukazuje, jak provádět základní operace na vašich prostředků Azure PowerShell. Pro pokročilejší scénáře správy obvykle chcete vytvořit skript a znovu použít tento skript podle potřeby nebo podle plánu. [Služby Azure Automation](../automation/automation-intro.md) poskytuje způsob, jak často automatizaci použít skripty, které spravují řešení Azure.
