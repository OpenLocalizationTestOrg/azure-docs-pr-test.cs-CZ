...
Ovládací prvek, který umožňuje uživateli zadat jeden nebo více souborů, které chcete nahrát. Pomocí tohoto prvku při [vytváření spravovaných aplikací Azure](managed-application-publishing.md).
