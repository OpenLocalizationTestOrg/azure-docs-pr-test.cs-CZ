...
<div id="main" class="v2">
    <div class="container">
        <h1 class="screenReader">Dokumentace k Microsoft Azure</h1>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Příručka Začínáme pro vývojáře v Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Příručka Aplikační architektura v Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="pivots">
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Začínáme s Azure</h2>
                                    <p>Prozkoumejte naše nejoblíbenější služby s využitím šablon Rychlý start, ukázek a výukových kurzů.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Nasazení infrastruktury</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/virtual-machines/linux/">Virtuální počítače s Linuxem</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/">Virtuální počítače s Windows</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Správa dat a umělá inteligence</h3>
                                                ...
                                                <h4>NoSQL</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/cosmos-db/">Databáze Cosmos</a></li>
                                                </ul>
                            ...
                            <li class="bottomRightItem">
                                ...
                                <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Zobrazit všechny služby Azure<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z"/></svg></button>
                                </a>
                            </li>
                            </li>
                        </ul>
            ...
            <li>
                ...
                <ul id="services">
                        ...
                        <ul id="all" class="directory">
                            <li>
                                ...
                                <div class="group">
                                    ...
                                    <h3>Umělá inteligence a Cognitive Services</h3>
                                    <ul>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/security/">
                                                <img src="media/index/SecurityCenter.svg" alt="" />
                                                <p>Informace o zabezpečení</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Monitorování a správa</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/application-insights/">
                                                <img src="media/index/ApplicationInsights.svg" alt="" />
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuální počítače s Linuxem</h3>
                                                    <p>Zřizování virtuálních počítačů s Ubuntu, Red Hat a dalšími systémy</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuální počítače s Windows</h3>
                                                    <p>Zřizování virtuálních počítačů pro SQL Server, SharePoint a další</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web Apps</h3>
                                                    <p>Rychlé vytvoření a nasazení důležitých webových aplikací se škálováním</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funkce</h3>
                                                    <p>Zpracování událostí s kódem bez serveru</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Batch</h3>
                                                    <p>Spouštění výpočetních úloh pomocí kontejnerů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vývoj mikroslužeb a orchestrace kontejnerů ve Windows nebo v Linuxu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vytváření vysoce dostupných a neomezeně škálovatelných cloudových aplikací a rozhraní API</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Nástroj pro vyrovnávání zatížení vrstvy 7 s integrovaným vyrovnáváním zatížení HTTP a řízením dodání</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>VPN Gateway</h3>
                                                    <p>Vytvoření zabezpečeného propojení různých míst</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>Hostování vaší DNS domény v Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Směrování příchozího provozu s cílem dosažení vysokého výkonu a dostupnosti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#web">Web a mobilní zařízení</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API Apps</h3>
                                                    <p>Snadné sestavení a používání cloudových rozhraní API</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Kódování, ukládání a streamování videa a zvuku škálovatelným způsobem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zvýšení využití aplikací a udržení zákazníků</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#containers">Kontejnery</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Škálování a orchestrace kontejnerů pomocí Kubernetes, DC/OS nebo Docker Swarm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ukládání a správa imagí kontejnerů napříč všemi typy nasazení Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Elastický datový sklad jako služba s funkcemi na podnikové úrovni</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Databáze Cosmos</h3>
                                                    <p>Spravovaná databáze dokumentů typu NoSQL jako služba</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>PostgreSQL</h3>
                                                    <p>Spravovaná služba databáze PostgreSQL pro vývojáře aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MySQL</h3>
                                                    <p>Spravovaná služba databáze MySQL pro vývojáře aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Factory</h3>
                                                    <p>Orchestrace a správa transformace a přesunu dat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#cognitive">Umělá inteligence a Cognitive Services</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Počítačové zpracování obrazu</h3>
                                                    <p>Zjištění využitelných informací z obrázků</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tvář</h3>
                                                    <p>Detekce, identifikace, analýza, uspořádání a označení tváří na fotografiích</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Překonejte překážky při rozpoznávání řeči</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Prohledávejte, upravujte, analyzujte a zjišťujte informace z videí</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#analytics">Data a analýza</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HDInsight</h3>
                                                    <p>Zřízení cloudových clusterů Hadoop, Spark, R Server, HBase a Storm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zpracování datových proudů z milionů zařízení IoT v reálném čase</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Distribuovaná služba analýzy usnadňující zpracování velkých objemů dat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Integrace ohromujících plně interaktivních vizualizací dat do aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Inteligentní a bezserverová služba pro roboty, která se škáluje na vyžádání</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Centrum pro vývojáře IoT</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure IoT Hub</h3>
                                                    <p>Připojení, sledování a řízení miliard prostředků IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Hubs</h3>
                                                    <p>Příjem telemetrických dat z miliónů zařízení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Podniková integrace</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Připojení napříč privátními i veřejnými cloudovými prostředími</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#security">Zabezpečení a identita</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Synchronizace místních adresářů a povolení jednotného přihlašování</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#devtools">Vývojářské nástroje</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rychlé vytváření prostředí pomocí opakovaně použitelných šablon a artefaktů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rozpoznávání, třídění a diagnostika problémů s webovými aplikacemi a službami</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Nasazení mobilních aplikací, získávání zpětné vazby a zpráv o chybách a monitorování využití</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Monitorování a správa</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automation</h3>
                                                    <p>Zjednodušení správu cloudu pomocí automatizace procesů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Vysoce detailní monitorování dat v reálném čase pro libovolné prostředky Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Pomáhá při diagnostice a získání podpory v případě, že potíže s Azure ovlivňují vaše prostředky.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Nasazení a správa prostředků Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sestavování a hostování aplikací pro mise vlády USA ve vyhrazené instanci Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sestavování a hostování aplikací v souladu s německými předpisy a také hlavními mezinárodními standardy, pod kontrolou důvěryhodného datového zplnomocněnce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <ul id="sdkstools">
                    <li>
                        ...
                        <ul id="sdkstools-all" class="cardsF">
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/dotnet/azure/?view=azure-dotnet">Referenční materiály k rozhraní API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure-sdk-for-python.readthedocs.io/en/latest/">Referenční materiály k rozhraní API</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/resources/samples/?platform=python">Získat ukázky</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/python">Další informace</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="http://azure.github.io/azure-sdk-for-node/">Referenční materiály k rozhraní API</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=nodejs">Získat ukázky</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/nodejs">Další informace</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://github.com/Azure/azure-sdk-for-ruby/blob/master/README.md">Referenční materiály k rozhraní API</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=ruby">Získat ukázky</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/ruby/">Další informace</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/rest/api/">Začínáme s REST</a>
                                                </h3>
                                                <p>
                                                    <a href="/rest/api">Referenční materiály</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.microsoft.com/documentation/samples/?platform=rest">Získat ukázky</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="container">
                                    <h2>Rozhraní příkazového řádku (CLI)</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0 </h3>
                                                <p>
                                                    <a href="/cli/azure/overview">Začínáme</a>
                                                </p>
                                                <p>
                                                    <a href="/cli/azure/install-azure-cli">Azure CLI 2.0</a>
                                                </p>
                                                <p>
                                                    <a href="/cli/azure">Referenční materiály</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/powershell/azure/install-azurerm-ps">Stáhnout PowerShell</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI </h3>
                                                <p>
                                                    <a href="/azure/xplat-cli-install?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Začínáme</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/linux-azure-cli">Stáhnout Azure CLI pro Linux</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/mac-azure-cli">Stáhnout Azure CLI pro Mac</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/webpi-azure-cli">Stáhnout Azure CLI pro Windows</a>
                                                </p>
                                                <p>
                                                    <a href="/azure/virtual-machines/azure-cli-arm-commands?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Referenční materiály</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://www.microsoft.com/web/handlers/webpi.ashx/getinstaller/VWDOrVs2015AzurePack.appids">Stáhnout</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://github.com/Microsoft/DockerToolsDocs">Nástroje Dockeru</a>
                                                </h3>
                                                <p>
                                                    <a href="/dotnet/articles/core/docker/visual-studio-tools-for-docker">Začínáme</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780680">Stáhnout pro Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780681">Stáhnout pro Visual Studio Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Stáhnout pro Team Services</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://visualstudiogallery.msdn.microsoft.com/c9eb3ba8-0c59-4944-9a62-6eee37294597">Nástroje PowerShellu pro Visual Studio</a>
                                                </h3>
                                                <p>
                                                    <a href="https://visualstudiogallery.msdn.microsoft.com/c9eb3ba8-0c59-4944-9a62-6eee37294597">Stáhnout</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Začínáme</a>
                                                </p>
                                                <p>
                                                     <a  href="http://go.microsoft.com/fwlink/?LinkId=722418">Stáhnout pro Linux</a>
                                                </p>
                                                <p>
                                                    <a href="http://go.microsoft.com/fwlink/?LinkId=708342">Stáhnout pro Mac</a>
                                                </p>
                                                <p>
                                                    <a href="http://go.microsoft.com/fwlink/?LinkId=708343">Stáhnout pro Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://www.visualstudio.com/vs/python">Nástroje Python Tools</a>
                                                </h3>
                                                <p>
                                                    <a href="https://github.com/Microsoft/PTVS/wiki/PTVS-Installation">Začínáme se sadou Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://marketplace.visualstudio.com/items?itemName=donjayamanne.python">Začínáme se sadou Visual Studio Code</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sada osvědčených postupů pro cloudové aplikace, které mimo jiné zahrnují problematiku automatického škálování, ukládání do mezipaměti, dělení dat, návrh rozhraní API a monitorování.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
