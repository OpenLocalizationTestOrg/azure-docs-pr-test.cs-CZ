...
## [Použít AAD auth tooaccess rozhraní API](media-services-use-aad-auth-to-access-ams-api.md)
### [Použití portálu toomanage AAD ověřování](media-services-portal-get-started-with-aad.md)
...
### [Pomocí rozhraní příkazového řádku toocreate a nakonfigurovat aplikaci AAD](media-services-cli-create-and-configure-aad-app.md)
### [Pomocí prostředí PowerShell toocreate a nakonfigurovat aplikaci AAD](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Použít MES tooauto-generovat žebříku přenosovou rychlostí](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Jak toogenerate miniatur pomocí kodéru Media Encoder Standard s rozhraním .NET](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Nakonfigurujte ochranu obsahu hello portálu](media-services-portal-protect-content.md)
### [Konfigurace nezašifrovaného klíče AES-128 pro váš stream](media-services-protect-with-aes128.md)
### [Použít REST tooencrypt svůj obsah pomocí šifrování úložiště](media-services-rest-storage-encryption.md)
...
### [Pomocí partnery toodeliver Widevine licence tooMedia služby](media-services-licenses-partner-integration.md)
#### [Pomocí Axinom tooMedia licence Widevine toodeliver služeb](media-services-axinom-integration.md)
#### [Pomocí castLabs tooMedia licence Widevine toodeliver služeb](media-services-castlabs-integration.md)
...
### [Analýza média pomocí portálu hello](media-services-portal-analyze.md)
...
### [Insert – reklamu v hello na straně klienta](media-services-inserting-ads-on-client-side.md)
