...
[Průzkumník Azure Batch][batch_explorer], jeden z Azure Batch [ukázkové aplikace][github_samples], obsahuje *Heat mapa* funkce, která poskytuje vizualizaci provedení úlohy. Pokud jste provádění [ParallelTasks] [ parallel_tasks_sample] ukázkovou aplikaci, můžete použít funkci Heat mapa můžete snadno vizualizovat provádění paralelních úloh na každém uzlu.
