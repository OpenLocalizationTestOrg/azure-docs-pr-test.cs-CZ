...
[!code-azurecli[hlavní](../../../cli_scripts/batch/run-job/run-job.sh "spuštění úlohy")]
...
| [vytvoření úlohy batch az](https://docs.microsoft.com/cli/azure/batch/task#create) | Přidá úlohu do zadané úlohy Batch.  |
| [Zobrazit úlohy batch az](https://docs.microsoft.com/cli/azure/batch/task#show) | Načte podrobnosti úlohy z zadaný dávkové úlohy.  |
| [Seznam úkolů az batch](https://docs.microsoft.com/cli/azure/batch/task#list) | Obsahuje úkoly spojené s zadanou úlohu.  |
