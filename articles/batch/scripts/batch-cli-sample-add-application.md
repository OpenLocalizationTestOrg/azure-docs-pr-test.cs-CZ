...
[!code-azurecli[hlavní](../../../cli_scripts/batch/add-application/add-application.sh "přidat aplikaci")]
...
| [Vytvoření balíčku aplikace batch az](https://docs.microsoft.com/cli/azure/batch/application/package#create) | Přidá balíček aplikace pro zadanou aplikaci.  |
