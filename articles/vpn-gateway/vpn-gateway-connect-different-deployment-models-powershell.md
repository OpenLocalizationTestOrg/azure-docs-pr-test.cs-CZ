...
### <a name="part-2--verify-the-gateway-subnet"></a>Část 2 - Ověřte podsíť brány
...
### <a name="part-3---add-the-local-network-site"></a>Část 3 – přidání na místní síťový Web
...
### <a name="part-4---associate-the-vnet-with-the-local-network-site"></a>Součástí 4 – přidružit na místní síťový web virtuální sítě
...
### <a name="part-5---save-the-file-and-upload"></a>Část 5 – soubor uložte a nahrajte
...
## <a name="creatermgw"></a>Část 2: Konfigurace brány virtuální sítě RM
...
## <a name="section-3-modify-the-classic-vnet-local-site-settings"></a>Část 3: Úprava classic místní lokality nastavení virtuální sítě
