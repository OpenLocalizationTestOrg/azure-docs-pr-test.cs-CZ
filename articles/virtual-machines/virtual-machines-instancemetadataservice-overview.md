...
Oblasti                                        | Dostupnost?
-----------------------------------------------|-----------------------------------------------
[Všechny všeobecně dostupná globální oblasti Azure](https://azure.microsoft.com/en-us/regions/)     | Obecně k dispozici 
[Azure Government](https://azure.microsoft.com/en-us/overview/clouds/government/)              | Ve verzi Preview 
[Azure Čína](https://www.azure.cn/)                                                           | Ve verzi Preview
[Azure Německo](https://azure.microsoft.com/en-us/overview/clouds/germany/)                    | Ve verzi Preview
...
platformUpdateDomain |  [Aktualizace domény](virtual-machines-windows-manage-availability.md) hello virtuální počítač spuštěný v
platformFaultDomain | [Doména selhání](virtual-machines-windows-manage-availability.md) hello virtuální počítač spuštěný v
...
vmSize | [Velikost virtuálního počítače](virtual-machines-windows-sizes.md)
...
scheduledevents | Aktuálně ve veřejné verzi Preview najdete [scheduledevents](virtual-machines-scheduled-events.md)
...
- Další informace o hello [scheduledevents](virtual-machines-scheduled-events.md) rozhraní API **ve verzi Public Preview** poskytované hello Instance služby metadat.
