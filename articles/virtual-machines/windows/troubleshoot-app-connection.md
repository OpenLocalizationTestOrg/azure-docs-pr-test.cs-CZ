...
---
# <a name="troubleshoot-access-tooan-application-running-on-a-windows-virtual-machine-in-azure"></a><span data-ttu-id="aa0ac-103">Řešení potíží s přístup tooan aplikace běžící v systému Windows virtuálního počítače v Azure</span><span class="sxs-lookup"><span data-stu-id="aa0ac-103">Troubleshoot access tooan application running on a Windows virtual machine in Azure</span></span>
