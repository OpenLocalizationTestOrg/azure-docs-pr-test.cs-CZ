...
1. Přidání úložiště do virtuálního počítače. Podrobné informace najdete v tématu [přidejte úložiště](../../../storage/common/storage-premium-storage.md).
...
Pokud chcete nastavit parametr port testu clusteru, aktualizujte proměnné ve následující skript z prostředí.
