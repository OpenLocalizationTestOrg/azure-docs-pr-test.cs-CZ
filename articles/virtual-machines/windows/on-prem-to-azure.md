...
| Scénář                                                                                                                         | Dokumentace                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Máte existující instance AWS EC2, které může chcete migrovat na Azure spravované disky                                     | [Přesunout virtuální počítač z Amazon Web Services (AWS) do Azure](aws-to-azure.md)                           |
| Máte z virtuálního počítače a jiné virtualizační platforma, která chcete použít pro použití jako obrázek vytvořit víc virtuálních počítačů Azure. | [Nahrát zobecněný virtuální pevný disk a použít ho k vytvoření nové virtuální počítače v Azure](upload-generalized-managed.md) |
...
Disky systému Azure spravované usnadňuje správu virtuálních počítačů odebráním potřeba spravovat účty úložiště. Spravovat disky také výhody z vyšší spolehlivost virtuálních počítačů ve skupině dostupnosti. Zajišťuje, že disky různé virtuální počítače ve skupině dostupnosti bude dostatečně od sebe navzájem oddělené předejdete jediný bod selhání. Automaticky umístí disky pro různé virtuální počítače do skupiny dostupnosti v různých jednotek škálování úložiště (razítka) omezující vliv jednoho úložiště škálování jednotky chyby způsobené hardwaru a chyby softwaru. V závislosti na vašich potřebách můžete vybrat ze dvou typů možností úložiště: 
 
- [Pro prémiové disky spravované](../../storage/common/storage-premium-storage.md) jsou plnou stavu jednotky SSD (Solid-State Drive) na základě úložiště úložná média, který dodává highperformance, podporu disků s nízkou latencí pro virtuální počítače běžící I náročnými úlohy. Migrací prémiové disky spravované můžete využít výhod rychlosti a výkonu z těchto disků.  
