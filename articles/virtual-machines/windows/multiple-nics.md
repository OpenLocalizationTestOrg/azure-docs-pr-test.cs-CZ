...
Podrobné informace, včetně toho, jak vytvořit několik síťových adaptérů v rámci své vlastní skripty prostředí PowerShell najdete v části [nasazení virtuálních počítačů více Síťových](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md).
...
Pokud chcete přidat do existující virtuální počítač virtuální síťovou kartu, můžete zrušit přidělení virtuálního počítače, přidejte virtuální síťovou kartu a pak spusťte virtuální počítač.
