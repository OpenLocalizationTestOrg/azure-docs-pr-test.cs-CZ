...
Při navrhování infrastruktury aplikace, naplánování aplikačními vrstvami používat. Nastaví skupiny virtuálních počítačů, které slouží ke stejnému účelu v na dostupnost, jako je například sadu dostupnosti pro vaše klientské virtuální počítače se systémem nginx nebo Apache. Vytvořte samostatnou sadu dostupnosti pro virtuální počítače back-end s MongoDB nebo MySQL. Cílem je zajistit, že jednotlivé komponenty aplikace je chráněn skupinu dostupnosti a alespoň jednou se instance vždy zůstane spuštěný.
