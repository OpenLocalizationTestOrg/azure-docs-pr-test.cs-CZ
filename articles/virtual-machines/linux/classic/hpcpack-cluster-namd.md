...
Další možnosti spuštění úloh HPC pro Linux v Azure najdete v tématu [technických prostředcích pro batch a vysoce výkonné výpočty](../../../batch/batch-hpc-solutions.md).
