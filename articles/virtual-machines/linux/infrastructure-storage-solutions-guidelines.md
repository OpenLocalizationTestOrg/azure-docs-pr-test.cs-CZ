...
* Vytvořte sadu účtů úložiště pomocí zásady vytváření názvů. Můžete použít rozhraní příkazového řádku Azure nebo na portálu.
...
Disky operačního systému a datové disky mají maximální velikost 4 TB. Správce logických svazek (LVM) můžete překročí toto omezení podle sdružování společně datových disků na logické svazky přesahující 1023GB pro virtuální počítač.
...
Kromě toho umožňuje vytvářet větší než 1023 GB disky v mnoha případech pomocí proložení pro datové disky zlepšuje výkon tím, že několik objektů blob pro zálohování úložiště pro jeden svazek. S proložení, vstupně-výstupních operací nutná k zápisu a čtení dat z jednoho logického disku pokračuje paralelně.
