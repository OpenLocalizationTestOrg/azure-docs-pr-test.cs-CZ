...
* Dva servery nginx spuštěným klientem hello front-endu v webovou vrstvu
...
* **Storage úrovně Premium** hello MongoDB horizontálně dělené clusteru serverů a jejich datových disků.
...
* **azos použijte jako db** pro hello servery v clusteru horizontálně dělené MongoDB hello
...
* **azos použití virtuálních počítačů db01** hello první MongoDB serveru v clusteru hello
* **azos použití virtuálních počítačů db02** hello druhý MongoDB serveru v clusteru hello
