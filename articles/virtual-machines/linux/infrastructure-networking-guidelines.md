...
Vzhledem k tomu, že se nepřipojí k síti na pracovišti, jen Azure virtuální sítě můžete použít libovolnou část prostor privátní IP adresy. Adresní prostor může být stejné privátní prostor, který je v použít místní.

### <a name="cross-premises-virtual-networks"></a>Mezi různými místy virtuální sítě
Pokud místní uživatelé a počítače vyžadovat probíhající připojení k virtuální počítače ve virtuální síť Azure, vytvořte virtuální síť mezi různými místy. Připojte virtuální síť k vaší místní sítí s ExpressRoute nebo připojení site-to-site VPN.
...
Stejně jako u místní fyzické síťové infrastruktury, virtuálních sítí Azure může obsahovat více než jen podsítě a IP adresy. Při navrhování infrastruktury aplikace, můžete začlenit některé z těchto dalších součástí:
