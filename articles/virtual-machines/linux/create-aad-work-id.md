...
---
# <a name="creating-a-work-or-school-identity-in-azure-active-directory-to-use-with-linux-vms"></a>Vytváření pracovního nebo školního identity v Azure Active Directory pro použití s virtuální počítače s Linuxem
