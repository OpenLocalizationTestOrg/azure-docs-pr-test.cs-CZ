...
Najít v dokumentaci, které potřebujete k vytvoření a správa virtuálních počítačů založených na systému Linux v modelu nasazení classic.
...
* [Časté otázky o Azure virtuální počítače vytvořené pomocí modelu nasazení classic](classic/faq.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Přihlaste se k virtuální počítač Linux pomocí portálu Azure classic](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

## <a name="set-up"></a>Nastavení
* [Nainstalovat Azure rozhraní příkazového řádku (Azure CLI)](../../cli-install-nodejs.md)

## <a name="tutorials"></a>Kurzy
* [Zásobník svítilna nainstalovat na virtuální počítač s Linuxem v Azure](create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Použití rozšíření Docker VM z rozhraní příkazového řádku Azure (Azure CLI)](classic/cli-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Použití rozšíření Docker VM z webu Azure Portal](classic/portal-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Jak použít počítač s Dockerem v Azure](docker-machine.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Jak nakonfigurovat sadu dostupnosti pro virtuální počítače v modelu nasazení classic](../windows/classic/configure-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Naplánování plánované údržby na virtuálních počítačích Azure](classic/planned-maintenance-schedule.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Správa dostupnosti virtuálních počítačů](../windows/manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Základy: zachycení virtuálního počítače s Linuxem vytvoříte šablonu](classic/capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Postup resetování hesla nebo SSH vlastnosti pro Linux](classic/reset-access.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Vložení vlastní Data do virtuálního počítače pro použití s inicializací cloudu](../windows/classic/inject-custom-data.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)

## <a name="storage"></a>Úložiště
* [Datový Disk se připojuje k virtuálního počítače s Linuxem](../windows/classic/attach-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Jak nastavit koncové body na klasické virtuální počítač v Azure](../windows/classic/setup-endpoints.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)

## <a name="troubleshooting"></a>Řešení potíží
* [Řešení potíží s Secure Shell (SSH) připojení k virtuálnímu počítači systémem Linux Azure](troubleshoot-ssh-connection.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
Tady jsou pro blogy od Microsoftu, stránky Technet a externí servery, nikoli Azure.com dokumentaci, jak je uvedeno výše. Azure a open source výpočetní světě jsou přesunutí fast cíle, je téměř jisté, že jsou zastaralé, odkazy na následující *navzdory* fakt, že provedeme snažit co nejlépe průběžně novější témata přidání a odebrání zastaralých ty. Pokud jsme jeden provedena, prosím dejte nám vědět, v komentářích nebo odeslat žádost o přijetí změn pro naše [úložiště GitHub](https://github.com/Azure/azure-content/).
...
* [Postup nasazení Image virtuálního počítače CentOS z OpenLogic](https://azure.microsoft.com/blog/2013/01/11/deploying-openlogic-centos-images-on-windows-azure-virtual-machines/)
...
* [Redis v systému Windows ve službě Azure Redis Cache](http://msopentech.com/blog/2014/05/12/redis-on-windows/)
...
Jako na světě devops správu a optimalizaci je poměrně obsáhlou a změna velmi rychle, měli byste zvážit v seznamu níže počáteční bod.
