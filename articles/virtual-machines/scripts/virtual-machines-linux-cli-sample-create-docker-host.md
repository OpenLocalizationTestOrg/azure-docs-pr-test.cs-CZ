...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/virtual-machine/create-docker-host/create-docker-host.sh "hostitelů Docker")]
...
| [Vytvoření virtuálního počítače az](https://docs.microsoft.com/cli/azure/vm#create) | Vytvoří virtuální počítač a připojí jej k síťové karty, virtuální sítě, podsítě a skupinu zabezpečení sítě. Tento příkaz také Určuje bitovou kopii virtuálního počítače, který se má použít a pověření pro správu.  |
| [virtuální počítač az open-port](https://docs.microsoft.com/cli/azure/vm#open-port) | Vytvoří pravidlo skupiny zabezpečení sítě chcete povolit příchozí přenosy. V této ukázce je otevřen port 80 pro přenosy protokolu HTTP. |
| [sada rozšíření virtuálního počítače Azure](https://docs.microsoft.com/cli/azure/vm/extension#set) | Přidá a spustí rozšíření virtuálního počítače k virtuálnímu počítači. V této ukázce rozšíření virtuálního počítače Docker slouží ke konfiguraci Docker hostitele.|
