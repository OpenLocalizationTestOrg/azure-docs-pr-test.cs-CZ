...
Tento skript vytvoří virtuální počítač a rozšíření vlastních skriptů DSC virtuální počítač Azure používá k instalaci a konfiguraci služby IIS. 
...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/virtual-machine/create-windows-iis-using-dsc/create-windows-iis-using-dsc.sh "rychlé vytvoření virtuálního počítače")]
...
| [nastavení rozšíření virtuálního az](https://docs.microsoft.com/cli/azure/vm#create) | Přidejte do virtuálního počítače, které vyvolá skript k instalaci IIS rozšíření vlastních skriptů. |
