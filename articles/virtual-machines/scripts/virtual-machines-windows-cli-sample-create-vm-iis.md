...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/virtual-machine/create-vm-windows-iis/create-vm-windows-iis.sh "rychlé vytvoření virtuálního počítače")]
...
| [sada rozšíření virtuálního počítače Azure](https://docs.microsoft.com/cli/azure/vm/extension#set) | Přidá a spustí rozšíření virtuálního počítače k virtuálnímu počítači. V této ukázce se používá rozšíření vlastních skriptů instalace služby IIS.|
