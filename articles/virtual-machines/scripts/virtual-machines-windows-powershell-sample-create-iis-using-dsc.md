...
Tento skript vytvoří virtuální počítač Azure systémem Windows Server 2016 a potom pomocí hello rozšíření DSC virtuálního počítače Azure tooinstall služby IIS. Po spuštění skriptu hello, budete mít přístup hello výchozí web služby IIS na hello veřejnou IP adresu hello virtuálního počítače.
