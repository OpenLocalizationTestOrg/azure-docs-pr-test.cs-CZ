...
* Pokud chcete vlastní FreeBSD tooAzure toobring, podívejte se příliš[vytvoření a nahrání virtuálního pevného disku FreeBSD tooAzure](linux/classic/freebsd-create-upload-vhd.md).
