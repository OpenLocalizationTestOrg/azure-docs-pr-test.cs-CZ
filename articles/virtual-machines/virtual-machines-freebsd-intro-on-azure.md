...
* Pokud chcete, aby vlastní FreeBSD do Azure, podívejte se na [vytvoření a nahrání virtuálního pevného disku FreeBSD do Azure](linux/classic/freebsd-create-upload-vhd.md).
