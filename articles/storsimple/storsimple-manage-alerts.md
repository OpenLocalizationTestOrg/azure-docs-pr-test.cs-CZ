...
---
# <a name="use-hello-storsimple-manager-service-tooview-and-manage-storsimple-alerts"></a>Použijte tooview služby StorSimple Manager hello a Správa výstrah StorSimple
## <a name="overview"></a>Přehled
Hello **výstrahy** ve hello služby StorSimple Manager poskytuje způsob pro vás tooreview a zrušte zaškrtnutí StorSimple výstrahy související s zařízení na základě v reálném čase. Na této kartě můžete centrálně monitorovat problémy v oblasti stavu hello zařízení StorSimple a hello celkového řešení Microsoft Azure StorSimple.
...
1. Přejděte příliš**zařízení** > **konfigurace** hello zařízení.
2. V části **nastavení výstrah**, nastavte následující hello:
...
3. toosend testovací e-mailová oznámení, klikněte na ikonu šipky hello další příliš**odeslat zkušební e-mail**. Hello služby StorSimple Manager se zobrazí stavové zprávy, jak předává hello testovací oznámení. 
4. Když hello následující zpráva se zobrazí, klikněte na tlačítko **OK**. 
   
    ![Výstrahy testování odeslaných e-mailové oznámení](./media/storsimple-manage-alerts/HCS_AlertNotificationConfig3.png)
   
   > [!NOTE]
   > Pokud hello testovací zpráva oznámení nelze odeslat, hello služby StorSimple Manager se zobrazí příslušná zpráva. Klikněte na tlačítko **OK**, počkejte několik minut a potom opakujte toosend vaše testovací zpráva oznámení. 
   > 
   > 

## <a name="view-and-track-alerts"></a>Zobrazení a sledovat výstrahy
řídicí panel služby StorSimple Manager Hello poskytuje stručný přehled hello počet výstrah v zařízeních, uspořádané podle úrovně závažnosti.

![Řídicí panel výstrahy](./media/storsimple-manage-alerts/admin_alerts_dashboard.png)

Kliknutím na úroveň závažnosti hello otevře hello **výstrahy** kartě hello výsledky obsahovat pouze hello výstrahy, které odpovídají této úrovně závažnosti.
...
Pokud potřebujete toosend hello informace tooMicrosoft podpory můžete zkopírovat hello podrobnosti výstrahy tooa textového souboru. Po a potom hello doporučení a vyřešit hello podmínka pro upozornění na místě, byste měli vymazat hello výstrahy ze zařízení hello výběrem hello upozornění v hello **výstrahy** kartě a kliknutím na **vymazat**. tooclear více výstrah, vyberte všechny výstrahy, klikněte na možnost žádný sloupec s výjimkou hello **výstraha** sloupec a pak klikněte na tlačítko **zrušte** po výběru všechny hello výstrahy toobe vymazán. Mějte na paměti některé výstrahy jsou po vyřešení problému hello nebo když systém hello se novými informacemi aktualizují hello výstrahy automaticky vymazány.
...
Možná bude efektivnější toorun sestavy výstrah tak, aby můžete zkontrolovat a poté je smažte ve skupinách. Kromě toho hello **výstrahy** kartě může zobrazit oznámení, too250. Pokud byl překročen počet výstrah, zobrazí se všechny výstrahy v hello výchozí zobrazení. Zkombinováním hello toocustomize pole, které výstrahy se zobrazují následující:
...
| Bylo zjištěno brzké selhání disku. | Bylo zjištěno brzké selhání disku. |Zjistili jsme chybu brzké jednotky pro hello hardwarová součást ' jednotka ve slotu <*pozice ID*>, skříň <*skříň ID*>'. Zvažte nahrazení jednotce. <br> Než začnete Výměna disku hello, projděte si následující informace hello.<br><br>Pokud vaše zařízení má více než jednoho disku, který selhal, neodstraňujte kdykoli víc než jeden SSD nebo pevný disk. Díky tomu může dojít ke ztrátě dat.<br><br>Zajistěte, aby umístíte náhradní SSD ve slotu, která dříve obsahovala SSD. Hello totéž platí pro pevný disk.<br><br>Sloty jsou číslované z 0 too11. Poškozený disk na pozici 2 mapuje tooa selhání disku ve slotu 3 hello zařízení (z hello nahoře vlevo).<br><br>Další informace o nahrazení disku přejděte toohttps://go.microsoft.com/fwlink/?linkid=838653. Pokud problém přetrvá, obraťte se na podporu společnosti Microsoft prostřednictvím https://go.microsoft.com/fwlink/?linkid=838654. |
