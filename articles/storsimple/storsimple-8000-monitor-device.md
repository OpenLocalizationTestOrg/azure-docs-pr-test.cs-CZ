...
Monitorování konkrétní zařízení v rámci vašeho řešení StorSimple můžete použít službu StorSimple Manager zařízení. Můžete vytvořit vlastní grafy na základě vstupně-výstupní výkon, využití kapacity, propustnost sítě a metriky výkonu zařízení a připnout do řídicího panelu. Další informace, přejděte na [přizpůsobit řídicího panelu portálu](/articles/azure-portal/azure-portal-dashboards.md).
