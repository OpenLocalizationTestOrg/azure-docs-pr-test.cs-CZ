...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal"></a>Nasazení místního zařízení StorSimple v hello Government portálu
[!INCLUDE [storsimple-version-selector-deploy-gov](../../includes/storsimple-version-selector-deploy-gov.md)]

## <a name="overview"></a>Přehled
Vítejte tooMicrosoft nasazení zařízení StorSimple v Azure. Tyto kurzy nasazení se vztahují toohello StorSimple řady 8000 spouštění Update 1 softwaru v hello portálu Azure Government. Tato série kurzů popisuje, jak tooconfigure zařízení StorSimple a zahrnuje kontrolní seznam konfigurace, požadavky konfigurace a podrobnou konfiguraci kroky.
...
| &nbsp; |Registrační klíč služby |Tento klíč se generují z hello portálu Azure. | |
