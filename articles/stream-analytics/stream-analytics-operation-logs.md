...
## <a name="find-operation-logs-in-the-azure-management-portal"></a>Najít operaci protokoly na portálu správy Azure
...
1. Klikněte na **Management Services** v [portálu Azure Classic](https://manage.windowsazure.com).
...
Otevře se okno zobrazení událostí za posledních 7 dnů pro všechny prostředky ve vašem předplatném.  Můžete filtrovat, zobrazí se události zadejte typ nebo časového rámce kliknutím **filtru** příkaz.
...
V portálu pro správu Azure, klikněte na **podrobnosti** tlačítko v dolní části okna zobrazíte další podrobnosti o zvolenou událost. 
...
Odtud můžete otevřít **podrobností** tak, že kliknete na události.
...
V portálu pro správu Azure klikněte na ikonu hledání a typ "se nezdařilo". To dává výsledku všechny protokoly s chybami. 
