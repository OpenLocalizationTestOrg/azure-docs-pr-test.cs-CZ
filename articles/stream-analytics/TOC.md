...
### [Výstup tooAzure funkce](stream-analytics-functions-redis.md)
### [Výstup tooData Lake Store](stream-analytics-data-lake-output.md)
### [Výstup tooDocumentDB](stream-analytics-documentdb-output.md)
...
### [Propustnost tooincrease škálování](stream-analytics-scale-jobs.md)
...
### [Použití hello Management .NET SDK](stream-analytics-dotnet-management-sdk.md)
