...
Každý koncový bod má rozhraní API pro spuštění dávky a synchronní zpracování. Stream Analytics používá synchronní zpracování. Název konkrétní službu [požadavků a odpovědí služby](../machine-learning/machine-learning-consume-web-services.md) v AzureML studio.
