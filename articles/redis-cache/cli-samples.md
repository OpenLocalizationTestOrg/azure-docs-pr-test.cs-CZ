...
| [Připojení webové aplikace do mezipaměti redis](./../app-service-web/scripts/app-service-cli-app-service-redis.md) | Vytvoří webové aplikace Azure a mezipaměti redis a potom přidá podrobnosti připojení redis nastavení aplikace. |
|**Odstranit mezipaměť**||
