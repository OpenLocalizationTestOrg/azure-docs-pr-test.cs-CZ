...
Stránce [porovnání Azure Web Apps, cloudové služby a virtuální počítače](app-service-web/choose-web-site-cloud-service-vm.md) poskytuje podrobnější informace o tom, jak zvolit výpočetní model.
