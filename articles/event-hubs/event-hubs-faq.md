...
Jednotky propustnosti centra událostí se účtují HODINOVĚ, založené na maximální počet jednotek vybraný během zadané hodiny.
...
Snímek se povolí, když má povolenou možnost zachycení žádné Centrum událostí v oboru názvů. Zaznamenat centra událostí se účtují HODINOVĚ za zakoupené jednotky propustnosti. Počet jednotek propustnosti zvětšit nebo zmenšit, zachycení událostí centra fakturace odráží tyto změny v přírůstcích po celou hodinu. Další informace o fakturaci zaznamenat centra událostí najdete v tématu [informace o cenách služby Event Hubs](https://azure.microsoft.com/pricing/details/event-hubs/).
