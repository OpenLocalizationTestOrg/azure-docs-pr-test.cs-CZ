...
1. V [portál Azure](https://portal.azure.com), klikněte na aplikační služby >  **&lt;any_app >** > **přihlašovací údaje nasazení**.
    ...
    > [!NOTE]
    > Na portálu musí mít aspoň jednu aplikaci, než se dostanete k okno přihlašovací údaje nasazení. Nicméně s [rozhraní příkazového řádku Azure](app-service-web-app-azure-resource-manager-xplat-cli.md), můžete nakonfigurovat přihlašovací údaje uživatele bez stávající aplikace.
