...
### <a name="alert-rules-for-status-codes-403-and-500s-high-cpu-and-http-queue-length"></a>Pravidla výstrah pro stavové kódy 403 a 500's, vysoké využití procesoru a délka fronty HTTP
    {
      "apiVersion": "2014-04-01",
...
### <a name="app-insights"></a>Přehled aplikace
    {
      "apiVersion": "2014-04-01",
