...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/app-service/connect-to-redis/connect-to-redis.sh "Azure Redis Cache")]
...
| [Vytvoření az redis](https://docs.microsoft.com/en-us/cli/azure/redis#create) | Vytvořte novou instanci služby Redis Cache. Toto je, kde bude uložena data. |
| [AZ redis seznamu klíčů](https://docs.microsoft.com/en-us/cli/azure/redis#list-keys) | Uvádí přístupové klíče pro instanci služby redis cache. |
