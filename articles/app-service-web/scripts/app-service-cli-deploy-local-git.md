...
| [není nastavený az webapp nasazení uživatele](https://review.docs.microsoft.com/cli/azure/webapp/deployment/user#set) | Nastaví přihlašovací údaje hello nasazení úrovni účtu pro službu App Service. |
