...
**Webové sokety**. Nastavit **ON** povolit protokol WebSocket; například, pokud vaše webová aplikace používá [ASP.NET SignalR] nebo [socket.io].
...
* Nastavte průběžné nasazování. V tématu [pomocí Git, jak nasadit webové aplikace v Azure App Service](web-sites-deploy.md).
