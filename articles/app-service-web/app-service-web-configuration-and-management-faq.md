...
Pokud váš web hostovaný ve službě App Service Environment pro PowerApps, zjistěte, jak získat odchozí IP adresu, najdete v článku [odchozí síťové adresy](app-service-app-service-environment-network-architecture-overview.md#outbound-network-addresses).
...
Další informace najdete v tématu [postup vytvoření služby App Service Environment](app-service-web-how-to-create-an-app-service-environment.md).
...
Podrobnou dokumentaci pro ověřování a autorizace ve službě App Service najdete v tématu [zabezpečení služby App Service](../app-service/app-service-security-readme.md). Dokumentace obsahuje také informace o nastavení služby App Service pro různé identifikovat zprostředkovatele přihlášení:
