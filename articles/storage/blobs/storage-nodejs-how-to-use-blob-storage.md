...
Příklad nastavení proměnných prostředí [portál Azure](https://portal.azure.com) webové aplikace Azure, najdete v části [webové aplikace Node.js pomocí služby Azure Table](../../app-service-web/storage-nodejs-use-table-storage-web-site.md).
...
[Sestavení a nasazení webové aplikace Node.js do Azure pomocí Web Matrix]: https://www.microsoft.com/web/webmatrix/  
