...
[Část 1](../common/storage-dotnet-shared-access-signature-part-1.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json) tohoto kurzu prozkoumali sdílené přístupové podpisy (SAS) a vysvětlení osvědčené postupy pro jejich použití. Část 2 ukazuje, jak toogenerate a pak použít sdílené přístupové podpisy pomocí úložiště objektů Blob. Příklady Hello jsou napsané v C# a používají hello Klientská knihovna pro úložiště Azure pro .NET. Hello příklady v tomto kurzu:
...
* [Sdílené přístupové podpisy, část 1: Vysvětlení modelu SAS hello](../common/storage-dotnet-shared-access-signature-part-1.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)
