...
## <a name="download-and-install-azcopy"></a><span data-ttu-id="7daa8-112">Stáhněte a nainstalujte AzCopy</span><span class="sxs-lookup"><span data-stu-id="7daa8-112">Download and install AzCopy</span></span>
...
### <a name="download-blobs-with-specified-prefix"></a><span data-ttu-id="7daa8-132">Stáhnout objekty BLOB se zadanou předponou.</span><span class="sxs-lookup"><span data-stu-id="7daa8-132">Download blobs with specified prefix</span></span>
...
### <a name="upload-all-files"></a><span data-ttu-id="7daa8-148">Odeslat všechny soubory.</span><span class="sxs-lookup"><span data-stu-id="7daa8-148">Upload all files</span></span>
...
<span data-ttu-id="7daa8-155">Předpokládejme následující soubory jsou umístěny ve složce `C:\myfolder`:</span><span class="sxs-lookup"><span data-stu-id="7daa8-155">Assume the following files reside in folder `C:\myfolder`:</span></span>
...
<span data-ttu-id="7daa8-169">Všimněte si, že je nutné mít přístup pro čtení geograficky redundantní úložiště s povoleným.</span><span class="sxs-lookup"><span data-stu-id="7daa8-169">Note that you must have read-access geo-redundant storage enabled.</span></span>
...
## <a name="table-export"></a><span data-ttu-id="7daa8-202">Tabulka: Export</span><span class="sxs-lookup"><span data-stu-id="7daa8-202">Table: Export</span></span>
...
## <a name="table-import"></a><span data-ttu-id="7daa8-235">Tabulka: Import</span><span class="sxs-lookup"><span data-stu-id="7daa8-235">Table: Import</span></span>
...
### <a name="import-entities-to-table-using-blobs"></a><span data-ttu-id="7daa8-250">Importovat entity do tabulky pomocí objektů BLOB</span><span class="sxs-lookup"><span data-stu-id="7daa8-250">Import entities to table using blobs</span></span>
...
### <a name="use-a-response-file-to-specify-command-line-parameters"></a><span data-ttu-id="7daa8-258">Zadejte parametry příkazového řádku pomocí souboru odpovědí</span><span class="sxs-lookup"><span data-stu-id="7daa8-258">Use a response file to specify command-line parameters</span></span>
...
<span data-ttu-id="7daa8-313">**Platí pro:** objekty BLOB, soubory, tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-313">**Applicable to:** Blobs, Files, Tables</span></span>
...
<span data-ttu-id="7daa8-329">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-329">**Applicable to:** Blobs, Files</span></span>
...
### <a name="sourcesassas-token"></a><span data-ttu-id="7daa8-342">/ SourceSAS: "tokenu sas"</span><span class="sxs-lookup"><span data-stu-id="7daa8-342">/SourceSAS:"sas-token"</span></span>
...
<span data-ttu-id="7daa8-357">**Platí pro:** objektů BLOB</span><span class="sxs-lookup"><span data-stu-id="7daa8-357">**Applicable to:** Blobs</span></span>
...
<span data-ttu-id="7daa8-382">Pokud soubor deníku neexistuje, AzCopy zkontroluje, zda příkazového řádku, který můžete vložit odpovídá příkazového řádku v souboru deníku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-382">If the journal file does exist, AzCopy will check whether the command line that you input matches the command line in the journal file.</span></span> <span data-ttu-id="7daa8-383">Pokud se dva příkazové řádky shodují, obnoví AzCopy neúplné operaci.</span><span class="sxs-lookup"><span data-stu-id="7daa8-383">If the two command lines match, AzCopy resumes the incomplete operation.</span></span> <span data-ttu-id="7daa8-384">Pokud se neshodují, zobrazí se výzva k buď přepsat soubor deníku spustit novou operaci, nebo zrušit aktuální operace.</span><span class="sxs-lookup"><span data-stu-id="7daa8-384">If they do not match, you will be prompted to either overwrite the journal file to start a new operation, or to cancel the current operation.</span></span>

<span data-ttu-id="7daa8-385">Soubor deníku se odstraní po úspěšném dokončení operace.</span><span class="sxs-lookup"><span data-stu-id="7daa8-385">The journal file is deleted upon successful completion of the operation.</span></span>

<span data-ttu-id="7daa8-386">Všimněte si, že obnovení ze souboru deníku vytvořeného v předchozí verzi AzCopy operace není podporována.</span><span class="sxs-lookup"><span data-stu-id="7daa8-386">Note that resuming an operation from a journal file created by a previous version of AzCopy is not supported.</span></span>

<span data-ttu-id="7daa8-387">**Platí pro:** objekty BLOB, soubory, tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-387">**Applicable to:** Blobs, Files, Tables</span></span>

### <a name="parameter-file"></a><span data-ttu-id="7daa8-388">/@:"Parameter-File"</span><span class="sxs-lookup"><span data-stu-id="7daa8-388">/@:"parameter-file"</span></span>
<span data-ttu-id="7daa8-389">Určuje soubor, který obsahuje parametry.</span><span class="sxs-lookup"><span data-stu-id="7daa8-389">Specifies a file that contains parameters.</span></span> <span data-ttu-id="7daa8-390">AzCopy zpracovává parametry v souboru stejně, jako kdyby kdyby byly zadány na příkazovém řádku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-390">AzCopy processes the parameters in the file just as if they had been specified on the command line.</span></span>

<span data-ttu-id="7daa8-391">V souboru odpovědí můžete zadat několik parametrů na jeden řádek nebo zadejte každý parametr na samostatném řádku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-391">In a response file, you can either specify multiple parameters on a single line, or specify each parameter on its own line.</span></span> <span data-ttu-id="7daa8-392">Všimněte si, že jednotlivé parametr nemůže zahrnovat více řádků.</span><span class="sxs-lookup"><span data-stu-id="7daa8-392">Note that an individual parameter cannot span multiple lines.</span></span>

<span data-ttu-id="7daa8-393">Soubory odezvy může zahrnovat komentáře řádky, které začínají symbolem #.</span><span class="sxs-lookup"><span data-stu-id="7daa8-393">Response files can include comments lines that begin with the # symbol.</span></span>

<span data-ttu-id="7daa8-394">Můžete zadat několik souborů odpovědi.</span><span class="sxs-lookup"><span data-stu-id="7daa8-394">You can specify multiple response files.</span></span> <span data-ttu-id="7daa8-395">Všimněte si však, že AzCopy nepodporuje soubory vnořené odezvy.</span><span class="sxs-lookup"><span data-stu-id="7daa8-395">However, note that AzCopy does not support nested response files.</span></span>

<span data-ttu-id="7daa8-396">**Platí pro:** objekty BLOB, soubory, tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-396">**Applicable to:** Blobs, Files, Tables</span></span>

### <a name="y"></a><span data-ttu-id="7daa8-397">/Y</span><span class="sxs-lookup"><span data-stu-id="7daa8-397">/Y</span></span>
<span data-ttu-id="7daa8-398">Potlačí všechny výzvy potvrzení AzCopy.</span><span class="sxs-lookup"><span data-stu-id="7daa8-398">Suppresses all AzCopy confirmation prompts.</span></span>

<span data-ttu-id="7daa8-399">**Platí pro:** objekty BLOB, soubory, tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-399">**Applicable to:** Blobs, Files, Tables</span></span>

### <a name="l"></a><span data-ttu-id="7daa8-400">/ L</span><span class="sxs-lookup"><span data-stu-id="7daa8-400">/L</span></span>
<span data-ttu-id="7daa8-401">Určuje operaci výpis pouze; žádná data budou zkopírována.</span><span class="sxs-lookup"><span data-stu-id="7daa8-401">Specifies a listing operation only; no data is copied.</span></span>

<span data-ttu-id="7daa8-402">AzCopy bude interpretovat použití této možnosti simulace pro spuštění příkazového řádku bez možnosti/l a počet, kolik objekty se zkopírují, můžete zadat možnost /V ve stejnou dobu a zkontrolujte, které objekty se zkopírují v podrobného protokolování.</span><span class="sxs-lookup"><span data-stu-id="7daa8-402">AzCopy will interpret the using of this option as a simulation for running the command line without this option /L and count how many objects will be copied, you can specify option /V at the same time to check which objects will be copied in the verbose log.</span></span>

<span data-ttu-id="7daa8-403">Chování tato možnost je určena také umístění zdroje dat a přítomnost rekurzivní možnost /S a soubor vzor možnost režim /Pattern.</span><span class="sxs-lookup"><span data-stu-id="7daa8-403">The behavior of this option is also determined by the location of the source data and the presence of the recursive mode option /S and file pattern option /Pattern.</span></span>

<span data-ttu-id="7daa8-404">AzCopy vyžaduje oprávnění seznamu a přečtěte si toto umístění zdroje, při použití této možnosti.</span><span class="sxs-lookup"><span data-stu-id="7daa8-404">AzCopy requires LIST and READ permission of this source location when using this option.</span></span>

<span data-ttu-id="7daa8-405">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-405">**Applicable to:** Blobs, Files</span></span>

### <a name="mt"></a><span data-ttu-id="7daa8-406">/ MT</span><span class="sxs-lookup"><span data-stu-id="7daa8-406">/MT</span></span>
<span data-ttu-id="7daa8-407">Nastaví čas poslední změny stažený soubor být stejný jako zdrojový objekt blob nebo souboru.</span><span class="sxs-lookup"><span data-stu-id="7daa8-407">Sets the downloaded file's last-modified time to be the same as the source blob or file's.</span></span>

<span data-ttu-id="7daa8-408">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-408">**Applicable to:** Blobs, Files</span></span>

### <a name="xn"></a><span data-ttu-id="7daa8-409">/XN</span><span class="sxs-lookup"><span data-stu-id="7daa8-409">/XN</span></span>
<span data-ttu-id="7daa8-410">Vyloučí novější zdrojovému prostředku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-410">Excludes a newer source resource.</span></span> <span data-ttu-id="7daa8-411">Prostředek se nezkopírují, pokud čas poslední změny zdroje je stejná nebo novější než cílový.</span><span class="sxs-lookup"><span data-stu-id="7daa8-411">The resource will not be copied if the last modified time of the source is the same or newer than destination.</span></span>

<span data-ttu-id="7daa8-412">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-412">**Applicable to:** Blobs, Files</span></span>

### <a name="xo"></a><span data-ttu-id="7daa8-413">/XO</span><span class="sxs-lookup"><span data-stu-id="7daa8-413">/XO</span></span>
<span data-ttu-id="7daa8-414">Vyloučí starší zdrojovému prostředku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-414">Excludes an older source resource.</span></span> <span data-ttu-id="7daa8-415">Prostředek se nezkopírují, pokud čas poslední změny zdroje je stejná nebo starší než cílový.</span><span class="sxs-lookup"><span data-stu-id="7daa8-415">The resource will not be copied if the last modified time of the source is the same or older than destination.</span></span>

<span data-ttu-id="7daa8-416">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-416">**Applicable to:** Blobs, Files</span></span>

### <a name="a"></a><span data-ttu-id="7daa8-417">/A</span><span class="sxs-lookup"><span data-stu-id="7daa8-417">/A</span></span>
<span data-ttu-id="7daa8-418">Ukládání pouze soubory, které mají atribut Archivovat nastaven.</span><span class="sxs-lookup"><span data-stu-id="7daa8-418">Uploads only files that have the Archive attribute set.</span></span>

<span data-ttu-id="7daa8-419">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-419">**Applicable to:** Blobs, Files</span></span>

### <a name="iarashcnetoi"></a><span data-ttu-id="7daa8-420">/ IA: [RASHCNETOI]</span><span class="sxs-lookup"><span data-stu-id="7daa8-420">/IA:[RASHCNETOI]</span></span>
<span data-ttu-id="7daa8-421">Ukládání pouze soubory, které mají všechny zadané atributy sady.</span><span class="sxs-lookup"><span data-stu-id="7daa8-421">Uploads only files that have any of the specified attributes set.</span></span>

<span data-ttu-id="7daa8-422">Dostupné atributy patří:</span><span class="sxs-lookup"><span data-stu-id="7daa8-422">Available attributes include:</span></span>

* <span data-ttu-id="7daa8-423">R = soubory jen pro čtení</span><span class="sxs-lookup"><span data-stu-id="7daa8-423">R = Read-only files</span></span>
* <span data-ttu-id="7daa8-424">A = soubory připravené k archivaci</span><span class="sxs-lookup"><span data-stu-id="7daa8-424">A = Files ready for archiving</span></span>
* <span data-ttu-id="7daa8-425">S = systémové soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-425">S = System files</span></span>
* <span data-ttu-id="7daa8-426">H = skryté soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-426">H = Hidden files</span></span>
* <span data-ttu-id="7daa8-427">C = komprimované soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-427">C = Compressed files</span></span>
* <span data-ttu-id="7daa8-428">N = normální soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-428">N = Normal files</span></span>
* <span data-ttu-id="7daa8-429">E = šifrovaných souborů</span><span class="sxs-lookup"><span data-stu-id="7daa8-429">E = Encrypted files</span></span>
* <span data-ttu-id="7daa8-430">T = dočasné soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-430">T = Temporary files</span></span>
* <span data-ttu-id="7daa8-431">O = Offline soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-431">O = Offline files</span></span>
* <span data-ttu-id="7daa8-432">I = není indexované soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-432">I = Non-indexed files</span></span>

<span data-ttu-id="7daa8-433">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-433">**Applicable to:** Blobs, Files</span></span>

### <a name="xarashcnetoi"></a><span data-ttu-id="7daa8-434">/ XA: [RASHCNETOI]</span><span class="sxs-lookup"><span data-stu-id="7daa8-434">/XA:[RASHCNETOI]</span></span>
<span data-ttu-id="7daa8-435">Vyloučí soubory, které mají všechny zadané atributy sady.</span><span class="sxs-lookup"><span data-stu-id="7daa8-435">Excludes files that have any of the specified attributes set.</span></span>

<span data-ttu-id="7daa8-436">Dostupné atributy patří:</span><span class="sxs-lookup"><span data-stu-id="7daa8-436">Available attributes include:</span></span>

* <span data-ttu-id="7daa8-437">R = soubory jen pro čtení</span><span class="sxs-lookup"><span data-stu-id="7daa8-437">R = Read-only files</span></span>
* <span data-ttu-id="7daa8-438">A = soubory připravené k archivaci</span><span class="sxs-lookup"><span data-stu-id="7daa8-438">A = Files ready for archiving</span></span>
* <span data-ttu-id="7daa8-439">S = systémové soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-439">S = System files</span></span>
* <span data-ttu-id="7daa8-440">H = skryté soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-440">H = Hidden files</span></span>
* <span data-ttu-id="7daa8-441">C = komprimované soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-441">C = Compressed files</span></span>
* <span data-ttu-id="7daa8-442">N = normální soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-442">N = Normal files</span></span>
* <span data-ttu-id="7daa8-443">E = šifrovaných souborů</span><span class="sxs-lookup"><span data-stu-id="7daa8-443">E = Encrypted files</span></span>
* <span data-ttu-id="7daa8-444">T = dočasné soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-444">T = Temporary files</span></span>
* <span data-ttu-id="7daa8-445">O = Offline soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-445">O = Offline files</span></span>
* <span data-ttu-id="7daa8-446">I = není indexované soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-446">I = Non-indexed files</span></span>

<span data-ttu-id="7daa8-447">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-447">**Applicable to:** Blobs, Files</span></span>

### <a name="delimiterdelimiter"></a><span data-ttu-id="7daa8-448">/ Oddělovač: "oddělovač.</span><span class="sxs-lookup"><span data-stu-id="7daa8-448">/Delimiter:"delimiter"</span></span>
<span data-ttu-id="7daa8-449">Označuje znak oddělovač použitý pro vymezení virtuálních adresářů v název objektu blob.</span><span class="sxs-lookup"><span data-stu-id="7daa8-449">Indicates the delimiter character used to delimit virtual directories in a blob name.</span></span>

<span data-ttu-id="7daa8-450">Ve výchozím nastavení používá AzCopy / jako oddělovací znak.</span><span class="sxs-lookup"><span data-stu-id="7daa8-450">By default, AzCopy uses / as the delimiter character.</span></span> <span data-ttu-id="7daa8-451">Ale AzCopy podporuje používání libovolného znaku běžné (například @, #, nebo %) jako oddělovač.</span><span class="sxs-lookup"><span data-stu-id="7daa8-451">However, AzCopy supports using any common character (such as @, #, or %) as a delimiter.</span></span> <span data-ttu-id="7daa8-452">Pokud potřebujete použít jeden z těchto speciálních znaků v příkazovém řádku, uzavřete název souboru s dvojité uvozovky.</span><span class="sxs-lookup"><span data-stu-id="7daa8-452">If you need to include one of these special characters on the command line, enclose the file name with double quotes.</span></span>

<span data-ttu-id="7daa8-453">Tato možnost platí pouze pro stahování objekty BLOB.</span><span class="sxs-lookup"><span data-stu-id="7daa8-453">This option is only applicable for downloading blobs.</span></span>

<span data-ttu-id="7daa8-454">**Platí pro:** objektů BLOB</span><span class="sxs-lookup"><span data-stu-id="7daa8-454">**Applicable to:** Blobs</span></span>

### <a name="ncnumber-of-concurrent-operations"></a><span data-ttu-id="7daa8-455">/ NC: "číslo z souběžných operace"</span><span class="sxs-lookup"><span data-stu-id="7daa8-455">/NC:"number-of-concurrent-operations"</span></span>
<span data-ttu-id="7daa8-456">Určuje počet souběžných operací.</span><span class="sxs-lookup"><span data-stu-id="7daa8-456">Specifies the number of concurrent operations.</span></span>

<span data-ttu-id="7daa8-457">AzCopy ve výchozím nastavení spustí počet souběžných operací, pokud chcete zvýšit propustnost dat přenosu.</span><span class="sxs-lookup"><span data-stu-id="7daa8-457">AzCopy by default starts a certain number of concurrent operations to increase the data transfer throughput.</span></span> <span data-ttu-id="7daa8-458">Všimněte si, že velký počet souběžných operací v prostředí s malou šířkou pásma může zahlcovat síťové připojení a zabránit v plně dokončení operace.</span><span class="sxs-lookup"><span data-stu-id="7daa8-458">Note that large number of concurrent operations in a low-bandwidth environment may overwhelm the network connection and prevent the operations from fully completing.</span></span> <span data-ttu-id="7daa8-459">Omezení souběžných operací podle skutečné dostupnou šířku pásma sítě.</span><span class="sxs-lookup"><span data-stu-id="7daa8-459">Throttle concurrent operations based on actual available network bandwidth.</span></span>

<span data-ttu-id="7daa8-460">Horní limit pro souběžných operací je 512.</span><span class="sxs-lookup"><span data-stu-id="7daa8-460">The upper limit for concurrent operations is 512.</span></span>

<span data-ttu-id="7daa8-461">**Platí pro:** objekty BLOB, soubory, tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-461">**Applicable to:** Blobs, Files, Tables</span></span>

### <a name="sourcetypeblob--table"></a><span data-ttu-id="7daa8-462">/ SourceType: "Blob" | "Tabulka"</span><span class="sxs-lookup"><span data-stu-id="7daa8-462">/SourceType:"Blob" | "Table"</span></span>
<span data-ttu-id="7daa8-463">Určuje, že `source` prostředek je k dispozici v místním vývojovém prostředí, spouštění v emulátoru úložiště objektu blob.</span><span class="sxs-lookup"><span data-stu-id="7daa8-463">Specifies that the `source` resource is a blob available in the local development environment, running in the storage emulator.</span></span>

<span data-ttu-id="7daa8-464">**Platí pro:** objekty BLOB, tabulek</span><span class="sxs-lookup"><span data-stu-id="7daa8-464">**Applicable to:** Blobs, Tables</span></span>

### <a name="desttypeblob--table"></a><span data-ttu-id="7daa8-465">/ DestType: "Blob" | "Tabulka"</span><span class="sxs-lookup"><span data-stu-id="7daa8-465">/DestType:"Blob" | "Table"</span></span>
<span data-ttu-id="7daa8-466">Určuje, že `destination` prostředek je k dispozici v místním vývojovém prostředí, spouštění v emulátoru úložiště objektu blob.</span><span class="sxs-lookup"><span data-stu-id="7daa8-466">Specifies that the `destination` resource is a blob available in the local development environment, running in the storage emulator.</span></span>

<span data-ttu-id="7daa8-467">**Platí pro:** objekty BLOB, tabulek</span><span class="sxs-lookup"><span data-stu-id="7daa8-467">**Applicable to:** Blobs, Tables</span></span>

### <a name="pkrskey1key2key3"></a><span data-ttu-id="7daa8-468">/ PKRS: "key&#1;key&#2; klíč&#3;..."</span><span class="sxs-lookup"><span data-stu-id="7daa8-468">/PKRS:"key1#key2#key3#..."</span></span>
<span data-ttu-id="7daa8-469">Rozdělí rozsah klíče oddílu Povolit export dat v tabulce současně, což zvyšuje rychlost operace exportu.</span><span class="sxs-lookup"><span data-stu-id="7daa8-469">Splits the partition key range to enable exporting table data in parallel, which increases the speed of the export operation.</span></span>

<span data-ttu-id="7daa8-470">Pokud není tato možnost zadána, AzCopy používá jedno vlákno pro export entity tabulky.</span><span class="sxs-lookup"><span data-stu-id="7daa8-470">If this option is not specified, then AzCopy uses a single thread to export table entities.</span></span> <span data-ttu-id="7daa8-471">Například pokud uživatel zadá /PKRS: "aa #bb", pak AzCopy spustí tři souběžných operací.</span><span class="sxs-lookup"><span data-stu-id="7daa8-471">For example, if the user specifies /PKRS:"aa#bb", then AzCopy starts three concurrent operations.</span></span>

<span data-ttu-id="7daa8-472">Každé operace exportuje mezi tři rozsahy klíčů oddílu, jak je uvedeno níže:</span><span class="sxs-lookup"><span data-stu-id="7daa8-472">Each operation exports one of three partition key ranges, as shown below:</span></span>

  <span data-ttu-id="7daa8-473">[klíč prvního oddílu, aa)</span><span class="sxs-lookup"><span data-stu-id="7daa8-473">[first-partition-key, aa)</span></span>

  <span data-ttu-id="7daa8-474">[aa, bb)</span><span class="sxs-lookup"><span data-stu-id="7daa8-474">[aa, bb)</span></span>

  <span data-ttu-id="7daa8-475">[bb, klíč oddílu poslední]</span><span class="sxs-lookup"><span data-stu-id="7daa8-475">[bb, last-partition-key]</span></span>

<span data-ttu-id="7daa8-476">**Platí pro:** tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-476">**Applicable to:** Tables</span></span>

### <a name="splitsizefile-size"></a><span data-ttu-id="7daa8-477">/ SplitSize: "velikost souboru"</span><span class="sxs-lookup"><span data-stu-id="7daa8-477">/SplitSize:"file-size"</span></span>
<span data-ttu-id="7daa8-478">Určuje, v exportovaném souboru rozdělení velikost v MB, je minimální povolená hodnota je 32.</span><span class="sxs-lookup"><span data-stu-id="7daa8-478">Specifies the exported file split size in MB, the minimal value allowed is 32.</span></span>

<span data-ttu-id="7daa8-479">Pokud není tato možnost zadána, bude AzCopy exportovat data tabulky do jednoho souboru.</span><span class="sxs-lookup"><span data-stu-id="7daa8-479">If this option is not specified, AzCopy will export table data to single file.</span></span>

<span data-ttu-id="7daa8-480">Pokud data tabulky se exportují do objektu blob a velikost exportovaný soubor dosáhne 200 GB limit pro velikost objektu blob, pak AzCopy rozdělí exportovaný soubor i v případě, že není tato možnost zadána.</span><span class="sxs-lookup"><span data-stu-id="7daa8-480">If the table data is exported to a blob, and the exported file size reaches the 200 GB limit for blob size, then AzCopy will split the exported file, even if this option is not specified.</span></span>

<span data-ttu-id="7daa8-481">**Platí pro:** tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-481">**Applicable to:** Tables</span></span>

### <a name="entityoperationinsertorskip--insertormerge--insertorreplace"></a><span data-ttu-id="7daa8-482">/ EntityOperation: "InsertOrSkip" | "InsertOrMerge" | "InsertOrReplace"</span><span class="sxs-lookup"><span data-stu-id="7daa8-482">/EntityOperation:"InsertOrSkip" | "InsertOrMerge" | "InsertOrReplace"</span></span>
<span data-ttu-id="7daa8-483">Určuje chování importu dat tabulky.</span><span class="sxs-lookup"><span data-stu-id="7daa8-483">Specifies the table data import behavior.</span></span>

* <span data-ttu-id="7daa8-484">InsertOrSkip - přeskočí stávající entitu nebo vloží novou entitu, pokud neexistuje v tabulce.</span><span class="sxs-lookup"><span data-stu-id="7daa8-484">InsertOrSkip - Skips an existing entity or inserts a new entity if it does not exist in the table.</span></span>
* <span data-ttu-id="7daa8-485">InsertOrMerge - sloučí existující entitu nebo vloží novou entitu, pokud neexistuje v tabulce.</span><span class="sxs-lookup"><span data-stu-id="7daa8-485">InsertOrMerge - Merges an existing entity or inserts a new entity if it does not exist in the table.</span></span>
* <span data-ttu-id="7daa8-486">InsertOrReplace - nahrazuje stávající entitu nebo vloží novou entitu, pokud neexistuje v tabulce.</span><span class="sxs-lookup"><span data-stu-id="7daa8-486">InsertOrReplace - Replaces an existing entity or inserts a new entity if it does not exist in the table.</span></span>

<span data-ttu-id="7daa8-487">**Platí pro:** tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-487">**Applicable to:** Tables</span></span>

### <a name="manifestmanifest-file"></a><span data-ttu-id="7daa8-488">/ Manifest: "manifest – soubor"</span><span class="sxs-lookup"><span data-stu-id="7daa8-488">/Manifest:"manifest-file"</span></span>
<span data-ttu-id="7daa8-489">Určuje soubor manifestu pro tabulky exportovat a importovat operaci.</span><span class="sxs-lookup"><span data-stu-id="7daa8-489">Specifies the manifest file for the table export and import operation.</span></span>

<span data-ttu-id="7daa8-490">Tato možnost je volitelné během exportu, AzCopy vygeneruje soubor manifestu se předdefinované názvem, pokud není tato možnost zadána.</span><span class="sxs-lookup"><span data-stu-id="7daa8-490">This option is optional during the export operation, AzCopy will generate a manifest file with predefined name if this option is not specified.</span></span>

<span data-ttu-id="7daa8-491">Tato možnost je povinná během operace importu pro vyhledání datových souborů.</span><span class="sxs-lookup"><span data-stu-id="7daa8-491">This option is required during the import operation for locating the data files.</span></span>

<span data-ttu-id="7daa8-492">**Platí pro:** tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-492">**Applicable to:** Tables</span></span>

### <a name="synccopy"></a><span data-ttu-id="7daa8-493">/ SyncCopy</span><span class="sxs-lookup"><span data-stu-id="7daa8-493">/SyncCopy</span></span>
<span data-ttu-id="7daa8-494">Označuje, zda synchronně kopírování objektů BLOB nebo soubory mezi dva koncové body Azure Storage.</span><span class="sxs-lookup"><span data-stu-id="7daa8-494">Indicates whether to synchronously copy blobs or files between two Azure Storage endpoints.</span></span>

<span data-ttu-id="7daa8-495">AzCopy ve výchozím nastavení používá asynchronní kopie straně serveru.</span><span class="sxs-lookup"><span data-stu-id="7daa8-495">AzCopy by default uses server-side asynchronous copy.</span></span> <span data-ttu-id="7daa8-496">Zadejte tuto možnost, chcete-li provést synchronní kopie, která stáhne objektů BLOB nebo soubory k místní paměti a odesílá je do úložiště Azure.</span><span class="sxs-lookup"><span data-stu-id="7daa8-496">Specify this option to perform a synchronous copy, which downloads blobs or files to local memory and then uploads them to Azure Storage.</span></span>

<span data-ttu-id="7daa8-497">Tuto možnost můžete použít při kopírování souborů v rámci úložiště objektů Blob, úložiště File, nebo z úložiště objektů Blob k úložišti souborů nebo naopak.</span><span class="sxs-lookup"><span data-stu-id="7daa8-497">You can use this option when copying files within Blob storage, within File storage, or from Blob storage to File storage or vice versa.</span></span>

<span data-ttu-id="7daa8-498">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-498">**Applicable to:** Blobs, Files</span></span>

### <a name="setcontenttypecontent-type"></a><span data-ttu-id="7daa8-499">/ SetContentType: "content-type"</span><span class="sxs-lookup"><span data-stu-id="7daa8-499">/SetContentType:"content-type"</span></span>
<span data-ttu-id="7daa8-500">Určuje typ MIME pro cílové objekty BLOB nebo soubory obsahu.</span><span class="sxs-lookup"><span data-stu-id="7daa8-500">Specifies the MIME content type for destination blobs or files.</span></span>

<span data-ttu-id="7daa8-501">AzCopy nastaví typ obsahu pro objekt blob nebo soubor na application/octet-stream ve výchozím nastavení.</span><span class="sxs-lookup"><span data-stu-id="7daa8-501">AzCopy sets the content type for a blob or file to application/octet-stream by default.</span></span> <span data-ttu-id="7daa8-502">Typ obsahu pro všechny objekty BLOB nebo soubory můžete nastavit a explicitně zadat hodnotu pro tuto možnost.</span><span class="sxs-lookup"><span data-stu-id="7daa8-502">You can set the content type for all blobs or files by explicitly specifying a value for this option.</span></span>

<span data-ttu-id="7daa8-503">Pokud zadáte tuto možnost bez hodnoty, bude nastavte AzCopy, každý objekt blob nebo typ obsahu souboru podle jeho přípony.</span><span class="sxs-lookup"><span data-stu-id="7daa8-503">If you specify this option without a value, then AzCopy will set each blob or file's content type according to its file extension.</span></span>

<span data-ttu-id="7daa8-504">**Platí pro:** objekty BLOB, soubory</span><span class="sxs-lookup"><span data-stu-id="7daa8-504">**Applicable to:** Blobs, Files</span></span>

### <a name="payloadformatjson--csv"></a><span data-ttu-id="7daa8-505">/ PayloadFormat: "JSON" | "CSV"</span><span class="sxs-lookup"><span data-stu-id="7daa8-505">/PayloadFormat:"JSON" | "CSV"</span></span>
<span data-ttu-id="7daa8-506">Určuje formát souboru exportovaná data tabulky.</span><span class="sxs-lookup"><span data-stu-id="7daa8-506">Specifies the format of the table exported data file.</span></span>

<span data-ttu-id="7daa8-507">Pokud není tato možnost zadána, exportuje AzCopy ve výchozím nastavení tabulky datový soubor ve formátu JSON.</span><span class="sxs-lookup"><span data-stu-id="7daa8-507">If this option is not specified, by default AzCopy exports table data file in JSON format.</span></span>

<span data-ttu-id="7daa8-508">**Platí pro:** tabulky</span><span class="sxs-lookup"><span data-stu-id="7daa8-508">**Applicable to:** Tables</span></span>

## <a name="known-issues-and-best-practices"></a><span data-ttu-id="7daa8-509">Známé problémy a doporučené postupy</span><span class="sxs-lookup"><span data-stu-id="7daa8-509">Known Issues and Best Practices</span></span>
### <a name="limit-concurrent-writes-while-copying-data"></a><span data-ttu-id="7daa8-510">Limit souběžných zápisy při kopírování dat</span><span class="sxs-lookup"><span data-stu-id="7daa8-510">Limit concurrent writes while copying data</span></span>
<span data-ttu-id="7daa8-511">Při kopírování objektů BLOB nebo soubory s AzCopy, mějte na paměti, že jiná aplikace může být úprava dat během kopírování ho.</span><span class="sxs-lookup"><span data-stu-id="7daa8-511">When you copy blobs or files with AzCopy, keep in mind that another application may be modifying the data while you are copying it.</span></span> <span data-ttu-id="7daa8-512">Pokud je to možné Ujistěte se, které chcete kopírovat data nemění při kopírování.</span><span class="sxs-lookup"><span data-stu-id="7daa8-512">If possible, ensure that the data you are copying is not being modified during the copy operation.</span></span> <span data-ttu-id="7daa8-513">Například při kopírování virtuálního pevného disku přidružený virtuální počítač Azure, ujistěte se, že žádné další aplikace jsou aktuálně zápis na virtuální pevný disk.</span><span class="sxs-lookup"><span data-stu-id="7daa8-513">For example, when copying a VHD associated with an Azure virtual machine, make sure that no other applications are currently writing to the VHD.</span></span> <span data-ttu-id="7daa8-514">Dobrým způsobem, jak to udělat, je leasing prostředků, které se mají zkopírovat.</span><span class="sxs-lookup"><span data-stu-id="7daa8-514">A good way to do this is by leasing the resource to be copied.</span></span> <span data-ttu-id="7daa8-515">Alternativně můžete nejprve vytvořte snímek virtuálního pevného disku a poté zkopírujte snímku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-515">Alternately, you can create a snapshot of the VHD first and then copy the snapshot.</span></span>

<span data-ttu-id="7daa8-516">Pokud nelze zabránit jiné aplikace z zápis do objektů BLOB nebo soubory, když se kopírují, pak mějte na paměti, že v době dokončení úlohy, kopírované prostředky buď již nemá úplné parita s prostředky zdroje.</span><span class="sxs-lookup"><span data-stu-id="7daa8-516">If you cannot prevent other applications from writing to blobs or files while they are being copied, then keep in mind that by the time the job finishes, the copied resources may no longer have full parity with the source resources.</span></span>

### <a name="run-one-azcopy-instance-on-one-machine"></a><span data-ttu-id="7daa8-517">Jedna instance nástroje AzCopy spusťte na jednom počítači.</span><span class="sxs-lookup"><span data-stu-id="7daa8-517">Run one AzCopy instance on one machine.</span></span>
<span data-ttu-id="7daa8-518">AzCopy je navržen chcete maximalizovat využití prostředků vašeho počítače urychlit přenos dat, doporučujeme spustit pouze jedna instance nástroje AzCopy na jednom počítači a zadejte možnost `/NC` Pokud potřebujete více souběžných operací.</span><span class="sxs-lookup"><span data-stu-id="7daa8-518">AzCopy is designed to maximize the utilization of your machine resource to accelerate the data transfer, we recommend you run only one AzCopy instance on one machine, and specify the option `/NC` if you need more concurrent operations.</span></span> <span data-ttu-id="7daa8-519">Další podrobnosti, zadejte `AzCopy /?:NC` na příkazovém řádku.</span><span class="sxs-lookup"><span data-stu-id="7daa8-519">For more details, type `AzCopy /?:NC` at the command line.</span></span>

### <a name="enable-fips-compliant-md5-algorithms-for-azcopy-when-you-use-fips-compliant-algorithms-for-encryption-hashing-and-signing"></a><span data-ttu-id="7daa8-520">Povolit algoritmus MD5 kompatibilní s FIPS pro AzCopy když jste "použití standardu FIPS kompatibilní s algoritmy pro šifrování, hašování a podpisování".</span><span class="sxs-lookup"><span data-stu-id="7daa8-520">Enable FIPS compliant MD5 algorithms for AzCopy when you "Use FIPS compliant algorithms for encryption, hashing and signing".</span></span>
<span data-ttu-id="7daa8-521">AzCopy ve výchozím nastavení používá k výpočtu MD5 při kopírování objektů implementace rozhraní .NET MD5, ale existují některé požadavky na zabezpečení, které je třeba povolit nastavení MD5 kompatibilní s FIPS AzCopy.</span><span class="sxs-lookup"><span data-stu-id="7daa8-521">AzCopy by default uses .NET MD5 implementation to calculate the MD5 when copying objects, but there are some security requirements that need AzCopy to enable FIPS compliant MD5 setting.</span></span>

<span data-ttu-id="7daa8-522">Můžete vytvořit soubor app.config `AzCopy.exe.config` s vlastností `AzureStorageUseV1MD5` a umístí jej vyhraďte s AzCopy.exe.</span><span class="sxs-lookup"><span data-stu-id="7daa8-522">You can create an app.config file `AzCopy.exe.config` with property `AzureStorageUseV1MD5` and put it aside with AzCopy.exe.</span></span>
...
<span data-ttu-id="7daa8-523">Pro vlastnost "AzureStorageUseV1MD5" • True - použije výchozí hodnotu, AzCopy implementace rozhraní .NET MD5.</span><span class="sxs-lookup"><span data-stu-id="7daa8-523">For property "AzureStorageUseV1MD5" • True - The default value, AzCopy will use .NET MD5 implementation.</span></span>
<span data-ttu-id="7daa8-524">• False – AzCopy použije algoritmus MD5 kompatibilní se standardem FIPS.</span><span class="sxs-lookup"><span data-stu-id="7daa8-524">• False – AzCopy will use FIPS compliant MD5 algorithm.</span></span>

<span data-ttu-id="7daa8-525">Všimněte si, že na počítač se systémem Windows ve výchozím nastavení je zakázáno algoritmy splňující standard FIPS, můžete v okně Spustit zadejte secpol.msc a zkontrolujte tento přepínač v nastavení zabezpečení -> Místní zásady -> zabezpečení -> – Možnosti kryptografie systému: použití vyhovující standardu FIPS pro šifrování, hašování a podpisování.</span><span class="sxs-lookup"><span data-stu-id="7daa8-525">Note that FIPS compliant algorithms is disabled by default on your Windows machine, you can type secpol.msc in your Run window and check this switch at Security Setting->Local Policy->Security Options->System cryptography: Use FIPS compliant algorithms for encryption, hashing and signing.</span></span>

## <a name="next-steps"></a><span data-ttu-id="7daa8-526">Další kroky</span><span class="sxs-lookup"><span data-stu-id="7daa8-526">Next steps</span></span>
<span data-ttu-id="7daa8-527">Další informace o Azure Storage a AzCopy naleznete v následujících zdrojích informací.</span><span class="sxs-lookup"><span data-stu-id="7daa8-527">For more information about Azure Storage and AzCopy, refer to the following resources.</span></span>

### <a name="azure-storage-documentation"></a><span data-ttu-id="7daa8-528">Dokumentace k Azure Storage:</span><span class="sxs-lookup"><span data-stu-id="7daa8-528">Azure Storage documentation:</span></span>
* [<span data-ttu-id="7daa8-529">Úvod do Azure Storage</span><span class="sxs-lookup"><span data-stu-id="7daa8-529">Introduction to Azure Storage</span></span>](storage-introduction.md)
* [<span data-ttu-id="7daa8-530">Používání úložiště Blob z rozhraní .NET</span><span class="sxs-lookup"><span data-stu-id="7daa8-530">How to use Blob storage from .NET</span></span>](storage-dotnet-how-to-use-blobs.md)
* [<span data-ttu-id="7daa8-531">Jak používat úložiště File z rozhraní .NET</span><span class="sxs-lookup"><span data-stu-id="7daa8-531">How to use File storage from .NET</span></span>](storage-dotnet-how-to-use-files.md)
* [<span data-ttu-id="7daa8-532">Používání úložiště Table z rozhraní .NET</span><span class="sxs-lookup"><span data-stu-id="7daa8-532">How to use Table storage from .NET</span></span>](storage-dotnet-how-to-use-tables.md)
* [<span data-ttu-id="7daa8-533">Jak vytvořit, spravovat nebo odstranit účet úložiště</span><span class="sxs-lookup"><span data-stu-id="7daa8-533">How to create, manage, or delete a storage account</span></span>](storage-create-storage-account.md)
* [<span data-ttu-id="7daa8-534">Přenos dat pomocí nástroje AzCopy v systému Linux</span><span class="sxs-lookup"><span data-stu-id="7daa8-534">Transfer data with AzCopy on Linux</span></span>](storage-use-azcopy-linux.md)

### <a name="azure-storage-blog-posts"></a><span data-ttu-id="7daa8-535">Příspěvky blogu Azure Storage:</span><span class="sxs-lookup"><span data-stu-id="7daa8-535">Azure Storage blog posts:</span></span>
* [<span data-ttu-id="7daa8-536">Představení náhled knihovny přesun dat úložiště Azure</span><span class="sxs-lookup"><span data-stu-id="7daa8-536">Introducing Azure Storage Data Movement Library Preview</span></span>](https://azure.microsoft.com/blog/introducing-azure-storage-data-movement-library-preview-2/)
* [<span data-ttu-id="7daa8-537">AzCopy: Úvod synchronní kopie a vlastní typ obsahu</span><span class="sxs-lookup"><span data-stu-id="7daa8-537">AzCopy: Introducing synchronous copy and customized content type</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2015/01/13/azcopy-introducing-synchronous-copy-and-customized-content-type.aspx)
* [<span data-ttu-id="7daa8-538">AzCopy: Uvedení obecné dostupnosti AzCopy 3.0 a AzCopy 4.0 verze preview s podporou tabulky a souboru</span><span class="sxs-lookup"><span data-stu-id="7daa8-538">AzCopy: Announcing General Availability of AzCopy 3.0 plus preview release of AzCopy 4.0 with Table and File support</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2014/10/29/azcopy-announcing-general-availability-of-azcopy-3-0-plus-preview-release-of-azcopy-4-0-with-table-and-file-support.aspx)
* [<span data-ttu-id="7daa8-539">AzCopy: Optimalizovaných pro rozsáhlé kopie scénáře</span><span class="sxs-lookup"><span data-stu-id="7daa8-539">AzCopy: Optimized for Large-Scale Copy Scenarios</span></span>](http://go.microsoft.com/fwlink/?LinkId=507682)
* [<span data-ttu-id="7daa8-540">AzCopy: Podpora pro geograficky redundantní úložiště s přístupem pro čtení</span><span class="sxs-lookup"><span data-stu-id="7daa8-540">AzCopy: Support for read-access geo-redundant storage</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2014/04/07/azcopy-support-for-read-access-geo-redundant-account.aspx)
* [<span data-ttu-id="7daa8-541">AzCopy: Přenos dat pomocí SAS token a znovu spustit režim</span><span class="sxs-lookup"><span data-stu-id="7daa8-541">AzCopy: Transfer data with re-startable mode and SAS token</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/09/07/azcopy-transfer-data-with-re-startable-mode-and-sas-token.aspx)
* [<span data-ttu-id="7daa8-542">AzCopy: Objekt Blob kopírování mezi účet pomocí</span><span class="sxs-lookup"><span data-stu-id="7daa8-542">AzCopy: Using cross-account Copy Blob</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/04/01/azcopy-using-cross-account-copy-blob.aspx)
* [<span data-ttu-id="7daa8-543">AzCopy: Nahrávání nebo stahování souborů pro objekty BLOB Azure</span><span class="sxs-lookup"><span data-stu-id="7daa8-543">AzCopy: Uploading/downloading files for Azure Blobs</span></span>](http://blogs.msdn.com/b/windowsazurestorage/archive/2012/12/03/azcopy-uploading-downloading-files-for-windows-azure-blobs.aspx)
