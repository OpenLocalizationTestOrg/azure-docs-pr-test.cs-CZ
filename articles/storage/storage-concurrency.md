...
Pokud se pokusíte operaci zápisu na objekt blob zapůjčených bez předávání ID zapůjčení, požadavek selže s 412 chyby. Všimněte si, že pokud zapůjčení vyprší před voláním **UploadText** metoda ale stále předat ID zapůjčení, požadavek se také nezdaří s **412** chyby. Další informace o správě identifikátory zapůjčení a časy vypršení platnosti zapůjčení, najdete v článku [zapůjčení Blob](http://msdn.microsoft.com/library/azure/ee691972.aspx) dokumentace k REST.  
