...
[!code-azurecli[hlavní](../../../cli_scripts/storage/create-managed-data-disks-from-vhd/create-managed-data-disks-from-vhd.sh "vytvořit spravovaného disku z virtuálního pevného disku")]
