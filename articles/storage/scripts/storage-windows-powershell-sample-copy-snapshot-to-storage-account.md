...
[Vytvoření spravovaného disku z virtuálního pevného disku](./../scripts/storage-windows-powershell-sample-create-managed-disk-from-vhd.md?toc=%2fpowershell%2fmodule%2ftoc.json)
