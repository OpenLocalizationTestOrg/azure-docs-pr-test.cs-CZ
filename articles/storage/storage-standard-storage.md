...
Můžete vytvořit [přírůstkové snímky](storage-incremental-snapshots.md) pro nespravovaná standardní disky stejným způsobem použít snímky s standardní úložiště. Doporučujeme vytvářet snímky a poté zkopírujte tyto snímky do geograficky redundantní standardní účet úložiště, pokud váš zdrojový disk je v účtu místně redundantní úložiště. Další informace najdete v tématu [možnosti redundance úložiště Azure](storage-redundancy.md).
