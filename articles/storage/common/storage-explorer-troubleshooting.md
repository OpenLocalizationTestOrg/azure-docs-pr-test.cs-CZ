...
Microsoft Azure Storage Explorer (Preview) je samostatná aplikace, která umožňuje snadno pracovat s daty Azure Storage ve Windows, systému macOS a Linux. Aplikace se může připojit toStorage účty hostované na Azure, suverénní Cloudy a Azure zásobníku.
...
Než budete pokračovat, zkuste restartovat aplikaci a zjistit, zda lze dlouhodobý problémy.
