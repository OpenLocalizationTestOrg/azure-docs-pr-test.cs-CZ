...
Podrobný kurz, který vás provede procesem hello šifrování objektům BLOB pomocí šifrování na straně klienta a Azure Key Vault, najdete v části [šifrování a dešifrování objektů BLOB v úložišti Microsoft Azure pomocí Azure Key Vault](../blobs/storage-encrypt-decrypt-blobs-key-vault.md).
