...
Jeden scénář, kde byste mohli toospecify explicitní koncový bod je, když jste změnili vaší tooa koncový bod úložiště objektů Blob [vlastní domény](../blobs/storage-custom-domain-name.md). V takovém případě můžete zadat svůj vlastní koncový bod pro úložiště objektů Blob v připojovacím řetězci. Volitelně můžete zadat hello výchozí koncové body pro hello jiných služeb Pokud vaše aplikace používá je.
