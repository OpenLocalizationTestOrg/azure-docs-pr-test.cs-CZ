...
* Před vytvořením úlohy importu, můžete použít tento nástroj toocopy data toohello pevné disky budete tooship tooan datového centra Azure.
...
Pokud jste **Příprava jednotky** úlohy importu, musí být splněny hello následující požadavky:
...
* Je nutné alespoň jeden z hello přístupových klíčů k účtu úložiště.
...
* Je třeba použít jednu nebo více prázdný 3,5 pevné disky SATA připojen toohello kopie počítače.
...
Pokud se pokoušíte příliš**opravit importu** který částečně selhala, budete potřebovat:

* soubory protokolu kopie Hello
* klíč účtu úložiště Hello

Pokud se pokoušíte příliš**opravit exportu** který částečně selhala, budete potřebovat:
...
První, [stáhnout hello nástroj Azure Import/Export](https://www.microsoft.com/download/details.aspx?id=55280) a rozbalte ho například tooa adresáře v počítači, `c:\WAImportExport`.
...
Dále otevřete okno příkazového řádku v **režimu správce**, a změny do adresáře hello obsahující hello rozbalené soubory.

toooutput Nápověda pro příkaz hello, spusťte nástroj hello (`WAImportExport.exe`) bez parametrů:
