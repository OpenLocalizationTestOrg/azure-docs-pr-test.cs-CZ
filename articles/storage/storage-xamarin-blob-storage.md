...
Codebase – Xamarin umožňuje vývojářům používat sdílené C# k vytvoření iOS, Android a aplikací pro Windows Store s jejich nativní uživatelského rozhraní. V tomto kurzu se dozvíte, jak používat úložiště objektů Blob Azure pomocí aplikace Xamarin. Pokud vás zajímají další informace o službě Azure Storage, než začnete kód, najdete [Úvod do Microsoft Azure Storage](storage-introduction.md).
