...
* **OTÁZKY. Kdy použít Azure File vs objektů Blob v Azure vs disku Azure?**  
    ...
    Další informace na [rozhodnutí při objektů BLOB Azure toouse, soubory Azure nebo Azure datových disků](storage-decide-blobs-files-disks.md)
...
* **OTÁZKY. Jak můžu začít pracovat používání Azure File storage?**  
    ...
    * [Zjistěte, jak toocreate Azure File sdílet pomocí hello portálu](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Zjistěte, jak toocreate Azure File sdílet pomocí prostředí Powershell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Zjistěte, jak toocreate Azure File sdílet pomocí rozhraní příkazového řádku](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **OTÁZKY. Jak odstranit chyby Azure File storage?**
    ...
    Můžete se podívat příliš[Azure File storage článku Poradce při potížích s](storage-troubleshoot-file-connection-problems.md) pro pokyny k odstraňování problémů začátku do konce. 
...
* [Použití hello rozhraní příkazového řádku Azure s Azure Storage](storage-azure-cli.md)
