...
4. V zobrazeném dialogovém okně se zobrazí název účtu úložiště, primární přístupový klíč a sekundární přístupový klíč. Pro přístupový klíč můžete použít primární nebo sekundární jeden. 
5. Kliknutím na ikonu kopírování do schránky zkopírujte klíč.
