...
[Část 1](storage-dotnet-shared-access-signature-part-1.md) tohoto kurzu prozkoumali sdílené přístupové podpisy (SAS) a vysvětlení osvědčené postupy pro jejich použití. Část 2 ukazuje, jak vygenerovat a pak použít sdílené přístupové podpisy úložiště objektů Blob. Příklady jsou napsané v jazyce C# a použít knihovnu klienta služby Azure Storage pro .NET. Příklady v tomto kurzu:
...
* [Sdílené přístupové podpisy, část 1: Vysvětlení modelu SAS](storage-dotnet-shared-access-signature-part-1.md)
