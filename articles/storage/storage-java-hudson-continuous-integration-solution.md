...
* Účet úložiště Azure. Pokud nemáte účet úložiště, můžete vytvořit jeden pomocí kroků v [vytvořit účet úložiště](storage-create-storage-account.md#create-a-storage-account).
...
Další informace najdete také zjistit [středisko pro vývojáře Java](https://azure.microsoft.com/develop/java/).