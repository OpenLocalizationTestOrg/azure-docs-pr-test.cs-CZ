...
### [Připojte tooa spravovaných disků na virtuální počítač s Windows pomocí prostředí PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [Prohledávání služby Blob Storage pomocí Azure Search](../search/search-blob-storage-integration.md)
...
### [Tooblobs anonymní přístup](storage-manage-access-to-resources.md)
...
### [Migraci disků spravovaných virtuálních počítačích Azure tooAzure](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrace z AWS a jiné platformy tooManaged disky](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migrace tooPremium úložiště pomocí Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Migrace tooPremium úložiště](storage-migration-to-premium-storage.md)
...
### [Použití hello emulátor úložiště](storage-use-emulator.md)
...
### [Zálohování a zotavení po havárii pro disky IAAS](storage-backup-and-disaster-recovery-for-azure-iaas-disks.md)
...
## Přenos dat
### [Přesun dat tooand z úložiště](storage-moving-data.md)
### [AzCopy ve Windows](storage-use-azcopy.md)
### [AzCopy v Linuxu](storage-use-azcopy-linux.md)
### [Pomocí služby importu a exportu hello](storage-import-export-service.md)
### [Pomocí hello nástroj pro Import/Export](storage-import-export-tool-how-to.md)
#### [Nastavení hello nástroj pro Import/Export](storage-import-export-tool-setup.md)
...
#### [Řešení potíží s hello nástroj pro Import/Export](storage-import-export-tool-troubleshooting-v1.md)
...
### [Pomocí hello nástroj pro Import nebo Export (v1)](storage-import-export-tool-how-to-v1.md)
#### [Nastavení hello nástroj pro Import/Export](storage-import-export-tool-setup-v1.md)
...
#### [Formát souborů metadat a vlastností služby Import/export](storage-import-export-file-format-metadata-and-properties.md)
#### [Formát souborů protokolu služby Import/export](storage-import-export-file-format-log.md)
### [Pomocí REST API služby Azure Import/Export hello](storage-import-export-using-the-rest-api.md)
...
### [Knihovna pro přesun dat v Azure Storage](https://www.nuget.org/packages/Microsoft.Azure.Storage.DataMovement/)
