...
* [Účet úložiště Azure](../common/storage-create-storage-account.md?toc=%2fazure%2fstorage%2fqueues%2ftoc.json#create-a-storage-account)
...
* Zobrazte další funkce příručky toolearn o dalších možnostech pro ukládání dat v Azure.
  * [Začínáme s Azure Table storage pomocí rozhraní .NET](../../cosmos-db/table-storage-how-to-use-dotnet.md) toostore strukturovaná data.
  * [Začínáme s Azure Blob storage pomocí rozhraní .NET](../blobs/storage-dotnet-how-to-use-blobs.md) toostore Nestrukturovaná data.
  * [Připojit tooSQL databáze pomocí rozhraní .NET (C#)](../../sql-database/sql-database-connect-query-dotnet-core.md) toostore relační data.
