...
Další informace o tom, jak používat **CloudTable** objektu, najdete v části [Začínáme s Azure Table storage pomocí rozhraní .NET](storage-dotnet-how-to-use-tables.md).

## <a name="related-topics-covered-by-the-queues-how-to-article"></a>Související témata předmětem článek s postupy fronty
Informace o způsobu zpracování zpracování tabulky aktivovány zprávu fronty, nebo pro scénáře WebJobs SDK, které nejsou specifické pro zpracování tabulky, najdete v části [Začínáme s Azure Queue storage a Visual Studio připojené služeb (webové úlohy projekty)](vs-storage-webjobs-getting-started-queues.md).
