...
toocreate sdílenou složku Azure, můžete použít účet úložiště, který již existuje, nebo [vytvořit nový účet úložiště Azure](storage-create-storage-account.md). toocreate sdílenou Azure pomocí prostředí PowerShell, budete potřebovat název svého účtu úložiště a klíč účtu hello... Pokud máte v plánu toouse prostředí Powershell nebo rozhraní příkazového řádku, budete potřebovat klíč účtu úložiště.
...
2. **Klikněte na tlačítko Přidat sdílenou složku:**    
    ![Klikněte na tlačítko hello přidat sdílené složky souboru – tlačítko](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Zadejte název a kvótu. Aktuálně může být kvóta maximálně 5 TB:**    
    ![Zadejte název a požadované kvótu pro hello nové sdílené složky](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)
