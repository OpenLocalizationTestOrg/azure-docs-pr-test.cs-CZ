...
Můžete také použít AzCopy toocopy jeden soubor tooanother nebo toocopy naopak objektů blob tooa soubor nebo naopak. V tématu [přenos dat pomocí příkazového řádku Azcopy hello](storage-use-azcopy.md).
...
Navíc můžete odkazovat příliš[Azure File storage článku Poradce při potížích s](storage-troubleshoot-file-connection-problems.md) pro pokyny k odstraňování problémů začátku do konce.
