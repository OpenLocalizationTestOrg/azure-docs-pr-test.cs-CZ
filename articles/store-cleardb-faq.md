...
Když provádíte migraci prostředků ve předplatných, některé [omezení](app-service-web/app-service-move-resources.md) použít. Databáze ClearDB MySQL je službu třetí strany a proto nejsou migrována během migrace předplatného Azure. Pokud spravujete není migraci databáze MySQL před migrací prostředků Azure, je vaše databáze MySQL cleardb – zakázat. Nejprve ručně migrovat své databáze a pak proveďte migraci předplatného Azure pro vaši webovou aplikaci. 
