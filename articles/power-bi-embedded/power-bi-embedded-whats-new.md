...
* [Vytvořit novou sestavu](power-bi-embedded-create-report-from-dataset.md)
* [Sestavu uložit jako](power-bi-embedded-save-reports.md)
* Vložení sestavy v režimu pro čtení, upravit nebo vytvořit nový 
* [Sestava přepínání mezi režimy úprav/čtení](power-bi-embedded-toggle-mode.md)
...
* [Pokročilou analýzu s Power BI Embedded a R](https://powerbi.microsoft.com/blog/r-in-pbie/)
