...
V této části se dozvíte, jak k publikování projektu back-end .NET ze sady Visual Studio. Můžete taky nasadit projektu back-end pomocí Git nebo libovolné jiné metody popsané v [dokumentaci k nasazení služby Azure App Service](../app-service-web/web-sites-deploy.md).
...
1. Postupujte podle kroků v [povolení diagnostiky](../app-service-web/web-sites-enable-diagnostic-log.md#enablediag).
...
5. Stáhněte si a vyhodnocovat u nich protokoly, jak je popsáno v [postupy: stažení protokolů](../app-service-web/web-sites-enable-diagnostic-log.md#download).
