...
4. Zadejte podrobnosti sady runbook a potom klikněte na značku zaškrtnutí. Název sady runbook bude již být vyplněna.
5. Runbook se objeví na **Runbooky** kartě pro účet služby Automation.
...
8. Runbook se objeví na **Runbooky** kartě pro účet služby Automation.
...
* Proto byste měli poskytnout podrobné informace, které vám pomohou identifikovat funkce sady runbook uživatele, se ve výsledcích Galerie Runbooků zobrazí souhrn pro odesílání.
* Jednu až tři z těchto značek byste měli přiřadit k odeslání.  Runbook se objeví v průvodci v části kategorie, které odpovídají jeho značky.  Průvodce se budou ignorovat všechny značky není v tomto seznamu. Pokud nezadáte žádné odpovídající značky, sada runbook se objeví v jiné kategorii.
...
1. Na portálu Azure otevřete účet Automation.
2. Klikněte na **prostředky** dlaždici otevřete seznam prostředků.
3. Klikněte na **moduly** dlaždici otevřete seznamu modulů.
4. Klikněte na **procházet galerii** spuštění tlačítko a v okně Procházet galerii.
   
    ![V galerii modulů](media/automation-runbook-gallery/modules-blade.png) <br>
5. Po spuštění v okně Procházet galerii můžete vyhledávat podle následující pole:
...
8. Když kliknete na tlačítko importovat, zobrazí se na název modulu, který chcete importovat. Pokud jsou nainstalovány všechny závislosti, **OK** tlačítko bude aktivní. Pokud jsou chybějících závislostí, je třeba importovat ty před importováním tohoto modulu.
9. Klikněte na tlačítko **OK** importovat modul a v okně modulu se spustí. Jakmile Azure Automation importuje modul ke svému účtu, extrahuje metadata o modulu a rutiny.
...
10. Obdržíte oznámení, který je nasazován modul a oznámení, když byla dokončena.
11. Po importu modulu, zobrazí se dostupné aktivity a můžete použít její prostředky v runboocích a konfigurace požadovaného stavu.
