...
4. Na **zvolte cenovou úroveň** vyberte **základní**    
...
**Tipy k řešení potíží:**  
Problém se vyřeší všechny z následujících řešení:  
...
* Konfigurace uzlu můžete přiřadit k uzlu, pomocí portálu Azure nebo pomocí rutiny prostředí PowerShell.
  ...
  * Aby bylo možné přiřadit konfigurace uzlu do uzlu pomocí portálu Azure, otevřete **uzly DSC** okno, pak vyberte uzel a klikněte na **konfigurace uzlu přiřazení** tlačítko.  
...
**Důvod chyby:** při následující výraz **uzlu** – klíčové slovo v konfigurace DSC se vyhodnocuje $null pak budou vytvořeny žádné konfigurace uzlů.    
