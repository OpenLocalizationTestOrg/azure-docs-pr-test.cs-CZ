---
title: "aaaAzure dokumentace k zálohování – kurzy, referenční dokumentace rozhraní API | Microsoft Docs"
description: "Pomocí zálohování dokumentaci toolearn jak tooback až toohello cloudové. Prohlédněte si kurzy a videa pro aplikaci, server Windows a zálohování virtuálních počítačů Azure."
services: backup
author: carolz
manager: carolz
layout: LandingPage
...
Zjistěte, jak toouse Azure Backup v hello cloudové tooprotect data pro dlouhodobé uchovávání a obnovení. Kurzy, videa a další dokumentaci ukazují, jak tooback zálohy dat, aplikace, Windows serverů a virtuálních počítačích Azure.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme se zálohováním serveru VMware s využitím Azure Backup Serveru</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">Referenční materiály k rozhraní REST API služby Recovery Services</a></p>
                    </div>
                </div>
            </div>
        </div>
