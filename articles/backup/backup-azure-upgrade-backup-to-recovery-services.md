...
- **Verze agenta minimální**: Chcete-li upgradovat svůj trezor, ujistěte se, agenta nástroje Microsoft Azure Recovery Services (MARS) je minimálně verze 2.0.9070.0. Pokud agenta MARS je starší než 2.0.9070.0, aktualizujte před zahájením procesu upgradu agenta.
...
- **Verze agenta minimální** -trezory Backup trezory služeb zotavení upgradujete agenta MARS nejméně verze 2.0.9070. Pokud máte položky zaregistrovat do trezoru zálohování s agentem starší než 2.0.9070, selže kontrola předpokladů. Pokud selže kontrola předpokladů, aktualizujte agenta a pokusit o upgrade trezoru znovu. Můžete si stáhnout nejnovější verzi agenta z [http://download.microsoft.com/download/F/4/B/F4B06356-150F-4DB0-8AD8-95B4DB4BBF7C/MARSAgentInstaller.exe](http://download.microsoft.com/download/F/4/B/F4B06356-150F-4DB0-8AD8-95B4DB4BBF7C/MARSAgentInstaller.exe).
...
**Proč nevidím informace úlohy pro místní zdroje po upgradu**</br>
Monitorování pro místní zálohování (MARS agent aplikace DPM a Azure Backup Server) je nová funkce, kterou dostanete při upgradu trezoru služby Backup do trezoru služeb zotavení. Informace o monitorování trvá až 12 hodin pro synchronizaci se službou.
