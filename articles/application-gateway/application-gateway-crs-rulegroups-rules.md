...
Brány firewall webových aplikací aplikace brány (firewall webových aplikací) chrání webových aplikací ze známých chyb zabezpečení a zneužití. To se provádí prostřednictvím pravidel, která jsou definována podle hello OWASP základní sady pravidel 2.2.9 nebo 3.0. Tato pravidla lze vypnout na základě podle pravidla. Tento článek obsahuje hello aktuální pravidla a sady pravidel, které nabízí.

Následující tabulky Hello jsou hello pravidlo skupiny a pravidel, které jsou k dispozici při Application Gateway pomocí brány firewall webových aplikací.  Každá tabulka představuje hello pravidel ve skupině pravidlo na konkrétní verzi řádku.
...
|920130|Nepodařilo tooparse textu požadavku.|
...
|960912|Nepodařilo tooparse textu požadavku.|
...
|RuleId|Popis|
|---|---|
|990002|Žádost o označuje hello zkontrolovat skener zabezpečení lokality|
|990901|Žádost o označuje hello zkontrolovat skener zabezpečení lokality|
|990902|Žádost o označuje hello zkontrolovat skener zabezpečení lokality|
...
Zjistěte, jak pravidla toodisable firewall webových aplikací navštivte stránky: [pravidla přizpůsobit firewall webových aplikací](application-gateway-customize-waf-rules-portal.md)
