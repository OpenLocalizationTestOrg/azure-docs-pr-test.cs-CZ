...
5. Použít následující příkazy k vytvoření nové "interní" tabulku s názvem **errorLogs**:
   ...
   * **Vytvoření tabulka není v případě existuje** -vytvoří tabulku, pokud ještě neexistuje. Tento příkaz vytvoří interní tabulku, která je uložena v datovém skladu Hive a je zcela spravuje Hive.
