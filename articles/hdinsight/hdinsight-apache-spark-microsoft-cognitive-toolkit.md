...
3. Z poznámkového bloku Jupyter, klikněte na tlačítko **nahrát** v pravém horním rohu a pak přejděte do umístění, které jste naklonovali úložiště GitHub.
    ...
    ![Nahrát Poznámkový blok Jupyter ke clusteru Azure HDInsight Spark](./media/hdinsight-apache-spark-microsoft-cognitive-toolkit/hdinsight-microsoft-cognitive-toolkit-load-jupyter-notebook.png "Poznámkový blok Jupyter nahrát do clusteru Azure HDInsight Spark")
