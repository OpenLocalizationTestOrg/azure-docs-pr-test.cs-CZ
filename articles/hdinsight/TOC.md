...
#### [Použití hello zobrazení Hive](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Používat hello nástroje HDInsight pro Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Použití Vzdálené plochy](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Použití hello dotazu konzoly](hdinsight-hadoop-use-hive-query-console.md)
...
### [Spuštění ukázek MapReduce hello](hdinsight-hadoop-run-samples-linux.md)
...
#### [Hello pomocí .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Zápis tooData Lake Store](hdinsight-storm-write-data-lake-store.md)
...
### [Použití nástrojů HDInsight toocreate Spark aplikací](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Použití nástrojů HDInsight toodebug Spark aplikací vzdáleně přes SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Připojení aplikace Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Připojení pomocí ovladač Hive JDBC hello](hdinsight-connect-hive-jdbc-driver.md)
...
### [Připojit HDInsight tooyour do místní sítě](connect-on-premises-network.md)
...
#### [Použití aplikací tooinstall REST](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publikování aplikace tooAzure HDInsight Marketplace.](hdinsight-apps-publish-applications.md)
## Zabezpečení
...
### [Omezit přístup toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Spravovat
...
#### [Pomocí cURL a hello REST API služby Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Hello pomocí .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Hello pomocí rozhraní příkazového řádku Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Hello použití portálu Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Hello pomocí rozhraní příkazového řádku Azure](hdinsight-administer-use-command-line.md)
### [Správa clusterů pomocí webovému uživatelskému rozhraní Ambari hello](hdinsight-hadoop-manage-ambari.md)
...
### [Nástroje pro vývoj tooResource Manager migrovat](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Dostupnost a spolehlivost](hdinsight-high-availability-linux.md)
### [Upgrade verze toonewer clusteru HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Pomocí zobrazení Ambari toodebug Tez úloh](hdinsight-debug-ambari-tez-view.md)
...
# Související
## Clustery s Windows
### [Migrace clusterů tooLinux clusterů systému Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Migrace clusterů tooLinux řešení rozhraní .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Použít Giraph tooprocess rozsáhlé grafy](hdinsight-hadoop-giraph-install.md)
...
### [Použití aplikací Java toobuild Maven](hdinsight-hbase-build-java-maven.md)
### [Použít hello úlohách Tez toodebug Tez uživatelského rozhraní](hdinsight-debug-tez-ui.md)
...
### [Monitorování clusterů pomocí hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Zdroje
## [Plány Azure do budoucna](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Získání nápovědy na fóru hello](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
