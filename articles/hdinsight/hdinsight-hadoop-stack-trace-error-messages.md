...
* [Protokoly YARN aplikace přístup na systémem Linux Hadoop v HDInsight](hdinsight-hadoop-access-yarn-app-logs-linux.md)
...
* [Poznámky k verzi pro komponent systému Hadoop v Azure HDInsight](hdinsight-release-notes.md)
