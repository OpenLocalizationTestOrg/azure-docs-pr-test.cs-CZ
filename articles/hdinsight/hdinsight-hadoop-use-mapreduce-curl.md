...
>
> Pro příkazy v této části nahraďte **uživatelské jméno** uživatelem pro ověření clusteru, a **heslo** s heslem pro uživatelský účet. Nahraďte **CLUSTERNAME** názvem vašeho clusteru.
>
...
1. Z příkazového řádku použijte následující příkaz k ověření, zda se můžete připojit ke clusteru HDInsight:
    ...
    Mělo by se zobrazit odpověď podobná následujícím kódu JSON:
