...
**Zdrojový kód**: zdrojový kód pro tyto ukázky je zahrnuta v clusteru HDInsight na `/usr/hdp/2.2.4.9-1/hadoop/src/hadoop-mapreduce-project/hadoop-mapreduce-examples`.

> [!NOTE]
> `2.2.4.9-1` v cestě je verze softwaru Hortonworks Data Platform pro HDInsight cluster a mohou být různé pro váš cluster.
