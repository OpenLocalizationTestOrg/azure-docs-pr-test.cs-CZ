...
### [Úloha 1: vytvoření skupiny správce hello](active-directory-ds-getting-started-create-group.md)
...
#### [Úloha 2: export hello zabezpečený LDAP certifikátu](active-directory-ds-admin-guide-configure-secure-ldap-export-pfx.md)
#### [Úloha 3: Povolení zabezpečeného LDAP pro hello spravované doméně pomocí portálu Azure classic](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps-classic.md)
#### [Úloha 3: Povolení zabezpečeného LDAP pro hello spravované doméně pomocí portálu Azure (preview)](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps.md)
...
### [Povolit náhled hello Azure portálu prostředí](active-directory-ds-azure-portal-enable-preview-access.md)
