...
2. Portálu classic zobrazí výzvu k otevření nebo uložení souboru s příponou '.rdp', který se používá k připojení k virtuálnímu počítači. Kliknutím otevřete soubor po dokončení stahování.
