...
Ne. Služba Azure AD Domain Services lze povolit pouze v klasické virtuální síti Azure. Resource Manager virtuální sítě pomocí virtuální sítě partnerský vztah spravované doménu ve virtuální síti Resource Manager můžete připojit klasickou virtuální síť.

#### <a name="can-i-enable-azure-ad-domain-services-in-a-federated-azure-ad-directory-i-use-adfs-to-authenticate-users-for-access-to-office-365-can-i-enable-azure-ad-domain-services-for-this-directory"></a>Můžete povolit funkci Azure AD Domain Services ve federované Azure AD adresáře? Používám služby AD FS k ověřování uživatelů pro přístup k Office 365. Můžete povolit pro tento adresář Azure AD Domain Services?
...
Služba sama přímo nepodporuje tento scénář. Najednou je k dispozici v pouze jednu virtuální síť Azure AD Domain Services. Můžete ale nakonfigurovat připojení mezi více virtuálních sítí, která zveřejňuje Azure AD Domain Services pro jiné virtuální sítě. Tento článek popisuje, jak můžete [propojit virtuální sítě v Azure](../vpn-gateway/virtual-networks-configure-vnet-to-vnet-connection.md).
...
Ne. Azure AD Domain Services lze nastavit pouze v [portál Azure classic](https://manage.windowsazure.com). Očekáváme, že k rozšíření podpory pro [portál Azure](https://portal.azure.com) v budoucnu.
