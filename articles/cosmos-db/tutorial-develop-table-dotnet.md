...
Azure Table Storage můžete dále používat pro tabulky s vysokými požadavky na úložiště a nižšími nároky na propustnost. Azure Cosmos DB zavádí podporu pro úložiště optimalizované tabulky v budoucí aktualizaci a stávající i nové účty úložiště Azure Table se bezproblémově upgraduje databázi Azure Cosmos.
...
- 99,99 % dostupnost v rámci jedné oblasti a možnost přidávat další oblasti pro vyšší dostupnosti, a [komplexní SLA špičkový](https://azure.microsoft.com/support/legal/sla/cosmos-db/) na obecné dostupnosti
