...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Získání klíče účtu pro Azure DB Cosmos pomocí hello rozhraní příkazového řádku Azure
...
| [AZ cosmosdb seznamu klíčů](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Vytvoří logického serveru, hostitelé hello databáze SQL. |
