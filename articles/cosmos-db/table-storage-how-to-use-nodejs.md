...
* [Sestavení a nasazení webové aplikace Node.js do Azure pomocí služby WebMatrix](../app-service-web/web-sites-nodejs-use-webmatrix.md)
...
Příklad nastavení proměnných prostředí [portál Azure](https://portal.azure.com) web Azure, najdete v části [webové aplikace Node.js pomocí služby Azure Table](../app-service-web/storage-nodejs-use-table-storage-web-site.md).
...
* [Vytvoření a nasazení aplikace Node.js ve službě Azure Web](../app-service-web/app-service-web-get-started-nodejs.md)