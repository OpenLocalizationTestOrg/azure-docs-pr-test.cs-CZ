...
Nové hostovaného operačního systému **verze** vydávají o každý měsíc umožňují začlenění nejnovějších aktualizací střediska MSRC. Z důvodu pravidelných měsíčních aktualizací, je obvykle zakázané 60 dnů po jeho vydání verze hostovaného operačního systému. Tato aktivita udržuje alespoň dvě verze hostovaného operačního systému pro každou skupinu, která je k dispozici pro použití.
