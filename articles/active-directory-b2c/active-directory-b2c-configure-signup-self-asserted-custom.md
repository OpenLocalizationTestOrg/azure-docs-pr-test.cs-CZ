...
Upravená Sipi se spustit testovací předání.
...
Umožňuje požádat uživatele pro jejich město.  Přidejte následující elementu, který chcete `<ClaimsSchema>` element v souboru TrustFrameWorkExtensions zásad:
