...
## [Použít Azure AD Graph API hello](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Přizpůsobení hello uživatelského rozhraní](active-directory-b2c-reference-ui-customization.md)
...
## [Použít hello reporting rozhraní API](active-directory-b2c-reference-usage-reporting-api.md)
