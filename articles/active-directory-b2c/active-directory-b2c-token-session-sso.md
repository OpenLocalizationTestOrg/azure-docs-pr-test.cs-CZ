...
7. Klikněte na **OK**.
8. Klikněte na tlačítko **Uložit** nahoře v okně.
...
* **Přístup k & ID token životnosti (minuty)**: doba platnosti tokenu nosiče OAuth 2.0 použít k získání přístupu k chráněnému prostředku. Azure AD B2C vydává pouze tokeny typu ID v tuto chvíli. Tato hodnota by použít u přístupové tokeny, i když jsme přidat podporu pro ně.
  * Výchozí = 60 minut.
...
* **Zakázané**: Vynutí uživatele k spuštění prostřednictvím celé uživatelské cesty na každé provedení zásad. Například to vám umožní více uživatelů se můžete zaregistrovat do vaší aplikace (ve scénáři sdílené klientů), i při jednoho uživatele zůstane přihlášeného během po celou dobu.
