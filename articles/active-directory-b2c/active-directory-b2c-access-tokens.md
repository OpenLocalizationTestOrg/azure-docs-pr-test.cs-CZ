...
1. V rámci Azure AD B2C **aplikace** okně otevřené rozhraní API webové aplikace ("API společnosti Contoso").
...
1. Přejděte na **aplikace** nabídky v okno s funkcemi B2C.
