...
1. Spustí relaci prohlížeče a přejděte do [Azure Portal](https://portal.azure.com) a přihlaste se pomocí pověření správce adresáře B2C, které chcete nakonfigurovat.
...
Přidejte novou deklaraci na toky pro sociálních účet přihlášení změnou TechnicalProfiles uvedené. Tyto dvě TechnicalProfiles jsou používány sociálního/federovaný účet přihlášení k zápisu a čtení dat uživatele pomocí alternativeSecurityId jako Lokátor objektu uživatele.
```
