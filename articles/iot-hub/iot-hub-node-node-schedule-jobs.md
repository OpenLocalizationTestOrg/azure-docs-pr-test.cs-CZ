...
* Vytvoření aplikace simulovaného zařízení, která má přímá metoda, která umožňuje **lockDoor** které je možné volat v back-end řešení.
...
**scheduleJobService.js**, která volá metodu přímé v aplikaci simulovaného zařízení a aktualizací dvojče zařízení požadovaných vlastností pomocí úlohy.
