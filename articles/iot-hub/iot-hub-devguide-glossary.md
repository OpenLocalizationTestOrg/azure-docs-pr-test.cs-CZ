...
[Portálu Microsoft Azure](https://portal.azure.com) je centrálním místem, kde můžete zřizovat a správě prostředků Azure. Slouží k uspořádání obsahu pomocí _okna_. V některých kurzy Centrum IoT, můžete být vyzváni k použití [portál Azure classic](https://manage.windowsazure.com).
