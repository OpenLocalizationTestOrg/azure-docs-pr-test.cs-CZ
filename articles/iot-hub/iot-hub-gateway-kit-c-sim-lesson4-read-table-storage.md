...
- Spustíte ukázkový kód v hostitelském počítači ke čtení zpráv ve službě Azure Table storage.
...
- [Vytvoření účtu úložiště Azure a Azure funkce aplikace](iot-hub-gateway-kit-c-sim-lesson4-deploy-resource-manager-template.md).
- [Spuštění ukázkové aplikace brány](iot-hub-gateway-kit-c-sim-lesson3-configure-simulated-device-app.md).
