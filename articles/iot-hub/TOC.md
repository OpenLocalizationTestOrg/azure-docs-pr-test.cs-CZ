...
#### Použití hello IoT brány Starter Kit
##### [Nastavení Intel NUC jako brány](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
##### [Připojení brány tooIoT hello rozbočovače](iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
##### [Použít hello bránu pro převod dat](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
...
### [Uložit IoT Hub zprávy tooAzure úložiště dat](iot-hub-store-data-in-azure-table-storage.md)
...
# Postup
## Plánování
### [Porovnání tooEvent Centrum IoT Hubs](iot-hub-compare-event-hubs.md)
...
##### [Odesílání zpráv typu zařízení cloud tooIoT rozbočovače](iot-hub-devguide-messages-d2c.md)
##### [Číst zprávy typu zařízení cloud ze vestavěným koncovým bodem hello](iot-hub-devguide-messages-read-builtin.md)
...
#### [Řízení přístupu tooIoT rozbočovače](iot-hub-devguide-security.md)
...
### [Použití zařízení IoT hello SDK pro jazyk C](iot-hub-device-sdk-c-intro.md)
#### [Použití hello IoTHubClient](iot-hub-device-sdk-c-iothubclient.md)
#### [Použít serializátor hello](iot-hub-device-sdk-c-serializer.md)
...
### Použít firmwaru zařízení tooupdate úlohy zařízení
...
#### [Pomocí portálu hello](iot-hub-create-through-portal.md)
...
#### [Použití hello REST API](iot-hub-rm-rest.md)
...
#### [Pomocí portálu hello](iot-hub-configure-file-upload.md)
...
## Zabezpečení
### [Zabezpečení z hello pozadí](iot-hub-security-ground-up.md)
