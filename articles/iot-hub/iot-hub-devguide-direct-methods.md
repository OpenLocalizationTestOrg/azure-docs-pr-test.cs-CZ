...
Přímá metoda jsou ze strany cloudu jen HTTP a MQTT jen ze strany zařízení.

Datová část pro metoda požadavky a odpovědi je až 8KB dokumentu JSON.

## <a name="reference-topics"></a>Témata odkazů:
Následující referenční témata poskytují další informace o používání přímé metody.
...
* V příspěvku *– metoda*
* *Hlavičky* který obsahovat autorizaci, žádat o ID, typu obsahu a kódování obsahu
...
Back-end aplikace obdrží odpověď, která zahrnuje:
...
* *Hlavičky* který obsahovat značku ETag, žádat o ID, typu obsahu a kódování obsahu
...
Text, který obdrží zařízení je v následujícím formátu:
...
Nyní jste se naučili použití přímé metod, může zajímat v následujícím tématu Příručka vývojáře IoT Hub:
