...
Informace o řešení běžných problémů na vaší kartě Adafruit prolnutí M0 Wi-Fi Arduino najdete v tématu hello [oficiální stránka řešení potíží](https://learn.adafruit.com/adafruit-feather-m0-wifi-atwinc1500?view=all#faq).
...
Nebo můžete přidat `--listen` informace o protokolu tooopen sériového portu toooutput zařízení.
