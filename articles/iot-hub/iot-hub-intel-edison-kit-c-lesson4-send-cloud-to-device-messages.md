...
1. Ujistěte se, že jste ve složce úložišti `iot-hub-c-edison-getting-started`. Otevřete ukázkovou aplikaci v aplikaci Visual Studio Code spuštěním následujících příkazů:
