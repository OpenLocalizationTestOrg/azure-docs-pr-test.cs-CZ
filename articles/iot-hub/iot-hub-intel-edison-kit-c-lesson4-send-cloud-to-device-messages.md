...
1. Ujistěte se, že jste ve složce úložišti hello `iot-hub-c-edison-getting-started`. Otevřete hello ukázkovou aplikaci v aplikaci Visual Studio Code spuštěním hello následující příkazy:
