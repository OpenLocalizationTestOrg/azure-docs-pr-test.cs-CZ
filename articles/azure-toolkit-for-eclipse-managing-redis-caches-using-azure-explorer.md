...
---
# <a name="managing-redis-caches-using-hello-azure-explorer-for-eclipse"></a>Správa mezipaměti Redis Cache pomocí hello Průzkumník Azure pro Eclipse

Průzkumník Azure, který je součástí hello nástrojů Azure pro prostředí Eclipse, poskytuje možnosti pro vývojáře v jazyce Java s řešením snadno použitelné pro správu redis mezipaměti v účtu Azure z uvnitř hello Eclipse IDE Hello.
...
1. Přihlaste se tooyour účet Azure postupem hello hello [přihlášení v pokyny pro hello nástrojů Azure pro Eclipse] článku.
...
## <a name="display-hello-properties-for-your-redis-cache-in-eclipse"></a>Zobrazí vlastnosti hello ke svojí mezipaměti Redis v prostředí Eclipse
...
1. Klikněte na tlačítko **OK** při zobrazení výzvy toodelete vaše mezipaměť redis.
