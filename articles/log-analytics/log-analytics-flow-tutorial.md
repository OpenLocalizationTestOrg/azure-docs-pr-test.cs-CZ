...
> [!NOTE]
> Konektor analýzy protokolů Azure pro Microsoft Flow vyžaduje pracovního prostoru budou upgradovány na novou dotazovacího jazyka pro analýzy protokolů. Můžete získat další informace o nový jazyk a získat postup upgradu pracovního prostoru v [upgradu pracovní prostor analýzy protokolů Azure na nové hledání protokolu](log-analytics-log-search-upgrade.md).  
