...
Přepnout **integrací** kartě a zadejte parametr časovače smysluplný název pro použití v rámci funkce. V předchozím kódu, se očekává, že časovač k volání *myTimer*. Zadejte [výraz CRON](../app-service-web/web-sites-create-web-jobs.md#CreateScheduledCRON) následujícím způsobem: 0 \* \* \* \* \* pro časovač způsobí, že funkce se má spustit jednou za minutu.
