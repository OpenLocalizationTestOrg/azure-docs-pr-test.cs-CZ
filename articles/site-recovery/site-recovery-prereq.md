...
Nastavte na místním počítači jako konfigurační server k orchestraci komunikace mezi místními servery a Azure. Na místním počítači také spravuje data replikace. <br/></br>
...
|**ADRESA URL** | **Nástroj VMM do nástroje VMM** | **Z VMM do Azure** | **Technologie Hyper-V do Azure** | **Z VMware do Azure** |
|--- | --- | --- | --- | --- |
