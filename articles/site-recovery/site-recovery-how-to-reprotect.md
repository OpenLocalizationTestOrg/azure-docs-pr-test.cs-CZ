...
> [!WARNING]
> Nelze označit zpět po [dokončení migrace](site-recovery-migrate-to-azure.md#what-do-we-mean-by-migration), přesunout virtuální počítač do jiné skupiny prostředků nebo odstranění virtuálního počítače Azure.
...
Mějte na paměti, že se stane, že replikace jenom přes síť VPN S2S nebo soukromého partnerského vztahu ExpressRoute sítě. Ujistěte se, že dostatečná šířka pásma je k dispozici v daném kanálu sítě.
