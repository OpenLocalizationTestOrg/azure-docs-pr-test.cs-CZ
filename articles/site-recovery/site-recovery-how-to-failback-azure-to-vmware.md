...
* Může selhat zpátky pouze do úložiště dat systému (VMFS) soubor virtuálního počítače. Pokud máte síť vSAN nebo RDM, opětovné ochrany a navrácení služeb po obnovení nebude fungovat.
...
* Nelze nepodaří zpět na základě sítě vSAN nebo RDM disky. V úložišti dat VMFS lze vytvářet pouze nové disky virtuálního počítače (VMDKs).
...
* Hlavní cílový server by neměl mít všechny snímky před spuštěním navrácení služeb po obnovení.
