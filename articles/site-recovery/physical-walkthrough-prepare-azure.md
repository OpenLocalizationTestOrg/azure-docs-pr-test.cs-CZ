...
---
# <a name="step-5-prepare-azure-resources-for-physical-server-replication-tooazure"></a>Krok 5: Příprava prostředků Azure pro replikaci tooAzure fyzického serveru


Použijte hello pokyny v této článku tooprepare Azure prostředky tak, aby můžete replikovat místní servery tooAzure pomocí hello [Azure Site Recovery](site-recovery-overview.md) služby.
...
Ujistěte se, že jste si přečetli hello [požadavky](physical-walkthrough-prerequisites.md).
...
- Zkontrolujte hello podporované oblasti pro obnovení lokality v části **geografickou dostupností** v [Azure Site Recovery podrobnosti o cenách](https://azure.microsoft.com/pricing/details/site-recovery/).
...
- Obnovení lokality se replikují na místní servery tooAzure úložiště. Virtuální počítače Azure jsou vytvořené z úložiště hello po převzetí služeb při selhání.
