...
Tento článek ukazuje, jak toouse šablonu Azure Resource Manager, který vytvořil oboru názvů Service Bus a fronty v daném oboru názvů. Se dozvíte, jak toodefine prostředky, ke kterým jsou nasazené a jak toodefine parametry, které jsou zadané, když se spustí nasazení hello. Můžete tuto šablonu použít pro vlastní nasazení, nebo si ji přizpůsobit toomeet vašim požadavkům.
...
Hello úplnou šablonu, najdete v části hello [šablony obor názvů a fronty Service Bus] [ Service Bus namespace and queue template] na Githubu.
...
[Fronty služby Service Bus](service-bus-queues-topics-subscriptions.md#queues) nabízejí First In tooone doručení zpráv první Out (FIFO) nebo další konkurenčních spotřebitelů.

toorun hello nasazení automaticky, klikněte na následující tlačítko hello:

[![Nasazení tooAzure](./media/service-bus-resource-manager-namespace-queue/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-queue%2Fazuredeploy.json)
...
Hello název fronty hello vytvořené v oboru názvů Service Bus hello.
