...
> [!NOTE]
> Toto téma se věnuje nasazení do cloudové služby, není pro webové servery. Informace o nasazení do webové stránky najdete v tématu [nasazení webové aplikace v Azure App Service](app-service-web/web-sites-deploy.md).
>
>
...
| Pracovní postupy |Aplikace služby pracovního postupu WCF |
