...
Tento kurz ukazuje, jak tooload dat do SQL Data Warehouse s použitím AzCopy a PolyBase. Po dokončení tohoto kurzu budete vědět, jak:
...
Viz také [Začínáme s hello příkazového řádku Azcopy][latest version of AzCopy].
