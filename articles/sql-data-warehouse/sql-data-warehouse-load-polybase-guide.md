...
Dotazy na externí tabulky jednoduše použijte název tabulky, jako kdyby byl relační tabulku.
...
## <a name="export-data-to-azure-blob-storage"></a>Exportovat data do Azure blob storage
V této části ukazuje, jak exportovat data z SQL Data Warehouse do Azure blob storage. Tento příklad používá vytvořit externí TABLE AS SELECT, který je vysoce původce příkazu Transact-SQL k exportu dat paralelně z výpočetních uzlů.
