...
Výpočetní prostředky, [Azure App Service](app-service/app-service-value-prop-what-is.md) poskytuje k hostování [web nebo webovou aplikaci](app-service-web/app-service-web-overview.md), [webové rozhraní API](app-service-api/app-service-api-apps-why-best-platform.md), nebo [back-end mobilní aplikace](app-service-mobile/app-service-mobile-value-prop.md). Aplikace služby App Service se také označují jako *App Services*, *webové aplikace*, *aplikace API*, a *mobilní aplikace*.
