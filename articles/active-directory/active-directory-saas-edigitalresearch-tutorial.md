...
V tomto kurzu zjistíte, jak toointegrate eDigitalResearch s Azure Active Directory (Azure AD).

Integrace eDigitalResearch s Azure AD poskytuje hello následující výhody:

- Můžete ovládat ve službě Azure AD, který má přístup tooeDigitalResearch.
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooeDigitalResearch (jednotné přihlášení) s jejich účty Azure AD.
...
Integrace služby Azure AD s eDigitalResearch tooconfigure, je třeba hello následující položky:
...
1. Přidání eDigitalResearch z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-edigitalresearch-from-hello-gallery"></a>Přidání eDigitalResearch z Galerie hello
tooconfigure hello integrace eDigitalResearch do Azure AD, je nutné tooadd eDigitalResearch hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd eDigitalResearch z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **eDigitalResearch**, vyberte **eDigitalResearch** z panelu výsledků klikněte **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow hello příslušného uživatele v eDigitalResearch je tooa uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello v eDigitalResearch musí toobe navázat.

V eDigitalResearch, přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testu Azure AD jednotné přihlašování s eDigitalResearch, potřebujete následující stavební bloky hello toocomplete:
...
3. **[Vytvoření zkušebního uživatele eDigitalResearch](#create-a-edigitalresearch-test-user)**  -toohave protějšek Britta Simon v eDigitalResearch, která je propojená toohello Azure AD reprezentace uživatele.
...
V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci eDigitalResearch.

**tooconfigure Azure AD jednotné přihlašování s eDigitalResearch, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **eDigitalResearch** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **eDigitalResearch domény a adresy URL** část, proveďte následující kroky hello:
    ...
    a. V hello **identifikátor** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<company-name>.edigitalresearch.com`

    b. V hello **adresa URL odpovědi** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<company-name>.edigitalresearch.com/login/consume`

    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné. Tyto hodnoty aktualizujte pomocí hello skutečné identifikátor dotazů a odpovědí adresy URL. Obraťte se na [tým podpory eDigitalResearch](http://www.maruedr.com/contact) tooget tyto hodnoty.
 


4. Na hello **SAML podpisový certifikát** klikněte na tlačítko **certifikát Base(64)** a potom uložte soubor certifikátu hello ve vašem počítači.

    !![odkaz ke stažení certifikátu Hello](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_certificate.png) 
...
6. Na hello **eDigitalResearch konfigurace** klikněte na tlačítko **konfigurace eDigitalResearch** tooopen **konfigurovat přihlášení** okno. Kopírování hello **Sign-Out adresu URL, SAML Entity ID** z hello **Stručná referenční příručka části.**
...
7. tooconfigure jednotného přihlašování na **eDigitalResearch** straně, je nutné stáhnout hello toosend **soubor certifikátu (Base64)**, **SAML Entity ID**, a  **Adresa URL odhlašování** příliš[tým podpory eDigitalResearch](http://www.maruedr.com/contact). Nastavují hello toohave tato nastavení jednotného přihlašování SAML připojení správně nastavena na obou stranách.
...
Hello cílem této části je toocreate volal Britta Simon v eDigitalResearch uživatele. 

Práce s hello [tým podpory eDigitalResearch](http://www.maruedr.com/contact) tooget uživatelé vytvoření.       
...
V této části povolíte tak, že udělíte přístup tooeDigitalResearch toouse Britta Simon Azure jednotné přihlašování.

![Přiřadit role uživatele hello][200] 

**tooassign Britta Simon tooeDigitalResearch, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **eDigitalResearch**.
...
Když kliknete na dlaždici eDigitalResearch hello v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour eDigitalResearch aplikace.
