...
V tomto kurzu zjistíte, jak toointegrate životního cyklu SCC službou Azure Active Directory (Azure AD).

Životní cyklus SCC integraci s Azure AD poskytuje hello následující výhody:

- Můžete řídit ve službě Azure AD, který má přístup tooSCC životního cyklu
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooSCC životního cyklu (jednotné přihlášení) s jejich účty Azure AD
...
tooconfigure integrace Azure AD s SCC životního cyklu, je třeba hello následující položky:
...
1. Přidání životního cyklu SCC z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-scc-lifecycle-from-hello-gallery"></a>Přidání životního cyklu SCC z Galerie hello
tooconfigure hello integrace životního cyklu SCC do Azure AD, je nutné tooadd životního cyklu SCC hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd životního cyklu SCC z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **životního cyklu SCC**.
...
5. Na panelu výsledků hello vyberte **životního cyklu SCC**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow hello příslušného uživatele v průběhu životního cyklu SCC je tooa uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello v průběhu životního cyklu SCC musí toobe navázat.

V průběhu životního cyklu SCC, přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testu Azure AD jednotné přihlašování s SCC životního cyklu, potřebujete následující stavební bloky hello toocomplete:

1. **[Konfigurace Azure AD jednotné přihlašování](#configuring-azure-ad-single-sign-on)**  -tooenable toouse vaši uživatelé tuto funkci.
2. **[Vytváření testovacího uživatele Azure AD](#creating-an-azure-ad-test-user)**  -tootest Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytváření testovacího uživatele životního cyklu SCC](#creating-an-scc-lifecycle-test-user)**  -toohave protějšek Britta Simon v průběhu životního cyklu SCC, která je propojená toohello Azure AD reprezentace uživatele.
4. **[Přiřazení hello Azure AD testovacího uživatele](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci SCC životního cyklu.

**tooconfigure Azure AD jednotné přihlašování s SCC životního cyklu, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **životního cyklu SCC** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **SCC životního cyklu domény a adresy URL** část, proveďte následující kroky hello:

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-scclifecycle-tutorial/tutorial_scclifecycle_url.png)

    a. V hello **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<sub-domain>.scc.com/ic7/welcome/customer/PICTtest.aspx`
    ...
    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné. Aktualizovat tyto hodnoty s hello skutečné přihlašovací adresa URL a identifikátor. Obraťte se na [tým podpory SCC životního cyklu klienta](mailto:lifecycle.support@scc.com) tooget tyto hodnoty. 
...
6. tooconfigure jednotného přihlašování na **životního cyklu SCC** straně, je nutné stáhnout hello toosend **soubor XML s metadaty** příliš[tým podpory životního cyklu SCC](mailto:lifecycle.support@scc.com). Nastavují hello toohave tato nastavení jednotného přihlašování SAML připojení správně nastavena na obou stranách.
...
V této části povolíte tak, že udělíte přístup tooSCC životního cyklu Britta Simon toouse Azure jednotné přihlašování.

![Přiřadit uživatele][200] 

**tooassign Britta Simon tooSCC životního cyklu, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace.**

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **životního cyklu SCC**.
...
Po kliknutí na tlačítko hello životního cyklu SCC dlaždici v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooSCC životního cyklu aplikace.
