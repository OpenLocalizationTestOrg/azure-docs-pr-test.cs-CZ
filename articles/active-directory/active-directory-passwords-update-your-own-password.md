...
3. V závislosti na tom, jakou konfiguraci SSPR vaši pracovníci IT vytvořili, se zobrazí jedna nebo více následujících možností. Vy nebo pracovníci IT naplnění některé z těchto informací před použitím článku [registrace pro resetování hesla pomocí samoobslužné služby](active-directory-passwords-reset-register.md).
