...
### <a name="sign-in-failure-reasons-on-the-azure-active-directory-admin-center"></a>Chyba přihlášení důvodů v Centru pro správu Azure Active Directory

Při řešení potíží při přihlašování uživatele prohlížení začněte [přihlašovací aktivita sestavy](../active-directory-reporting-activity-sign-ins.md) na [centra pro správu Azure Active Directory](https://aad.portal.azure.com/).
