...
* Azure AD Connect je ve výchozím nastavení pro komunikaci se službou Azure AD pomocí protokolu TLS 1.0. Toto můžete změnit na TLS 1.2 podle kroků v [povolení TLS 1.2 pro Azure AD Connect](#enable-tls-12-for-azure-ad-connect).
