...
## <a name="use-the-graph-api-to-manage-your-tenants-smart-lockout-values"></a>Použití rozhraní Graph API ke správě vašeho klienta inteligentní uzamčení hodnoty
...
4. Zkopírujte a vložte následující požadavku JSON do pole "Textu žádosti". Inteligentní uzamčení hodnoty podle potřeby změnit a použít náhodný identifikátor GUID pro `templateId`.
