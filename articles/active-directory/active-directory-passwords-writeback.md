...
3. Na další úlohy obrazovce klikněte na tlačítko **přizpůsobit možnosti synchronizace** a potom zvolte **Další**.
4. Obrazovce připojení ke službě Azure AD zadejte přihlašovací údaje globálního správce a zvolte **Další**.
5. Na připojení adresáře a domény a organizační jednotky filtrování obrazovky můžete **Další**.
...
Informace týkající se licencování, najdete v tématu [licence potřebné pro zpětný zápis hesla](active-directory-passwords-licensing.md#licenses-required-for-password-writeback) nebo následující weby
...
* **Krok 2 – šifrování na úrovni balíčku s AES-GCM** - pak celý balíček (heslo + požadovaná metadata) jsou šifrována pomocí standardu AES-GCM. To brání každý, kdo má přímý přístup do základní sběrnice kanálu zobrazení/manipulaci s obsahem.
* **Krok 3 – veškerá komunikace probíhá přes protokol TLS / SSL** -veškerá komunikace se sběrnice probíhá kanál SSL/TLS. Tento obsah zabezpečuje od neoprávněným 3. stran.
* **Automatickou výměnu klíče každých šest měsíců** – automaticky každých 6 měsíců, nebo pokaždé, když zpětný zápis hesla je zakázána a znovu povolena na Azure AD Connect, jsme výměny tyto klíče zajistit zabezpečení Maximální služby a bezpečnost.
