...
## [Přidat uživatele tooAzure AD](add-users-azure-active-directory.md)
## [Přiřazení licencí toousers](license-users-groups.md)
...
#### [Přiřaďte licence tooa skupinu](active-directory-licensing-group-assignment-azure-portal.md)
#### [Identifikace a řešení potíží s licencemi ve skupině](active-directory-licensing-group-problem-resolution-azure-portal.md)
#### [Migrace na základě toogroup licencování jednotlivých licencovaní uživatelé](active-directory-licensing-group-migration-azure-portal.md)
...
### [Přidání skupiny přístup tooSaaS aplikací](active-directory-accessmanagement-group-saasapps.md)
...
#### [Použití hello Azure Active Directory Power BI balíček obsahu](active-directory-reporting-power-bi-content-pack-how-to.md)
...
### [Pomocí hello portálu Azure](device-management-azure-portal.md)
...
### [Spravovat přístup tooapps](active-directory-managing-access-to-apps.md)
...
#### [Přidání role uživatele tooa B2B](active-directory-b2b-add-guest-to-role.md)
...
#### [Pochopení hello B2B uživatele](active-directory-b2b-user-properties.md)
#### [Token uživatele B2B](active-directory-b2b-user-token.md)
#### [B2B pro integrované aplikace Azure AD](active-directory-b2b-configure-saas-apps.md)
#### [Mapování deklarací identity uživatelů B2B](active-directory-b2b-claims-mapping.md)
#### [Porovnání tooB2C spolupráce B2B](active-directory-b2b-compare-b2c.md)
...
## Delegovat přístup tooresources
...
#### [Nastavení přístupu tooconnected aplikace](active-directory-conditional-access-policy-connected-applications.md)
