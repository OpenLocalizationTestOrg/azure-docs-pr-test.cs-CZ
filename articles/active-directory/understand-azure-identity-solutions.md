...
|Správce předplatného Azure| Správce účtu je osoba, která registraci aplikace nebo kód zakoupili předplatné Azure. Mohou používat [centra účtů](https://account.windowsazure.com/Home/Index) Pokud chcete provádět různé úlohy správy, jako jsou vytvářet odběry, zrušit předplatné, změňte fakturace předplatného nebo změnit správce služeb. |
