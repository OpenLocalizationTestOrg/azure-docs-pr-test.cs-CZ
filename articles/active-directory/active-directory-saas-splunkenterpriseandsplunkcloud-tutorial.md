...
- Můžete povolit uživatelům tooautomatically get přihlášeného tooSplunk Enterprise a Splunk cloudu (jednotné přihlášení) s jejich účty Azure AD
...
## <a name="adding-splunk-enterprise-and-splunk-cloud-from-hello-gallery"></a>Přidání Splunk Enterprise a Splunk cloudu z Galerie hello
...
4. Hello vyhledávacího pole zadejte **Splunk Enterprise a Splunk cloudu**.
...
5. Na panelu výsledků hello vyberte **Splunk Enterprise a Splunk cloudu**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
V Splunk Enterprise a Splunk cloudu, přiřaďte hello hodnotu hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.
...
3. **[Vytvoření zkušebního uživatele Splunk Enterprise a cloudu Splunk](#creating-a-splunk-enterprise-and-splunk-cloud-test-user)**  -toohave protějšku Britta Simon ve Splunk podniku a Splunk cloudu, který je propojený toohello Azure AD reprezentace uživatele.
4. **[Přiřazení hello Azure AD testovacího uživatele](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci Splunk Enterprise a Splunk cloudu.

**tooconfigure Azure AD jednotné přihlašování s Splunk Enterprise a Splunk cloudu, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Splunk Enterprise a cloudu Splunk** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **Splunk Enterprise a Splunk cloudové domény a adresy URL** část, pokud chcete aplikace hello tooconfigure v **IDP** iniciované režimu:
    ...
    a. V hello **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<splunkserverUrl>/en-US/app/launcher/home`
    
    b. V hello **identifikátor** textovému poli, zadat adresu URL hello Splunk serveru.

    c. V hello **adresa URL odpovědi** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<splunkserver>/saml/acs`

    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné. Aktualizovat tyto hodnoty s hello skutečné identifikátor, adresa URL odpovědi a přihlašovací adresa URL. Zde, doporučujeme vám toouse hello jedinečnou hodnotu řetězce v hello identifikátor. Obraťte se na [Splunk Enterprise a klient Cloud Splunk tým podpory](https://www.splunk.com/content/splunkcom/en_us/about-us/contact.html#tabs/customer-support) tooget tyto hodnoty. 
...
6. tooconfigure jednotného přihlašování na **Splunk Enterprise a cloudu Splunk** straně, je nutné stáhnout hello toosend **soubor XML s metadaty** příliš[Splunk Enterprise a Splunk cloudu podporovat team](https://www.splunk.com/content/splunkcom/en_us/about-us/contact.html#tabs/customer-support).
...
V této části vytvoříte uživatele volat Britta Simon ve Splunk podniku a Splunk cloudu. Práce s [Splunk Enterprise a Splunk cloudu tým podpory](https://www.splunk.com/content/splunkcom/en_us/about-us/contact.html#tabs/customer-support) tooadd hello uživatele v hello Splunk Enterprise a Splunk Cloudová platforma.

### <a name="assigning-hello-azure-ad-test-user"></a>Přiřazení hello Azure AD testovacího uživatele

V této části povolíte tak, že udělíte přístup tooSplunk Enterprise a Splunk cloudu Britta Simon toouse Azure jednotné přihlašování.
