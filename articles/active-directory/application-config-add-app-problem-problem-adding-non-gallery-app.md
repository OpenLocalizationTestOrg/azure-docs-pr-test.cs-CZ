...
Tento článek vám pomůže toounderstand hello běžné problémy uživatelé setkávají při přidávání **vlastních aplikací bez Galerie** a co můžete dělat tooresolve je. 
...
Pokud potřebujete pomoc, získávání informací o vlastních aplikací, hello [knihovna dokumentů aplikace Azure AD](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) vám pomůžou toolearn informace o jednotné přihlašování s Azure AD a jak to funguje.
...
6.  Klikněte na tlačítko hello **ikona kopírování** toohello napravo od hello **Chyba kopírování** textbox toocopy všechny hello tooshare podrobnosti oznámení s skupiny pracovník podpory nebo produktu.
