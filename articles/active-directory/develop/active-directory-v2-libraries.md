...
Koncový bod v2.0 Azure Active Directory (Azure AD) podporuje standardní protokoly OAuth 2.0 a OpenID Connect 1.0. Můžete použít různé knihovny od společnosti Microsoft a jiných organizací s koncovým bodem v2.0.
