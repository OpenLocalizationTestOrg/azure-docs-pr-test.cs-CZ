...
Azure Active Directory Authentication Library (ADAL) umožňuje vývojářům aplikací klienta snadno ověřování uživatelů do cloudu nebo místní služby Active Directory (AD) a získat přístupové tokeny zabezpečení volání rozhraní API. ADAL usnadňuje ověřování pro vývojáře prostřednictvím funkcí, jako například:
...
ADAL zpracování většinu složitost, pomáhá vývojářům zaměřit se na obchodní logiky a snadno zabezpečení prostředků, aniž by musel být odborník v zabezpečení.
