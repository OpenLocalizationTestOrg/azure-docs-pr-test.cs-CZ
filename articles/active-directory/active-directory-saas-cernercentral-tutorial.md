...
V tomto kurzu zjistíte, jak toointegrate střed Cerner s Azure Active Directory (Azure AD).

Integrace střed Cerner s Azure AD poskytuje hello následující výhody:

- Můžete řídit ve službě Azure AD, který má přístup tooCerner – střed
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooCerner střed (jednotné přihlášení) s jejich účty Azure AD
...
Integrace služby Azure AD s centrální Cerner tooconfigure, je třeba hello následující položky:
...
1. Přidání Cerner střed z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-cerner-central-from-hello-gallery"></a>Přidání Cerner střed z Galerie hello
tooconfigure hello integrace Cerner střední do Azure AD, je nutné tooadd Cerner střed hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd Cerner střed z Galerie hello, proveďte následující kroky hello:**
...
3. tooadd novou aplikaci, klikněte na tlačítko **novou aplikaci** tlačítka v dialogovém okně hello.

    ![Aplikace][3]

4. Hello vyhledávacího pole zadejte **Cerner střed**.
...
5. Na panelu výsledků hello vyberte **Cerner střed**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow, co uživatel protějšku hello in – střed Cerner je tooa uživatelem ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello in – střed Cerner musí toobe navázat.

tooconfigure a testu Azure AD jednotné přihlašování s centrální Cerner, potřebujete následující stavební bloky hello toocomplete:

1. **[Konfigurace Azure AD jednotné přihlašování](#configuring-azure-ad-single-sign-on)**  -tooenable toouse vaši uživatelé tuto funkci.
2. **[Vytváření testovacího uživatele Azure AD](#creating-an-azure-ad-test-user)**  -tootest Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytvoření zkušebního uživatele střed Cerner](#creating-a-cerner-central-test-user)**  -toohave protějšek Britta Simon in – střed Cerner, která je propojená toohello Azure AD reprezentace hello uživatele.
4. **[Přiřazení hello Azure AD testovacího uživatele](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci Cerner střed.

**tooconfigure Azure AD jednotné přihlašování s Cerner – střed, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Cerner střed** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **Cerner centrální domény a adresy URL** část, proveďte následující kroky hello:

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-cernercentral-tutorial/tutorial_cernercentral_url.png)

    a. V hello **identifikátor** textovému poli, typ hello hodnotu pomocí hello následující vzorce:
    ...
    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné hello. Tyto hodnoty aktualizujte pomocí hello skutečné identifikátor dotazů a odpovědí adresy URL. Obraťte se na [tým podpory střed Cerner](https://wiki.ucern.com/display/CernerCentral/Contacting+Cloud+Operations) tooget tyto hodnoty.
...
5. toogenerate hello **Metadata** adresu url, proveďte následující kroky hello:
    ...
    d. Nyní přejděte na stránce vlastností toohello **Cerner střed** a kopírování hello **Id aplikace** pomocí **kopie** tlačítko a vložte do poznámkového bloku.
...
6. tooconfigure jednotného přihlašování na **Cerner střed** postranní, budete potřebovat toosend hello **adresu URL metadat** příliš[Cerner střed podporu](https://wiki.ucern.com/display/CernerCentral/Contacting+Cloud+Operations). Hello jednotného přihlašování je potřeba nakonfigurovat na integraci aplikací straně toocomplete hello.
...
3. tooopen hello **uživatele** dialogové okno, klikněte na tlačítko **přidat**.
...
**Střed Cerner** aplikace umožňuje ověřování z kteréhokoli zprostředkovatele federovaných identit. Pokud je uživatel moct toolog toohello aplikace domovské stránce, jsou federovaný a mít pro jakékoli ruční zřizování není nutné.

### <a name="assigning-hello-azure-ad-test-user"></a>Přiřazení hello Azure AD testovacího uživatele

V této části povolíte tak, že udělíte přístup tooCerner střed Britta Simon toouse Azure jednotné přihlašování.

![Přiřadit uživatele][200] 

**tooassign tooCerner Britta Simon – střed, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **Cerner střed**.
...
Po kliknutí na tlačítko hello Cerner střed dlaždici v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour Cerner střed aplikace. Další informace o na přístupovém panelu najdete v tématu [Úvod k přístupovému panelu](active-directory-saas-access-panel-introduction.md).
