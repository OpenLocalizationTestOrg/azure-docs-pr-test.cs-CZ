...
V tomto kurzu zjistíte, jak toointegrate Springer propojit s Azure Active Directory (Azure AD).

Integrace Springer odkaz s Azure AD poskytuje hello následující výhody:

- Můžete ovládat ve službě Azure AD, který má přístup tooSpringer odkaz.
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooSpringer odkaz (jednotné přihlášení) s jejich účty Azure AD.
...
Integrace služby Azure AD s odkazem Springer tooconfigure, je třeba hello následující položky:

- Předplatné služby Azure AD
- Odkaz Springer jednotné přihlašování povolené předplatné
...
1. Přidání Springer propojení z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-springer-link-from-hello-gallery"></a>Přidání Springer propojení z Galerie hello
tooconfigure hello integrace Springer propojení do Azure AD, je nutné tooadd Springer odkaz hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd Springer odkaz z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **Springer odkaz**, vyberte **Springer odkaz** z panelu výsledků klikněte **přidat** tlačítko tooadd hello aplikace.
...
V této části nakonfigurovat a otestovat Azure AD jednotné přihlašování s Springer odkaz na základě testovací uživatele, nazývá "Britta Simon".

Pro toowork jeden přihlašování Azure AD musí tooknow, jaké hello příslušného uživatele v Springer odkaz je tooa uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello v odkazu Springer musí toobe navázat.

V propojení Springer přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testování Azure AD jednotné přihlašování s odkazem Springer, potřebujete následující stavební bloky hello toocomplete:
...
3. **[Přiřadit hello Azure AD testovacího uživatele](#assign-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
4. **[Test jednotného přihlašování](#test-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configure-azure-ad-single-sign-on"></a>Konfigurovat Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci Springer odkaz.

**tooconfigure Azure AD jednotné přihlašování s Springer odkaz, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Springer odkaz** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **Springer odkaz domény a adresy URL** část, pokud chcete aplikace hello tooconfigure v **IDP** iniciované režimu:
    ...
    a. V hello **identifikátor** textovému poli, hello zadat adresu URL:`https://fsso.springer.com`

    b. V hello **adresa URL odpovědi** textovému poli, hello zadat adresu URL:`https://fsso-qa1.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL**. Pokud chcete aplikace hello tooconfigure v **SP** iniciované režimu:
    ...
    V hello **přihlašovací adresa URL** textovému poli, hello zadat adresu URL:`https://fsso.springer.com/federation/Consumer/metaAlias/SpringerServiceProvider`    
...
6. toogenerate hello **Metadata** adresu url, proveďte následující kroky hello:
    ...
    d. Nyní přejděte na stránce vlastností toohello **Springer odkaz** a kopírování hello **Id aplikace** pomocí **kopie** tlačítko a vložte do poznámkového bloku.
...
7. tooconfigure jednotného přihlašování na **Springer odkaz** straně, je nutné toosend hello generované **adresu URL metadat** příliš[tým podpory Springer odkaz](mailto:identity@springernature.com).
...
V této části povolíte tak, že udělíte přístup tooSpringer odkaz Britta Simon toouse Azure jednotné přihlašování.

![Přiřadit role uživatele hello][200] 

**tooassign Britta Simon tooSpringer odkaz, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **Springer odkaz**.
...
Když kliknete na dlaždici hello Springer odkaz v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour Springer odkaz aplikace.
