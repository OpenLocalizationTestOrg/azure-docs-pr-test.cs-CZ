...
V tomto kurzu zjistíte, jak toointegrate Zscaler s Azure Active Directory (Azure AD).

Integrace Zscaler s Azure AD poskytuje hello následující výhody:

- Můžete řídit ve službě Azure AD, který má přístup tooZscaler
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooZscaler (jednotné přihlášení) s jejich účty Azure AD
...
Integrace služby Azure AD s Zscaler tooconfigure, je třeba hello následující položky:

- Předplatné služby Azure AD
- Zscaler jednotné přihlašování povolené předplatné
...
1. Přidání Zscaler z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-zscaler-from-hello-gallery"></a>Přidání Zscaler z Galerie hello
tooconfigure hello integrace Zscaler do Azure AD, je nutné tooadd Zscaler hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd Zscaler z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **Zscaler**.

    ![Vytváření testovacího uživatele Azure AD](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_search.png)

5. Na panelu výsledků hello vyberte **Zscaler**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
V této části nakonfigurovat a otestovat Azure AD jednotné přihlašování s Zscaler podle testovacího uživatele názvem "Britta Simon".

Pro toowork jeden přihlašování Azure AD musí tooknow hello příslušného uživatele v Zscaler je tooa uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello v Zscaler musí toobe navázat.

V Zscaler, přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testu Azure AD jednotné přihlašování s Zscaler, potřebujete následující stavební bloky hello toocomplete:
...
4. **[Vytvoření zkušebního uživatele Zscaler](#creating-a-zscaler-test-user)**  -toohave protějšek Britta Simon v Zscaler, která je propojená toohello Azure AD reprezentace uživatele.
...
V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci Zscaler.

**tooconfigure Azure AD jednotné přihlašování s Zscaler, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Zscaler** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **Zscaler domény a adresy URL** část, proveďte následující kroky hello:

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_url.png)

    V hello **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<companyname>.zsclaer.net`

    > [!NOTE] 
    > Tato hodnota není skutečné. Aktualizujte tuto hodnotu s hello skutečná adresa URL přihlašování. Obraťte se na [tým podpory Zscaler klienta](https://www.zscaler.com/company/contact) tooget tuto hodnotu. 
...
6. Na hello **Zscaler konfigurace** klikněte na tlačítko **konfigurace Zscaler** tooopen **konfigurovat přihlášení** okno. Kopírování hello **SAML jeden přihlašování adresa URL služby** z hello **Stručná referenční příručka části.**

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_configure.png) 

7. V okně prohlížeče jiný web Přihlaste se jako správce na webu společnosti ZScaler tooyour.

8. V nabídce hello hello nahoře, klikněte na tlačítko **správy**.
   
    ![Správa](./media/active-directory-saas-zscaler-tutorial/ic800206.png "správy")

9. V části **spravovat správci & role**, klikněte na tlačítko **Správa uživatelů a ověřování**.   
            
    ![Správa uživatelů a ověřování](./media/active-directory-saas-zscaler-tutorial/ic800207.png "správu uživatelů a ověřování")

10. V hello **zvolte možnosti ověřování pro vaši organizaci** část, proveďte následující kroky hello:   
                
    ![Ověřování](./media/active-directory-saas-zscaler-tutorial/ic800208.png "ověřování")
...
11. Na hello **konfigurace SAML jeden přihlašování parametry** dialogové okno stránky, proveďte následující kroky hello a pak klikněte na **provést**
    ...
    ![Jednotné přihlašování](./media/active-directory-saas-zscaler-tutorial/ic800209.png "jednotného přihlašování")
...
12. Na hello **konfigurace ověřování uživatele** dialogové okno proveďte hello následující kroky:
    ...
    ![Správa](./media/active-directory-saas-zscaler-tutorial/ic800210.png "správy")
...
5. V části Proxy server hello proveďte hello následující kroky:   
    ...
    ![Proxy server](./media/active-directory-saas-zscaler-tutorial/ic769494.png "Proxy serveru")

    a. Vyberte **použít proxy server pro síť LAN**.

    b. V textovém poli hello adresu, zadejte **gateway.zscaler.net**.
...
Uživatelé toolog tooenable Azure AD v tooZScaler, musí být zřízená tooZScaler.  
V případě hello ZScaler zřizování je ruční úloha.
...
1. Přihlaste se tooyour **Zscaler** klienta.

2. Klikněte na tlačítko **správy**.   
   
    ![Správa](./media/active-directory-saas-zscaler-tutorial/ic781035.png "správy")

3. Klikněte na tlačítko **Správa uživatelů**.   
        
     ![Přidat](./media/active-directory-saas-zscaler-tutorial/ic781036.png "přidat")

4. V hello **uživatelé** , klikněte na **přidat**.
      
    ![Přidat](./media/active-directory-saas-zscaler-tutorial/ic781037.png "přidat")

5. V části přidat uživatele hello proveďte hello následující kroky:
        
    ![Přidat uživatele](./media/active-directory-saas-zscaler-tutorial/ic781038.png "přidat uživatele")
   
    a. Typ hello **UserID**, **zobrazované uživatelské jméno**, **heslo**, **Potvrdit heslo**a potom vyberte **skupiny**a hello **oddělení** platného účtu AAD chcete tooprovision.

    b. Klikněte na **Uložit**.

> [!NOTE]
> Můžete použít všechny ostatní ZScaler uživatele účtu nástroje pro tvorbu nebo rozhraní API poskytované ZScaler tooprovision AAD uživatelské účty.

### <a name="assigning-hello-azure-ad-test-user"></a>Přiřazení hello Azure AD testovacího uživatele

V této části povolíte tak, že udělíte přístup tooZscaler toouse Britta Simon Azure jednotné přihlašování.

![Přiřadit uživatele][200] 

**tooassign Britta Simon tooZscaler, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **Zscaler**.
...
Když kliknete na dlaždici Zscaler hello v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour Zscaler aplikace.
