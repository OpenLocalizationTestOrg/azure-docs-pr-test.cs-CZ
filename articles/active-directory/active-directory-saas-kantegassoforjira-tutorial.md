...
V tomto kurzu zjistíte, jak toointegrate Kantega jednotné přihlašování pro JIRA s Azure Active Directory (Azure AD).

Integrace Kantega jednotné přihlašování pro JIRA s Azure AD poskytuje hello následující výhody:

- Můžete řídit ve službě Azure AD, který má přístup tooKantega jednotné přihlašování pro JIRA
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooKantega jednotné přihlašování pro JIRA (jednotné přihlášení) s jejich účty Azure AD
...
Integrace služby Azure AD pomocí jednotného přihlašování Kantega pro JIRA tooconfigure, je třeba hello následující položky:
...
1. Přidání Kantega jednotné přihlašování pro JIRA z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-kantega-sso-for-jira-from-hello-gallery"></a>Přidání Kantega jednotné přihlašování pro JIRA z Galerie hello
tooconfigure hello integrace Kantega přihlašování pro JIRA do Azure AD, musíte pro JIRA hello Galerie tooyour seznamu spravovaných aplikací SaaS tooadd Kantega jednotné přihlašování.

**tooadd Kantega jednotné přihlašování pro JIRA z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **Kantega jednotné přihlašování pro JIRA**.
...
5. Na panelu výsledků hello vyberte **Kantega jednotné přihlašování pro JIRA**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow, co uživatel protějšku hello SSO Kantega pro JIRA je tooa uživatelem ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello SSO Kantega pro JIRA musí toobe navázat.

V Kantega jednotné přihlašování pro JIRA, přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testování Azure AD jednotné přihlašování pomocí jednotného přihlašování Kantega JIRA, potřebujete následující stavební bloky hello toocomplete:

1. **[Konfigurace Azure AD jednotné přihlašování](#configuring-azure-ad-single-sign-on)**  -tooenable toouse vaši uživatelé tuto funkci.
2. **[Vytváření testovacího uživatele Azure AD](#creating-an-azure-ad-test-user)**  -tootest Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytváření Kantega SSO pro testovací uživatele JIRA](#creating-a-kantega-sso-for-jira-test-user)**  -toohave protějšek Britta Simon SSO Kantega pro JIRA, která je propojená toohello Azure AD reprezentace uživatele.
4. **[Přiřazení hello Azure AD testovacího uživatele](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v vaší Kantega jednotné přihlašování pro aplikace JIRA.

**tooconfigure Azure AD jednotné přihlašování pomocí jednotného přihlašování Kantega pro JIRA, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Kantega jednotné přihlašování pro JIRA** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. V **IDP** iniciované režimu na hello **Kantega SSO JIRA domény a adresy URL** části provést následující krok hello:
...
4. V **SP** initiated režimu, zkontrolujte **zobrazit upřesňující nastavení adresy URL** a proveďte následující krok hello:
    ...
    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné. Aktualizovat tyto hodnoty s hello skutečné identifikátor, adresa URL odpovědi a přihlašovací adresa URL. Tyto hodnoty jsou přijímány během konfigurace hello Jira modul plug-in, který je vysvětlen později v kurzu hello.
...
7. V okně prohlížeče jiný web Přihlaste se jako správce v tooyour JIRA na místním serveru.
...
9. Karta části doplňky, klikněte na tlačítko **najít nové rozšíření**. Hledání **Kantega jednotné přihlašování pro JIRA (SAML & protokolu Kerberos)** a klikněte na tlačítko **nainstalovat** tooinstall tlačítko hello nové zásuvný modul SAML.
...
13. Nový modul plug-in je uveden v části **integrace**. Klikněte na tlačítko **konfigurace** tooconfigure hello nového modulu plug-in.
...
16. Na hello **vlastností aplikace** část, proveďte následující kroky: 
    ...
    a. Kopírování hello **identifikátor ID URI aplikace** hodnotu a použít ho jako **identifikátor, adresa URL odpovědi a přihlašovací adresa URL** na hello **Kantega SSO JIRA domény a adresy URL** části na portálu Azure.
...
20. Na hello **JIRA uživatelské účty** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-kantegassoforjira-tutorial/addon10.png)

    a. Vyberte **v případě potřeby vytvořte uživatele v adresáři JIRA na interní** a zadejte vhodný název hello hello skupiny pro uživatele (může být více ne. skupin oddělené čárkou).
...
Uživatelé toolog tooenable Azure AD v tooJIRA, se musí být zřízená do JIRA. V Kantega jednotné přihlašování pro JIRA zřizování je ruční úloha.

**tooprovision uživatelský účet, proveďte následující kroky hello:**

1. Tooyour JIRA na místním serveru se přihlaste jako správce.
...
4. Na hello **"Vytvořit nový uživatel"** dialogové okno proveďte hello následující kroky:
...
V této části povolíte tak, že udělíte přístup tooKantega jednotné přihlašování pro JIRA toouse Britta Simon Azure jednotné přihlašování.

![Přiřadit uživatele][200] 

**tooassign tooKantega Britta Simon jednotného přihlašování pro JIRA, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **Kantega jednotné přihlašování pro JIRA**.
...
Po kliknutí na tlačítko hello Kantega jednotné přihlašování pro dlaždici JIRA v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour Kantega jednotné přihlašování pro aplikace JIRA.
