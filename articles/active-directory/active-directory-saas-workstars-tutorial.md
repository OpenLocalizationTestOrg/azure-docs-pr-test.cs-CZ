...
V tomto kurzu zjistíte, jak toointegrate Workstars s Azure Active Directory (Azure AD).

Integrace Workstars s Azure AD poskytuje hello následující výhody:

- Můžete ovládat ve službě Azure AD, který má přístup tooWorkstars.
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooWorkstars (jednotné přihlášení) s jejich účty Azure AD.
...
Integrace služby Azure AD s Workstars tooconfigure, je třeba hello následující položky:
...
1. Přidání Workstars z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-workstars-from-hello-gallery"></a>Přidání Workstars z Galerie hello
tooconfigure hello integrace Workstars do Azure AD, je nutné tooadd Workstars hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd Workstars z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **Workstars**, vyberte **Workstars** z panelu výsledků klikněte **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow hello příslušného uživatele v Workstars je tooa uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello v Workstars musí toobe navázat.

V Workstars, přiřadit hodnotu hello hello **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** tooestablish hello odkaz relace.

tooconfigure a testu Azure AD jednotné přihlašování s Workstars, potřebujete následující stavební bloky hello toocomplete:
...
3. **[Vytvoření zkušebního uživatele Workstars](#create-a-workstars-test-user)**  -toohave protějšek Britta Simon v Workstars, která je propojená toohello Azure AD reprezentace uživatele.
...
V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci Workstars.

**tooconfigure Azure AD jednotné přihlašování s Workstars, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **Workstars** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na hello **Workstars domény a adresy URL** část, proveďte následující kroky hello:
    ...
    a. V hello **identifikátor** textovému poli, hello zadat adresu URL:`https://workstars.com`

    b. V hello **adresa URL odpovědi** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://<subdomain>.workstars.com/saml/login_check`

    > [!NOTE] 
    > Hodnota Hello není skutečné. Aktualizace hello hodnotu s hello skutečná adresa URL odpovědi. Obraťte se na [tým podpory Workstars](https://support.workstars.com) tooget hello hodnotu.
...
6. Na hello **Workstars konfigurace** klikněte na tlačítko **konfigurace Workstars** tooopen **konfigurovat přihlášení** okno. Kopírování hello **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z hello **Stručná referenční příručka části.**

    ![Konfigurace Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_configure.png) 

7. V jiném okně prohlížeče Přihlaste se jako správce na webu společnosti Workstars tooyour.

8. Na hlavním panelu nástrojů hello klikněte na **nastavení**.

    ![Nastavení Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_sett.png)

9. Přejděte příliš**přihlašování** > **nastavení**.
...
10. Na hello **jeden znak na (SAML) – nastavení** proveďte hello následující kroky:
    ...
    c. Kopírovat obsah hello hello stažený certifikát souboru v programu Poznámkový blok a pak ji vložit do hello **x509 certifikát** textové pole. 

    d. V hello **URL jednotné přihlašování SAML** textovému poli, vložte hodnotu hello **SAML jeden přihlašování adresa URL služby**, který jste zkopírovali z portálu Azure.
    
    e. V hello **vzdálené adresy URL odhlašovací** textovému poli, vložte hodnotu hello **Sign-Out URL**, který jste zkopírovali z portálu Azure. 
...
V této části vytvoříte volal Britta Simon v Workstars uživatele. Práce s [tým podpory Workstars](https://support.workstars.com) tooadd hello uživatelé v platformě Workstars hello.

### <a name="assign-hello-azure-ad-test-user"></a>Přiřadit hello Azure AD testovacího uživatele

V této části povolíte tak, že udělíte přístup tooWorkstars toouse Britta Simon Azure jednotné přihlašování.

![Přiřadit role uživatele hello][200] 

**tooassign Britta Simon tooWorkstars, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **Workstars**.
...
Po kliknutí na tlačítko hello Workstars dlaždici v hello přístupového panelu, měli byste obdržet automaticky přihlášeného tooyour Workstars aplikace.
