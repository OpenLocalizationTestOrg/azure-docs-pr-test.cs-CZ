...
4. Do vyhledávacího pole zadejte **Expensify**.

    ![Vytváření testovacího uživatele Azure AD](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_search.png)

5. Na panelu výsledků vyberte **Expensify**a potom klikněte na **přidat** tlačítko Přidat aplikaci.
...
3. **[Vytváření testovacího uživatele Expensify](#creating-an-expensify-test-user)**  – Pokud chcete mít protějšek Britta Simon v Expensify propojeném s Azure AD reprezentace daného uživatele.
...
3. Na **Expensify domény a adresy URL** část, proveďte následující kroky:
    ...
    a. V **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí následujícího vzorce:`https://www.expensify.com/authentication/saml/login`

    b. V **identifikátoru adresy URL** textovému poli, zadejte adresu URL pomocí následujícího vzorce:`https://www.<companyname>.expensify.com/` 

    > [!NOTE] 
    > Tyto hodnoty nejsou skutečné. Tyto hodnoty aktualizujte skutečné přihlašovací adresa URL a identifikátoru adresy URL. Obraťte se na [tým podpory Expensify klienta](mailto:help@expensify.com) k získání těchto hodnot. 
