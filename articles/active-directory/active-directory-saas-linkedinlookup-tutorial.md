...
V tomto kurzu zjistíte, jak toointegrate LinkedIn vyhledávání v Azure Active Directory (Azure AD).

Integrace vyhledávání LinkedIn s Azure AD poskytuje hello následující výhody:

- Můžete řídit ve službě Azure AD, který má přístup tooLinkedIn vyhledávání
- Můžete povolit vaši uživatelé tooautomatically get přihlášeného tooLinkedIn vyhledávání (jednotné přihlášení) s jejich účty Azure AD
...
tooconfigure integrace Azure AD s LinkedIn vyhledávání, je třeba hello následující položky:
...
1. Přidání LinkedIn vyhledávání z Galerie hello
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-linkedin-lookup-from-hello-gallery"></a>Přidání LinkedIn vyhledávání z Galerie hello
tooconfigure hello integrace vyhledávání LinkedIn do Azure AD, je nutné tooadd LinkedIn vyhledávání hello Galerie tooyour seznamu spravovaných aplikací SaaS.

**tooadd LinkedIn vyhledávání z Galerie hello, proveďte následující kroky hello:**
...
4. Hello vyhledávacího pole zadejte **LinkedIn vyhledávání**.
...
5. Na panelu výsledků hello vyberte **LinkedIn vyhledávání**a potom klikněte na **přidat** tlačítko tooadd hello aplikace.
...
Pro toowork jeden přihlašování Azure AD musí tooknow, co uživatel protějšku hello LinkedIn vyhledávání je tooa uživatelem ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské hello vyhledávání LinkedIn musí toobe navázat.

Přiřazením hello hodnotu hello je vytvořen vztah tento odkaz **uživatelské jméno** ve službě Azure AD jako hodnota hello hello **uživatelské jméno** LinkedIn vyhledávání.

tooconfigure a testu Azure AD jednotné přihlašování s LinkedIn vyhledávání, potřebujete následující stavební bloky hello toocomplete:

1. **[Konfigurace Azure AD jednotné přihlašování](#configuring-azure-ad-single-sign-on)**  -tooenable toouse vaši uživatelé tuto funkci.
2. **[Vytváření testovacího uživatele Azure AD](#creating-an-azure-ad-test-user)**  -tootest Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytváření testovacího uživatele vyhledávání LinkedIn](#creating-an-linkedin-lookup-test-user)**  -toohave protějšek Britta Simon LinkedIn vyhledávání, která je propojená toohello Azure AD.
4. **[Přiřazení hello Azure AD testovacího uživatele](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  -tooverify tom, zda text hello konfigurace funguje.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotné přihlašování v hello portál Azure a nakonfigurovat jednotné přihlašování v aplikaci LinkedIn vyhledávání.

**tooconfigure Azure AD jednotné přihlašování s LinkedIn vyhledávání, proveďte následující kroky hello:**

1. V portálu Azure, na hello hello **LinkedIn vyhledávání** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. V okně prohlížeče jiných webových přihlašování tooyour **LinkedIn vyhledávání** webu jako správce.

4. V **centra účtů**, klikněte na tlačítko **globální nastavení** pod **nastavení**. Kromě toho **vyhledávání** z rozevíracího seznamu hello.
...
6. Na portálu Azure v části **LinkedIn vyhledávání domény a adresy URL** část, proveďte následující kroky, pokud chcete aplikace hello tooconfigure hello **IDP** iniciované režimu:
...
7. Zkontrolujte **zobrazit upřesňující nastavení adresy URL**, pokud chcete aplikace hello tooconfigure v **SP** iniciované režimu:
    ...
    V hello **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí hello následující vzoru:`https://www.linkedIn.com/checkpoint/enterprise/login/<AccountId>?application=lookup`
     
    > [!NOTE] 
    > Toto není skutečné hodnoty. má uživatel Hello tooupdate tyto hodnoty s hello skutečná adresa URL přihlašování. Obraťte se na [tým podpory klienta sítě LinkedIn vyhledávání](https://business.LinkedIn.com/lookup) tooget tuto hodnotu.

8. Vaše **LinkedIn vyhledávání** aplikace očekává hello SAML kontrolní výrazy ve specifickém formátu. Hello uživatel má tooadd vlastních atributů mapování toohello SAML tokenu atributy konfigurace. Hello následující snímek obrazovky ukazuje příklad. Výchozí hodnota Hello **uživatelský identifikátor** je **user.userprincipalname** ale LinkedIn vyhledávání očekává tento toobe namapována na hello uživatele e-mailovou adresu. Můžete použít **user.mail** atribut ze seznamu hello nebo použijte hodnotu hello odpovídajícího atributu na základě konfigurace vaší organizace. 
...
12. Přejděte příliš**nastavení správce LinkedIn** části. Soubor XML hello nahrávání jste si stáhli z portálu Azure hello kliknutím hello **soubor nahrát XML** možnost.
...
3. Klikněte na tlačítko **přidat** tooopen hello **uživatele** dialogové okno.
...
Propojené vyhledávání aplikace podporuje pouze v zřizování uživatelů čas (JIT) a po ověření uživatele v aplikaci hello automaticky vytvoří. Aktivovat **automaticky přiřadit licence** tooassign uživatel toohello licence.
...
V této části povolíte tak, že udělíte přístup tooLinkedIn vyhledávání toouse Britta Simon Azure jednotné přihlašování.

![Přiřadit uživatele][200] 

**tooassign tooLinkedIn Britta Simon vyhledávání, proveďte následující kroky hello:**

1. V hello portálu Azure, otevřete zobrazení aplikace hello a potom přejděte toohello directory zobrazení a přejděte příliš**podnikové aplikace, které** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

2. V seznamu aplikace hello vyberte **LinkedIn vyhledávání**.
...
Po kliknutí na tlačítko hello LinkedIn vyhledávání dlaždici v hello přístupový Panel, musí být přesměrované tooOrganizational stránku, kde jsou tooprovide osobní podrobnosti o účtu LinkedIn. Ho propojí s vaším účtem obchodní LinkedIn svůj osobní účet. 
