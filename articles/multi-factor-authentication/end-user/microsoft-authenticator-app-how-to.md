...
### <a name="add-an-account-to-the-app-using-touch-id"></a>Přidat účet k aplikaci pomocí Touch ID
Aplikace Microsoft Authenticator v systému iOS podporuje Touch ID.  Azure Multi-Factor Authentication umožňuje organizacím vyžadoval kód PIN pro zařízení. S Touch ID uživatelé systému iOS nemusíte zadání kódu PIN. Místo toho můžete kontrolovat jejich otisk prstu a vybrat **schválit**.
