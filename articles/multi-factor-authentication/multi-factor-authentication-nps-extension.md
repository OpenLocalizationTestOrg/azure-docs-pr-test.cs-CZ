...
4. Prostředí PowerShell vyzve k zadání vašeho ID klienta. Použijte identifikátor GUID ID adresáře, který jste zkopírovali z portálu Azure v části předpoklady.
5. Přihlaste se ke službě Azure AD jako správce.
