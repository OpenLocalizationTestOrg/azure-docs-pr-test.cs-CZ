...
Zkontrolujte připojení je aktuálně ve verzi public preview, toouse tato funkce je nutné toobe zaregistrován. toodo se spuštění hello následující ukázka rozhraní příkazového řádku
...
tooverify hello registrace byla úspěšná, spusťte následující příkaz rozhraní příkazového řádku hello:
