...
| Protokoly služby App Service | Události | Aplikační služby | <ul><li>**Soubor, tabulku nebo úložiště objektů blob:** [webové diagnostiky aplikací](../app-service-web/web-sites-enable-diagnostic-log.md)</li></ul> |
