...
| [Vytvořit účet úložiště az](/cli/azure/storage/account#create) | Vytvoří účet úložiště Azure. |
| [Vytvoření az functionapp](https://docs.microsoft.com/cli/azure/functionapp#create) | Vytvoří Azure funkce. |
