...
3. Do vyhledávacího pole hello hello katalogu služby Microsoft Update, zadejte číslo znalostní báze Knowledge Base (KB) hello opravy hotfix hello chcete toodownload, například **3121901**a potom klikněte na **vyhledávání**.
   
    Hello opravu hotfix seznamu se zobrazí, například **kumulativní softwaru sady aktualizací 2.0 pro zařízení StorSimple řady 8000**.
...
5. Vyhledejte všechny další opravy hotfix uvedené v předchozí tabulce hello (**3121900**, **3080728**, **3090322**, a **3121899**) a přidejte všechny Hello nákupní košík.
...
6. Hello softwaru aktualizace po dokončení, zopakujte kroky 3 až 5 tooinstall a monitorování hello SaaS agenta a agenta služby MDS. Ujistěte se, že `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` nainstalovali před `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Ověření verze softwaru systému hello. Zadejte:
...
8. Opakujte kroky 3 až 5 tooinstall hello zbývající regular režimu opravy hotfix.
   
   * Hello LSI ovladač - KB3121900
   * Hello Storport aktualizace – KB3080728
   * Hello Spaceport aktualizace – KB3090322
