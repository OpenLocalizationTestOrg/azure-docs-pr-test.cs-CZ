...
> [!NOTE]
> Vzhledem k tomu, že konfigurace může být složité objekty, jsou obvykle přiřazeny jedinečné ID (hodnoty hash nebo [identifikátory GUID][lnk-guid]) ke zjednodušení jejich porovnání.
> 
> 
...
Potom později některé aplikace zařízení budou hlásit úspěch nebo selhání této operace aktualizací vlastnost výše.
