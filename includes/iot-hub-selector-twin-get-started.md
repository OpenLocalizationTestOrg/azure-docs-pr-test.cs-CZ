...
> [!NOTE]
> V tomto okamžiku jsou přístupné pouze ze zařízení, která se připojují ke službě IoT Hub pomocí protokolu MQTT dvojčata zařízení. Naleznete [MQTT podporu] [ lnk-devguide-mqtt] článek pokyny o tom, jak převést stávající aplikace zařízení používat MQTT.
