* [Nastavení náročnosti geografické distribuce aplikace](../articles/app-service-web/app-service-app-service-environment-geo-distributed-scale.md)
* [Implementace vrstvené architektury zabezpečení](../articles/app-service-web/app-service-app-service-environment-layered-security.md) 
* [Konfigurace brány firewall webových aplikací pomocí služby App Service Environment](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
