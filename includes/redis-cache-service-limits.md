...
Vzhledem k tomu, že společnost Microsoft se provádí konfigurace a Správa instance služby Azure Redis Cache, jsou podporovány všechny příkazy Redis v Azure Redis Cache. Další informace najdete v tématu [Redis příkazy nejsou podporované ve službě Azure Redis Cache](../articles/redis-cache/cache-configure.md#redis-commands-not-supported-in-azure-redis-cache).
