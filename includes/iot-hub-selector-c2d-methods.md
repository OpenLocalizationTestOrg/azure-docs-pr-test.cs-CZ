...
> [!NOTE]
> V tomto okamžiku přímé metody jsou podporovány pouze na zařízení, která se připojují ke službě IoT Hub pomocí protokolu MQTT. Naleznete [MQTT podporu] [ lnk-devguide-mqtt] článek pokyny o tom, jak převést stávající aplikace zařízení používat MQTT.
