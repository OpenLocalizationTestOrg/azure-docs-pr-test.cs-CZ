...
| Síť |Virtuální síť s bránu ExpressRoute i bránu VPN  | Odeberte služby VPN Gateway před zahájením migrace a poté znovu vytvořit bránu sítě VPN, po dokončení migrace. Další informace o [ExpressRoute migrace](../articles/expressroute/expressroute-migration-classic-resource-manager.md).|
| Síť |ExpressRoute s odkazy autorizace  | Odeberte okruh ExpressRoute a připojení sítě virtaul před zahájením migrace a pak znovu vytvořte připojení po dokončení migrace. Další informace o [ExpressRoute migrace](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
...
| Compute |Rozšíření Azure Security Center s virtuální sítě, který má připojení přenosu brána sítě VPN nebo brány ExpressRoute s místní server DNS |Rozšíření Azure Security Center automaticky nainstaluje na virtuálních počítačích vyvolat výstrahy a sledovat jejich zabezpečení. Tato rozšíření obvykle získat nainstalovat automaticky, pokud Azure Security Center je povolena v předplatném. Migrace brány ExpressRoute není aktuálně podporována a bran VPN s připojením k přenosu ztratí místního přístupu. Odstranění ExpressRoute bránu nebo migrace brány sítě VPN s připojením k přenosu způsobí, že přístup k Internetu k účtu úložiště virtuálních počítačů k ztratí, když budete pokračovat s potvrzením migrace. Migrace nebude pokračovat, pokud k tomu dojde, protože nelze načíst objekt blob stavu agenta hosta. Doporučujeme zakázat 3 hodiny, než budete pokračovat v migraci zásad Azure Security Center na předplatné. |
